...
function fetchEvents($from_date, $to_date, $where_param = null, $orderby_param = null, $tracker_board = false, $nextX = 0, $bind_param = null, $query_param = null)
{
    ...
    if ($query_param) {
        ...
        $query = "SELECT " .
            ...
            "e.pc_title, e.pc_hometext, e.pc_examenes, e.pc_apptqx, e.pc_apptqxOI, e.pc_LIOOD, e.pc_LIOOI, e.pc_LIO_type_OD, e.pc_LIO_type_OI, e.pc_docnotes, e.pc_apptstatus, " .
            "p.fname, p.mname, p.lname, p.lname2, p.pricelevel, p.pid, p.pubpid, p.phone_home, p.phone_cell, " .

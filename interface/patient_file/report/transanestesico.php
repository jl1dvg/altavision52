...
// Si se está generando desde custom_report.php (PDF_CONTRA), solo renderizar HTML sin crear nuevo mPDF.
$embed = !empty($GLOBALS['PDF_CONTRA']);
$shouldRender = ($embed || $PDF_OUTPUT);
if ($embed) {
    ob_start();
}

...
$query = "  select  *,form_encounter.date as encounter_date
               from forms,form_encounter,form_eye_base,
                ...
                form_eye_neuro,form_eye_locking
                    ...
                    forms.form_id=form_eye_mag_wearing.FORM_ID and
                    forms.encounter=? and
                    forms.pid=? ";
...
<TABLE CELLSPACING=0 COLS=64 RULES=NONE BORDER=0>
    ...
    <TR>
        ...
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 1px solid #808080" COLSPAN=5 ALIGN=CENTER VALIGN=MIDDLE
            BGCOLOR="#CCFFCC"><B><FONT SIZE=1>COD. UO</FONT></B></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 1px solid #808080; border-right: 1px solid #808080"
            COLSPAN=12 ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#CCFFCC"><B><FONT SIZE=1>COD. LOCALIZACI&Oacute;N</FONT></B>
        </TD>
    ...
    <TR>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 5px solid #808080"
            COLSPAN=13 HEIGHT=21 ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#CCFFCC"><FONT SIZE=1>APELLIDO PATERNO</FONT></TD>
    ...
    <TR>
        ...
        <TD STYLE="border-top: 1px solid #808080" COLSPAN=10 ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#CCFFCC"><FONT SIZE=1>INSTRUCCI&Oacute;N</FONT>
        </TD>
        ...
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-right: 5px solid #808080"
            COLSPAN=12 ROWSPAN=2 ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#CCFFCC"><FONT SIZE=1>SEGURO DE SALUD</FONT></TD>
    </TR>
    <TR>
    ...
    <TR>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 5px solid #808080; border-left: 5px solid #808080; border-right: 1px solid #808080"
            COLSPAN=12 HEIGHT=28 ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#CCFFCC"><FONT SIZE=1>ESTABLECIMIENTO AL QUE SE ENV&Iacute;A
                LA CONTRARREFERENCIA</FONT></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 5px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            COLSPAN=16 ALIGN=LEFT VALIGN=MIDDLE><FONT SIZE=1><?php
                ...
                ?></FONT></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 5px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            COLSPAN=10 ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#CCFFCC"><FONT SIZE=1>SERVICIO QUE CONTRAREFIERE</FONT></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 5px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
        ...
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 5px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            COLSPAN=2 ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#FFFF99"><B><FONT SIZE=4 COLOR="#DD0806"><BR></FONT></B></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 5px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            COLSPAN=6 ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#CCFFCC"><FONT SIZE=1><BR></FONT></TD>
...
<table CELLSPACING=0 COLS=13 RULES=NONE BORDER=0 WIDTH=100%>
    <TR>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 1px solid #808080; border-left: 5px solid #808080"
            COLSPAN=1 HEIGHT=24 ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#CCCCFF" SDVAL="1" SDNUM="1033;"><B><FONT
                    SIZE=3>1</FONT></B></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 1px solid #808080; border-right: 5px solid #808080"
            COLSPAN=12 ALIGN=LEFT VALIGN=MIDDLE BGCOLOR="#CCCCFF"><B><FONT SIZE=3>RESUMEN DEL CUADRO CLÍNICO</FONT></B>
        </TD>
    </TR>
    <TR>
...
<table CELLSPACING=0 COLS=13 RULES=NONE BORDER=0 WIDTH=100%>
    <TR>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 1px solid #808080; border-left: 5px solid #808080"
            COLSPAN=1 HEIGHT=24 ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#CCCCFF" SDVAL="3" SDNUM="1033;"><B><FONT
                    SIZE=3>2</FONT></B></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 1px solid #808080; border-right: 5px solid #808080"
            COLSPAN=12 ALIGN=LEFT VALIGN=MIDDLE BGCOLOR="#CCCCFF"><B><FONT SIZE=3>HALLAZGOS RELEVANTES DE EXAMENES Y
                    PROCEDIMIENTOS DIAGNOSTICOS</FONT></B></TD>
    </TR>
    <TR>
        <TD class="linearesumen" COLSPAN=13><FONT SIZE=1>
                <?php

                function ExamOftal($RBROW, $LBROW, $RUL, $LUL, $RLL, $LLL, $RMCT, $LMCT, $RADNEXA, $LADNEXA, $EXT_COMMENTS, $SCODVA, $SCOSVA, $ODVA, $OSVA, $ODIOPAP, $OSIOPAP, $ODCONJ, $OSCONJ, $ODCORNEA, $OSCORNEA, $ODAC, $OSAC, $ODLENS, $OSLENS, $ODIRIS, $OSIRIS, $ODDISC, $OSDISC, $ODCUP, $OSCUP,
                                   $ODMACULA, $OSMACULA, $ODVESSELS, $OSVESSELS, $ODPERIPH, $OSPERIPH, $ODVITREOUS, $OSVITREOUS)
                {
                    if ($RBROW || $LBROW || $RUL || $LUL || $RLL || $LLL || $RMCT || $LMCT || $RADNEXA || $LADNEXA || $EXT_COMMENTS || $SCODVA || $SCOSVA || $ODVA || $OSVA || $ODIOPAP || $OSIOPAP || $OSCONJ || $ODCONJ || $ODCORNEA || $OSCORNEA || $ODAC || $OSAC || $ODLENS || $OSLENS || $ODIRIS || $OSIRIS || $ODDISC || $OSDISC || $ODCUP || $OSCUP ||
                        $ODMACULA || $OSMACULA || $ODVESSELS || $OSVESSELS || $ODPERIPH || $OSPERIPH || $ODVITREOUS || $OSVITREOUS) {
                        if ($SCODVA || $SCOSVA) {
                            $ExamOFT = $ExamOFT . ("AVSC: ");
                            if ($SCODVA) {
                        ...
                        if ($ODVA || $OSVA) {
                            $ExamOFT = $ExamOFT . ("AVCC: ");
                            if ($SCODVA) {
                                $ExamOFT = $ExamOFT . ("OD: " . $ODVA . ", ");
                            }
                            if ($SCOSVA) {
                                $ExamOFT = $ExamOFT . ("OI: " . $OSVA . ", ");
                            }
                        }
                        if ($ODIOPAP || $OSIOPAP) {
                            $ExamOFT = $ExamOFT . ("PIO: ");
                ...
                echo wordwrap(ExamOftal($RBROW, $LBROW, $RUL, $LUL, $RLL, $LLL, $RMCT, $LMCT, $RADNEXA, $LADNEXA, $EXT_COMMENTS, $SCODVA, $SCOSVA, $ODVA, $OSVA, $ODIOPAP, $OSIOPAP, $ODCONJ, $OSCONJ, $ODCORNEA, $OSCORNEA, $ODAC, $OSAC, $ODLENS, $OSLENS, $ODIRIS, $OSIRIS, $ODDISC, $OSDISC, $ODCUP, $OSCUP,
...
<table CELLSPACING=0 COLS=13 RULES=NONE BORDER=0 WIDTH=100%>
    <TR>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 1px solid #808080; border-left: 5px solid #808080"
            COLSPAN=1 HEIGHT=24 ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#CCCCFF" SDVAL="2" SDNUM="1033;"><B><FONT
                    SIZE=3>3</FONT></B></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 1px solid #808080; border-right: 5px solid #808080"
            COLSPAN=12 ALIGN=LEFT VALIGN=MIDDLE BGCOLOR="#CCCCFF"><B><FONT SIZE=3>TRATAMIENTO Y PROCEDIMIENTOS
                    TERAPÉUTICOS REALIZADOS</FONT></B></TD>
    </TR>
    <TR>
    ...
    <TR>
        <TD class="linearesumen" COLSPAN=13 HEIGHT=20 ALIGN=LEFT VALIGN=MIDDLE BGCOLOR="#FFFFFF"><FONT
                SIZE=1><BR></FONT></TD>
    </TR>
...
<table CELLSPACING=0 RULES=NONE BORDER=0 WIDTH=100%>
    <TR>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 1px solid #808080; border-left: 5px solid #808080"
            width="2%" HEIGHT=24 ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#CCCCFF"><B><FONT SIZE=3>4</FONT></B></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 1px solid #808080" width="17.5%" ALIGN=LEFT
            VALIGN=MIDDLE BGCOLOR="#CCCCFF"><B><FONT SIZE=3>DIAGN&Oacute;STICOS</FONT></B></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 1px solid #808080" width="17.5%" ALIGN=CENTER
            VALIGN=MIDDLE BGCOLOR="#CCCCFF"><FONT SIZE=1>PRE= PRESUNTIVO DEF= DEFINITIVO</FONT></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 1px solid #808080" width="6%" ALIGN=CENTER
            VALIGN=MIDDLE BGCOLOR="#CCCCFF"><B><FONT SIZE=1>CIE</FONT></B></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 1px solid #808080" width="3.5%" ALIGN=CENTER
            VALIGN=MIDDLE BGCOLOR="#CCCCFF"><B><FONT SIZE=1>PRE</FONT></B></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 1px solid #808080" width="3.5%" ALIGN=CENTER
            VALIGN=MIDDLE BGCOLOR="#CCCCFF"><B><FONT SIZE=1>DEF</FONT></B></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 1px solid #808080" width="2%" ALIGN=CENTER
            VALIGN=MIDDLE BGCOLOR="#CCCCFF"><B><FONT SIZE=3><BR></FONT></B></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 1px solid #808080" width="17.5%" ALIGN=LEFT
            VALIGN=MIDDLE BGCOLOR="#CCCCFF"><B><FONT SIZE=3><BR></FONT></B></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 1px solid #808080" width="17.5%" ALIGN=CENTER
            VALIGN=MIDDLE BGCOLOR="#CCCCFF"><FONT SIZE=1><BR></FONT></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 1px solid #808080" width="6%" ALIGN=CENTER
            VALIGN=MIDDLE BGCOLOR="#CCCCFF"><B><FONT SIZE=1>CIE</FONT></B></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 1px solid #808080" width="3.5%" ALIGN=CENTER
            VALIGN=MIDDLE BGCOLOR="#CCCCFF"><B><FONT SIZE=1>PRE</FONT></B></TD>
    ...
    <TR>
        ...
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            colspan="2" ALIGN=LEFT VALIGN=MIDDLE><B><FONT SIZE=1><?php echo getDXoftalmo($form_id, $pid, "0"); ?></FONT></B>
        </TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            ALIGN=CENTER VALIGN=MIDDLE><B><FONT SIZE=1><?php echo getDXoftalmoCIE10($form_id, $pid, "0"); ?></FONT></B>
        </TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#FFFF99"><B><FONT SIZE=4 COLOR="#DD0806"><BR></FONT></B></TD>
        ...
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#CCFFCC" SDVAL="4" SDNUM="1033;"><B><FONT SIZE=1>4</FONT></B></TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            colspan="2" ALIGN=LEFT VALIGN=MIDDLE><B><FONT SIZE=1><?php echo getDXoftalmo($form_id, $pid, "3"); ?></FONT></B>
        </TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            ALIGN=CENTER VALIGN=MIDDLE><B><FONT SIZE=1><?php echo getDXoftalmoCIE10($form_id, $pid, "3"); ?></FONT></B>
        </TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#FFFF99"><B><FONT SIZE=4 COLOR="#DD0806"><BR></FONT></B></TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 5px solid #808080"
    ...
    <TR>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 5px solid #808080; border-right: 1px solid #808080"
            HEIGHT=30 ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#CCFFCC" SDVAL="2" SDNUM="1033;"><B><FONT SIZE=1>2</FONT></B>
        </TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            colspan="2" ALIGN=LEFT VALIGN=MIDDLE><B><FONT SIZE=1><?php echo getDXoftalmo($form_id, $pid, "1"); ?></FONT></B>
        </TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            ALIGN=CENTER VALIGN=MIDDLE><B><FONT SIZE=1><?php echo getDXoftalmoCIE10($form_id, $pid, "1"); ?></FONT></B>
        </TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#FFFF99"><B><FONT SIZE=4 COLOR="#DD0806"><BR></FONT></B></TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080"
        ...
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#CCFFCC" SDVAL="5" SDNUM="1033;"><B><FONT SIZE=1>5</FONT></B></TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            colspan="2" ALIGN=LEFT VALIGN=MIDDLE><B><FONT SIZE=1><?php echo getDXoftalmo($form_id, $pid, "4"); ?></FONT></B>
        </TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            ALIGN=CENTER VALIGN=MIDDLE><B><FONT SIZE=1><?php echo getDXoftalmoCIE10($form_id, $pid, "4"); ?></FONT></B>
        </TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#FFFF99"><B><FONT SIZE=4 COLOR="#DD0806"><BR></FONT></B></TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 5px solid #808080"
    ...
    <TR>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 5px solid #808080; border-right: 1px solid #808080"
            HEIGHT=28 ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#CCFFCC" SDVAL="3" SDNUM="1033;"><B><FONT SIZE=1>3</FONT></B>
        </TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            colspan="2" ALIGN=LEFT VALIGN=MIDDLE><FONT
                SIZE=1><B><?php echo getDXoftalmo($form_id, $pid, "2"); ?></B></FONT></TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            ALIGN=CENTER VALIGN=MIDDLE><FONT SIZE=1><B><?php echo getDXoftalmoCIE10($form_id, $pid, "2"); ?></B></FONT>
        </TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#FFFF99"><B><FONT SIZE=4 COLOR="#DD0806"><BR></FONT></B></TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080"
        ...
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#CCFFCC" SDVAL="6" SDNUM="1033;"><B><FONT SIZE=1>6</FONT></B></TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            colspan="2" ALIGN=LEFT VALIGN=MIDDLE><FONT
                SIZE=1><B><?php echo getDXoftalmo($form_id, $pid, "5"); ?></B></FONT></TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            ALIGN=CENTER VALIGN=MIDDLE><FONT SIZE=1><B><?php echo getDXoftalmoCIE10($form_id, $pid, "5"); ?></B></FONT>
        </TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#FFFF99"><B><FONT SIZE=4 COLOR="#DD0806"><BR></FONT></B></TD>
        <TD STYLE="border-top: 1px solid #808080; border-bottom: 1px solid #808080; border-left: 1px solid #808080; border-right: 5px solid #808080"
    ...
    <TR>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 1px solid #808080; border-left: 5px solid #808080"
            COLSPAN=1 HEIGHT=24 ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#CCCCFF" SDVAL="2" SDNUM="1033;"><B><FONT
                    SIZE=3>5</FONT></B></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 1px solid #808080; border-right: 5px solid #808080"
            COLSPAN=12 ALIGN=LEFT VALIGN=MIDDLE BGCOLOR="#CCCCFF"><B><FONT SIZE=3>PLAN DE TRATAMIENTO RECOMENDADO</FONT></B>
        </TD>
    </TR>
    <TR>
        <TD class="linearesumen" COLSPAN=13 HEIGHT=20 ALIGN=LEFT VALIGN=MIDDLE BGCOLOR="#FFFFFF"><FONT SIZE=1>
...
<table CELLSPACING=0 RULES=NONE BORDER=0 WIDTH=100%>
    ...
    <TR>
        ...
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 5px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            width="7%" ALIGN=CENTER VALIGN=MIDDLE SDNUM="1033;1033;D-MMM-YY"><B><FONT SIZE=1><BR></FONT></B></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 5px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            width="7%" ALIGN=CENTER VALIGN=MIDDLE BGCOLOR="#CCFFCC"><FONT SIZE=1>CAMA</FONT></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 5px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
            width="7%" ALIGN=CENTER VALIGN=MIDDLE SDNUM="1033;0;[H]:MM:SS"><B><FONT SIZE=1><BR></FONT></B></TD>
        <TD STYLE="border-top: 5px solid #808080; border-bottom: 5px solid #808080; border-left: 1px solid #808080; border-right: 1px solid #808080"
    ...
    <TR>
        <TD colspan="6" HEIGHT=24 ALIGN=LEFT VALIGN=TOP><B><FONT SIZE=1 COLOR="#000000">SNS-MSP / HCU-form.053 /
                    2008</FONT></B></TD>

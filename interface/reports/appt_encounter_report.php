...
{
    global $grand_total_charges, $grand_total_copays, $grand_total_encounters, $grand_total_formulario;
    if (!$docrow['docname']) {
        return;
    }
...
$query = "( " .
    ...
    "f.authorized, f.formdir, f.form_name AS formulario, f.provider_id AS operador, " .
    ...
    "LEFT OUTER JOIN forms AS f ON f.pid = fe.pid AND f.encounter = fe.encounter AND f.deleted = 0 " .

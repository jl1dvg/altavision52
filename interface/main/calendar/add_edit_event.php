...
function Cirugia_Planificada($pid, $ojo)
{
    ...
    $formID = $result1['id'];
    $queryORDER = "SELECT * FROM form_eye_mag_ordenqx" . $ojo . " WHERE form_id = ? ORDER BY id ASC";
    $result2 = sqlStatement($queryORDER, array($formID));
    $plan_details = array(); // Array para almacenar los detalles de la cirugía planificada
    if (!empty($result2)) {
        while ($plan_row = sqlFetchArray($result2)) {
            $plan_details[] = $plan_row['ORDER_DETAILS'];
        }
    }
    return $plan_details;
}
...
<head>
    ...
    <script language="JavaScript">
        ...
        function set_display() {
            ...
            // Elementos relacionados al formulario "In Office"
            ...
            var style_examenes = document.getElementById('title_examenes').style;

            // Elementos relacionados al formulario "Quirurgico"
            var style_cirugia = document.getElementById('title_cirugia').style;
            ...
            if (catid == '2') { // In Office
                ...
                style_examenes.display = '';
                f.form_apptstatus.style.display = 'none';
                f.form_prefcat.style.display = '';
                f.form_examenes.style.display = '';
            } else {
                style_prefcat.display = 'none';
                style_apptstatus.display = '';
                style_examenes.display = 'none';
                f.form_prefcat.style.display = 'none';
                f.form_apptstatus.style.display = '';
                f.form_examenes.style.display = 'none';
            }

            if (catid == '15' || catid == '19') { // Quirurgico
                style_datos_cirugia.display = '';
                style_cirugia.display = '';
                style_QXOD.display = '';
                style_cirugiaOI.display = '';
                style_QXOI.display = '';
                style_LIOOD.display = '';
                ...
                style_cirugia.display = 'none';
                style_QXOD.display = 'none';
                style_cirugiaOI.display = 'none';
...
<div class="container-responsive">
    <form class="form-inline" method='post' name='theform' id='theform'
          action='add_edit_event.php?eid=<?php echo attr($eid) ?>'/>
...
<script language="Javascript">
    ...
    <input type="hidden" name="rt2_flag2" id="rt2_flag2"
           value="<?php echo attr(isset($rspecs['rt2_pf_flag']) ? $rspecs['rt2_pf_flag'] : '0'); ?>">
    <!-- End of addition by epsdky -->
    <center>
                ...
                <td colspan='10'>
                    <table class="table table-condensed" border='0' width='100%' bgcolor='#DDDDDD'>
                        <tr>
                            ...
                            <td nowrap>
                                <select class='input-sm' name='form_category' onchange='set_category()'
                                        style='width:100%'>
                                    <?php echo $catoptions ?>
                                </select>
                            </td>
                            <td width='1%' nowrap>
                                &nbsp;&nbsp;
                                <input type='radio' name='form_allday' onclick='set_allday()' value='1'
                                       id='rballday1'<?php echo ($thisduration == 1440) ? " checked" : ""; ?>/>
                            </td>
                        ...
                        <tr>
                            ...
                            <td nowrap>
                                &nbsp;&nbsp;
                                <input type='radio' name='form_allday' onclick='set_allday()' value='0'
                                       id='rballday2'<?php echo ($thisduration != 1440) ? " checked " : ""; ?>/>
                            </td>
            ...
            <span>
                ...
                <input class='input-sm' type='text' size='2' name='form_minute' value='<?php echo attr($starttimem) ?>'
                       title='<?php echo xla('Event start time'); ?>'/>&nbsp;
                                ...
                                <select class='input-sm' name='form_ampm'
                                        title='<?php echo xla("Note: 12:00 noon is PM, not AM"); ?>'>
                                    <option value='1'><?php echo xlt('AM'); ?></option>
                                    <option
                                        value='2'<?php echo ($startampm == '2') ? " selected" : ""; ?>><?php echo xlt('PM'); ?></option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td nowrap>
                                <input class="input-sm" type='text' size='10' name='form_title'
                                       value='<?php echo attr($row['pc_title']); ?>'
                                       style='width:100%'
                            ...
                            <td nowrap id='tdallday5'>
                                <input class='input-sm' type='text' size='4' name='form_duration'
                                       value='<?php echo attr($thisduration) ?>'
                        ...
                        if ($_GET['prov'] != true && $_GET['group'] != true) {
                            ...
                            <tr id="patient_details">
                                ...
                                <td nowrap>
                                    <input class='input-sm' type='text' size='10' name='form_patient' id="form_patient"
                                           style='width:100%;cursor:pointer;cursor:hand'
                                           placeholder='<?php echo xla('Click to select'); ?>'
                                           value='<?php echo is_null($patientname) ? '' : attr($patientname); ?>'
                                           onclick='sel_patient()' title='<?php echo xla('Click to select patient'); ?>'
                                           readonly/>
                                    <input class='input-sm' type='hidden' name='form_pid'
                                           value='<?php echo attr($patientid) ?>'/>
                                </td>
        ...
        ?>
                        ...
                        if ($_GET['group'] == true && $have_group_global_enabled) {
                            ...
                            <tr id="group_details">
                                ...
                                <td nowrap>
                                    <input class='input-sm' type='text' size='10' name='form_group' id="form_group"
                                           style='width:100%;cursor:pointer;cursor:hand'
                                           placeholder='<?php echo xla('Click to select'); ?>'
                                           value='<?php echo is_null($groupname) ? '' : attr($groupname); ?>'
                                           onclick='sel_group()' title='<?php echo xla('Click to select group'); ?>'
                                           readonly/>
                                    <input class='input-sm' type='hidden' name='form_gid'
                                           value='<?php echo attr($groupid) ?>'/>
                                </td>
                                <td colspan='3' nowrap style='font-size:8pt'>
   <span class="infobox">
    <?php
...
// =======================================
                            ...
                            <td nowrap>
                                ...
                                */
                                ...
                                <input type='hidden' name='form_repeat_exdate' id='form_repeat_exdate'
                                       value='<?php echo attr($repeatexdate); ?>'/>
                            ...
                            <td nowrap>
                                ...
                                <select class='input-sm' name='form_repeat_freq'
                                        title='<?php echo xla('Every, every other, every 3rd, etc.'); ?>'>
                                    <?php
                        ...
                        <tr id="days_every_week_row">
                            <td></td>
                            <td></td>
                            <td><input type='checkbox' id='days_every_week' name='days_every_week'
                                       onclick='set_days_every_week()' <?php echo (isDaysEveryWeek($repeats)) ? " checked" : ""; ?>/>
                            </td>
                        ...
                        <tr>
                            <td nowrap>
                                ...
                                <span id='title_prefcat'
                                      style='display:none'><b><?php echo xlt('Pref Cat'); ?>:</b></span>
                            </td>
                            <td nowrap>
                                ...
                                -->
                                <select class='input-sm' name='form_prefcat' style='width:100%;display:none'
                                        title='<?php echo xla('Preferred Event Category'); ?>'>
                            ...
                            <td nowrap>
                                <input type='text' size='10' class='datepicker' name='form_enddate' id='form_enddate'
                                       value='<?php echo attr(oeFormatShortDate($recurrence_end_date)) ?>'
                                       title='<?php echo xla('last date of this event'); ?>'/>
                                <?php
                                if ($repeatexdate != "") {
                        ...
                        <tr>
                            ...
                            <td colspan='4' nowrap>
                                <input class='input-sm' type='text' size='40' name='form_comments' style='width:100%'
                                       value='<?php echo attr($hometext); ?>'
                        ...
                        <tr>
                            <td nowrap>
                                <span id='title_examenes'
                                      style='display:none'><b><?php echo xlt('Exámenes'); ?>:</b></span>
                            </td>
                            <td colspan='4' nowrap>
                                <input class='input-sm' type='text' size='40' name='form_examenes' style='width:100%'
                                       value="<?php
                                       function Examenes_Planificados($pid)
                                       {
                                           $queryEYE = "SELECT * FROM form_eye_base WHERE pid = ? ORDER BY  id DESC LIMIT 1 ";
                                           $result1 = sqlQuery($queryEYE, array($pid));
                                           $formID = $result1['id'];
                                       ...
                                       if ($row['pc_examenes'] == null) {
                                           ...
                                           echo text($row['pc_examenes']);
                                       }
                                       ?>
"
                                       title='<?php echo xla('Informacián sobre los exámenes que debe realizarse'); ?>'/>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="5" nowrap>
                                <span id='title_datos_cirugia'
                        ...
                        <tr id='dob_row' style='display:<?php echo $dobstyle ?>'>
                            ...
                            <td nowrap>
                                <input type='text' size='10' class='datepicker' name='form_dob' id='form_dob'
                ...
                <td colspan='10' class="buttonbar">
                    <p>
                        ...
                        <?php if (!($GLOBALS['select_multi_providers'])) { //multi providers appt is not supported by check slot avail window, so skip ?>
                            <input type='button' id='find_available'
                                   value='<?php echo xla('Find Available{{Provider}}'); ?>'/>
                        <?php } ?>

                        &nbsp;
                        <input type='button' name='form_delete' id='form_delete'
                               value='<?php echo xla('Delete'); ?>'<?php echo (!$eid) ? " disabled" : ""; ?> />
                        &nbsp;
                        <input type='button' id='cancel' value='<?php echo xla('Cancel'); ?>'/>
                        &nbsp;
                        <input type='button' name='form_duplicate' id='form_duplicate'
                               value='<?php echo xla('Create Duplicate'); ?>'/>
    ...
    <div id="recurr_popup"
         style="visibility: hidden; position: absolute; top: 50px; left: 50px; width: 400px; border: 3px outset yellow; background-color: yellow; padding: 5px;">

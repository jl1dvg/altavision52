...
$queryPlan = "select tp.recommendation_for_follow_up AS recomendacion, tp.treatment_received AS tratamiento
              from forms AS f
...
$OFTid_SQL = sqlQuery($reasonQuery, array($_GET['patientid'], $_GET['visitid']));
$form_id = $OFTid_SQL['id'];

                        ...
                        <div id="NO_1" class="clear_both">
                            <div id="NERVIO_left" name="NERVIO_left" class="exam_section_left borderShadow">
                                ...
                                <div class="TEXT_class" id="NERVIO_left_text" name="NERVIO_left_text">
                                    ...
                                    <i class="closeButton_3 fa fa-database"
                                       title="<?php echo xla('Open/Close the NERVIOl Exam Quick Picks panel'); ?>"
                                    ...
                                    <br/>
                                    <div id="NERVIO_left_1" class="text_clinical">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="NERVIO" name="OSCUP" size="4" id="OSCUP"
                                                           value="<?php echo attr($OSCUP); ?>">
                                                </td>
                                            </tr>

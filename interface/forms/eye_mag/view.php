...
$form_folder = "eye_mag";
$Form_Name = "Eye Exam";
$canEditIssues = acl_check('patients', 'med', '', array('write', 'addonly'));
$form_id = $_REQUEST['id'];
...
<html>
<head>
    <title> <?php echo xlt('Chart'); ?>
        : <?php echo text($pat_data['fname']) . " " . text($pat_data['lname']) . " " . text($visit_date); ?></title>
...
<body class="bgcolor2 eye-mag-ui" background="<?php echo $GLOBALS['backpic'] ?>" style="margin:5px 0 0 0;">
...
<div id="page-wrapper" data-role="page">
    ...
    <div id="Layer3" name="Layer3" class="container-fluid">
        ...
        <!-- start form -->
        <form method="post" action="<?php echo $rootdir; ?>/forms/<?php echo $form_folder; ?>/save.php?mode=update"
              id="eye_mag" class="eye_mag pure-form" name="eye_mag">
            <div id="Layer1" name="Layer1" class="display">
                ...
                <div class="body_top text-center row" id="form_container" name="form_container">
                    ...
                    <input type="hidden" name="PREFS_MR_width" id="PREFS_MR_width"
                           value="<?php echo attr($MR_width); ?>">
                    ...
                    <input type="hidden" name="PREFS_ADDITIONAL" id="PREFS_ADDITIONAL"
                           value="<?php echo attr($ADDITIONAL); ?>">
                    <input type="hidden" name="PREFS_CLINICAL" id="PREFS_CLINICAL"
                           value="<?php echo attr($CLINICAL); ?>">
                    ...
                    <input type="hidden" name="PREFS_HPI_VIEW" id="PREFS_HPI_VIEW"
                           value="<?php echo attr($HPI_VIEW); ?>">
                    <input type="hidden" name="PREFS_EXT_VIEW" id="PREFS_EXT_VIEW"
                           value="<?php echo attr($EXT_VIEW); ?>">
                    <input type="hidden" name="PREFS_ANTSEG_VIEW" id="PREFS_ANTSEG_VIEW"
                           value="<?php echo attr($ANTSEG_VIEW); ?>">
                    <input type="hidden" name="PREFS_RETINA_VIEW" id="PREFS_RETINA_VIEW"
                           value="<?php echo attr($RETINA_VIEW); ?>">
                    <input type="hidden" name="PREFS_NEURO_VIEW" id="PREFS_NEURO_VIEW"
                           value="<?php echo attr($NEURO_VIEW); ?>">
                    <input type="hidden" name="PREFS_ACT_VIEW" id="PREFS_ACT_VIEW"
                           value="<?php echo attr($ACT_VIEW); ?>">
                    <input type="hidden" name="PREFS_PMH_RIGHT" id="PREFS_PMH_RIGHT"
                           value="<?php echo attr($PMH_RIGHT); ?>">
                    <input type="hidden" name="PREFS_HPI_RIGHT" id="PREFS_HPI_RIGHT"
                           value="<?php echo attr($HPI_RIGHT); ?>">
                    <input type="hidden" name="PREFS_EXT_RIGHT" id="PREFS_EXT_RIGHT"
                           value="<?php echo attr($EXT_RIGHT); ?>">
                    <input type="hidden" name="PREFS_ANTSEG_RIGHT" id="PREFS_ANTSEG_RIGHT"
                           value="<?php echo attr($ANTSEG_RIGHT); ?>">
                    <input type="hidden" name="PREFS_RETINA_RIGHT" id="PREFS_RETINA_RIGHT"
                           value="<?php echo attr($RETINA_RIGHT); ?>">
                    <input type="hidden" name="PREFS_NEURO_RIGHT" id="PREFS_NEURO_RIGHT"
                           value="<?php echo attr($NEURO_RIGHT); ?>">
                    <input type="hidden" name="PREFS_IMPPLAN_RIGHT" id="PREFS_IMPPLAN_RIGHT"
                           value="<?php echo attr($IMPPLAN_RIGHT); ?>">
                    <input type="hidden" name="PREFS_PANEL_RIGHT" id="PREFS_PANEL_RIGHT"
                           value="<?php echo attr($PANEL_RIGHT); ?>">
                    <input type="hidden" name="PREFS_KB" id="PREFS_KB" value="<?php echo attr($KB_VIEW); ?>">
                    <input type="hidden" name="PREFS_TOOLTIPS" id="PREFS_TOOLTIPS"
                           value="<?php echo attr($TOOLTIPS); ?>">
                    <input type="hidden" name="ownership" id="ownership" value="<?php echo attr($ownership); ?>">
                    <input type="hidden" name="PREFS_ACT_SHOW" id="PREFS_ACT_SHOW"
                           value="<?php echo attr($ACT_SHOW); ?>">
                    ...
                    <input type='hidden' name='setting_ANTSEG' id='setting_ANTSEG'
                           value='<?php echo attr($setting_ANTSEG); ?>'>
                    <input type='hidden' name='setting_POSTSEG' id='setting_POSTSEG'
                           value='<?php echo attr($setting_POSTSEG); ?>'>
                    <input type='hidden' name='setting_NEURO' id='setting_NEURO'
                           value='<?php echo attr($setting_NEURO); ?>'>
                    <input type='hidden' name='setting_IMPPLAN' id='setting_IMPPLAN'
                           value='<?php echo attr($setting_IMPPLAN); ?>'>
                                ...
                                <div id="HPI_left" name="HPI_left" class="exam_section_left borderShadow">
                                    <div id="HPI_left_text" class="TEXT_class">
                                        <span class="closeButton_2 fa fa-paint-brush"
                                              title="<?php echo xla('Open/Close the HPI Canvas'); ?>"
                                              id="BUTTON_DRAW_HPI" name="BUTTON_DRAW_HPI"></span>
                                        <i class="closeButton_3 fa fa-database"
                                           title="<?php echo xla('Open/Close the detailed HPI panel'); ?>"
                                           id="BUTTON_QP_HPI" name="BUTTON_QP_HPI"></i>
                                        <i class="closeButton_4 fa fa-user-md fa-sm fa-2" name="Shorthand_kb"
                                           title="<?php echo xla("Open/Close the Shorthand Window and display Shorthand Codes next to each field") . ". " . xla('Document clinical findings in Shorthand Format') . " <b>" . xla('FIELD: Text(.a); '); ?></b>."></i>
                                        <i class="closeButton fa fa-minus-circle"
                                           title="<?php echo xla('Minimize this panel'); ?>" id="BUTTON_TAB_HPI"
                                           name="BUTTON_TAB_HPI"></i>
                                        ...
                                        <div id="tabs_wrapper">
                                            <div id="tabs_container">
                                                <ul id="tabs">
                                                    ...
                                                    <li id="tab1_CC" class="active"><a class="fa fa-check"
                                                                                       href="#tab1"> <?php echo xlt('CC{{Chief Complaint}}'); ?>
                                                            1</a></li>
                                                    <li id="tab2_CC"><a <?php if ($CC2 > '') {
                                                            echo 'class="fa fa-check"';
                                                        } ?> href="#tab2"><?php echo xlt('CC{{Chief Complaint}}'); ?>
                                                            2</a></li>
                                                    <li id="tab3_CC"><a <?php if ($CC3 > '') {
                                                            echo 'class="fa fa-check"';
                                                        } ?> href="#tab3"><?php echo xlt('CC{{Chief Complaint}}'); ?>
                                                            3</a></li>
                                                </ul>
                                            </div>
                                                    ...
                                                    <table border="0" width="100%" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td class="pad10" colspan="2">
                                                                ...
                                                                <br/>
                                                                <textarea name="CC1" id="CC1" class="HPI_text"
                                                                          tabindex="10"><?php echo text($CC1); ?></textarea>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="top pad10">
                                      <span id="HPI_HELP"
                                            title="<?php echo xla('History of Present Illness: A detailed HPI may be completed by using either four or more HPI elements OR the status of three chronic or inactive problems.'); ?>"><?php echo xlt('HPI'); ?>
                                          :
                                        </span>
                                                                <div class="kb kb_left">HPI</div>
                                                                <br/>
                                                                <textarea name="HPI1" id="HPI1" class="HPI_text"
                                                                          tabindex="21"><?php echo text($HPI1); ?></textarea>
                                                                <br/>
                                                            </td>
                                                            <td class="top pad10"><span id="CHRONIC_HELP"
                                                                                        title="<?php echo xla('Chronic/Inactive Problems') . ":&nbsp\n" . xla('document 3 and their status to reach the detailed HPI level') . "&nbsp\n";
                                                                                        echo "PMH items flagged as Chronic with a comment regarding status will automatically appear here."; ?>"><?php echo xlt('Chronic Problems') ?>
                                                                    :</span>
                                                                <span class="kb_off"><br/></span>
                                                                <div class="kb kb_right">CHRONIC1</div>
                                                                <textarea name="CHRONIC1" id="CHRONIC1"
                                                                          class="HPI_text chronic_HPI"
                                                                          tabindex="22"><?php echo text($CHRONIC1); ?></textarea>
                                                                <span class="kb_off"><br/></span>
                                                                <div class="kb kb_right">CHRONIC2</div>
                                                                <textarea name="CHRONIC2" id="CHRONIC2"
                                                                          class="HPI_text chronic_HPI"
                                                                          tabindex="23"><?php echo text($CHRONIC2); ?></textarea>
                                                                <span class="kb_off"><br/></span>
                                                                <div class="kb kb_right">CHRONIC3</div>
                                                                <textarea name="CHRONIC3" id="CHRONIC3"
                                                                          class="HPI_text chronic_HPI"
                                                                          tabindex="24"><?php echo text($CHRONIC3); ?></textarea>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2" class="center">
                                                                <i id="CODE_HIGH_0" name="CODE_HIGH"
                                                                   class="CODE_HIGH fa fa-check nodisplay"
                                                                   value="1"></i>
                                        ...
                                        <span class="detail_4_elements"
                                              name=""><?php echo xlt('> 3 HPI elements'); ?></span> <?php echo xlt('OR{{as in AND/OR, ie. not an abbreviation}}'); ?>
                                                ...
                                                <div id="tab2_CC_text" class="tab_content">
                                                    <table class="CC_table" border="0" width="100%" cellspacing="0"
                                                           cellpadding="0">
                                                        <tr>
                                                            <td class="top pad10" colspan="2">
                                                                ...
                                                                <br/>
                                                                <textarea name="CC2" id="CC2" class="HPI_text CC_Box"
                                                                          tabindex="10"><?php echo text($CC2); ?></textarea>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="top pad10">
                                        <span class="HPI_TITLE"
                                              title="<?php echo xla('History of Present Illness: A detailed HPI may be completed by using either four or more HPI elements OR the status of three chronic or inactive problems.'); ?>"><?php echo xlt('HPI'); ?>
                                            2:
                                        </span>
                                                                <br/>
                                                                <textarea name="HPI2" id="HPI2" class="HPI_text"
                                                                          tabindex="21"><?php echo text($HPI2); ?></textarea>
                                                                <br/>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table class="CC_table" border="0" width="100%" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="top pad10" colspan="2">
                                                                ...
                                                                <br/>
                                                                <textarea name="CC3" id="CC3" class="HPI_text CC_Box"
                                                                          tabindex="10"><?php echo text($CC3); ?></textarea>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="top pad10">
                                        <span class="HPI_TITLE"
                                            ...
                                            3:
                                                                ...
                                                                <br/>
                                                                <textarea name="HPI3" id="HPI3" class="HPI_text"
                                                                          tabindex="21"><?php echo text($HPI3); ?></textarea>
                                                                <br/>
                                                            </td>
                                                        </tr>
                                                    </table>
                                ...
                                <div id="HPI_right" name="HPI_right" class="exam_section_right borderShadow">
                                    ...
                                    <div id="QP_HPI" name="QP_HPI" class="QP_class left">
                                        <div id="HPI_text_list" name="HPI_text_list">
                                            <span class="closeButton fa fa-close pull-right z100" id="BUTTON_TEXTD_HPI"
                                                  name="BUTTON_TEXTD_HPI" value="1"></span>
                                            ...
                                            <div id="tabs_wrapper">
                                                ...
                                                <div id="tabs_content_container" class="borderShadow">
                                                    <div id="tab1_HPI_text" class="tab_content">
                                                        <table>
                                                            <tr>
                                                                <td class="right"><b><?php echo xlt('Timing'); ?>:</b>
                                                                </td>
                                                                <td>
                                                                    <textarea name="TIMING1" id="TIMING1"
                                                                              class="count_HPI"
                                                                              tabindex="30"><?php echo text($TIMING1); ?></textarea>
                                                                </td>
                                                                <td>
                                                                    <i><?php echo xlt('When and how often?'); ?></i><br/>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="right"><b><?php echo xlt('Context'); ?>:</b>
                                                                </td>
                                                                <td>
                                                                    <textarea name="CONTEXT1" id="CONTEXT1"
                                                                              class="count_HPI"
                                                                              tabindex="31"><?php echo text($CONTEXT1); ?></textarea>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td class="right"><b><?php echo xlt('Severity'); ?>:</b>
                                                                </td>
                                                                <td>
                                                                    <textarea name="SEVERITY1" id="SEVERITY1"
                                                                              class="count_HPI"
                                                                              tabindex="32"><?php echo text($SEVERITY1); ?></textarea>
                                                                </td>
                                                                <td>
                                                                    <i><?php echo xlt('How bad is it? 0-10, mild, mod, severe?'); ?></i>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="right"><b><?php echo xlt('Modifying'); ?>
                                                                        :</b></td>
                                                                <td>
                                                                    <textarea name="MODIFY1" id="MODIFY1"
                                                                              class="count_HPI"
                                                                              tabindex="33"><?php echo text($MODIFY1); ?></textarea>
                                                                </td>
                                                                <td>
                                                                    <i><?php echo xlt('Does anything make it better? Worse?'); ?></i>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="right"><b><?php echo xlt('Associated'); ?>
                                                                        :</b></td>
                                                                <td>
                                                                    <textarea name="ASSOCIATED1" id="ASSOCIATED1"
                                                                              class="count_HPI"
                                                                              tabindex="34"><?php echo text($ASSOCIATED1); ?></textarea>
                                                                </td>
                                                                <td>
                                                                    <i><?php echo xlt('Anything else occur at the same time?'); ?></i>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="right"><b><?php echo xlt('Location'); ?>:</b>
                                                                </td>
                                                                <td>
                                                                    <textarea name="LOCATION1" id="LOCATION1"
                                                                              class="count_HPI"
                                                                              tabindex="35"><?php echo text($LOCATION1); ?></textarea>
                                                                </td>
                                                                <td>
                                                                    <i><?php echo xlt('Where on your body does it occur?'); ?></i>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="right"><b><?php echo xlt('Quality'); ?>:</b>
                                                                </td>
                                                                <td>
                                                                    <textarea name="QUALITY1" id="QUALITY1"
                                                                              class="count_HPI"
                                                                              tabindex="36"><?php echo text($QUALITY1); ?></textarea>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td class="right"><b><?php echo xlt('Duration'); ?>:</b>
                                                                </td>
                                                                <td><textarea name="DURATION1" id="DURATION1"
                                                                              class="count_HPI"
                                                                              tabindex="37"><?php echo text($DURATION1); ?></textarea>
                                                                </td>
                                                                <td>
                                                        ...
                                                        <center>
                                                            <i id="CODE_HIGH_1" name="CODE_HIGH"
                                                    ...
                                                    <div id="tab2_HPI_text" class="tab_content">
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <textarea name="TIMING2" id="TIMING2" tabindex="30"
                                                                              class="count_HPI"><?php echo text($TIMING2); ?></textarea>
                                                                </td>
                                                                </td>
                                                                <td>
                                                                    <i><?php echo xlt('When and how often?'); ?></i><br/>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <textarea name="CONTEXT2" id="CONTEXT2"
                                                                              tabindex="31"
                                                                              class="count_HPI"><?php echo text($CONTEXT2); ?></textarea>
                                                                    <br/>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <textarea name="SEVERITY2" id="SEVERITY2"
                                                                              tabindex="32"><?php echo text($SEVERITY2); ?></textarea>
                                                                </td>
                                                                <td>
                                                                    <i><?php echo xlt('How bad is it? 0-10, mild, mod, severe?'); ?></i>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td class="right"><b><?php echo xlt('Modifying'); ?>
                                                                        :</b></td>
                                                                <td>
                                                                    <textarea name="MODIFY2" id="MODIFY2" tabindex="33"
                                                                              class="count_HPI"><?php echo text($MODIFY2); ?></textarea>
                                                                </td>
                                                                <td>
                                                                    <i><?php echo xlt('Does anything make it better? Worse?'); ?></i>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td class="right"><b><?php echo xlt('Associated'); ?>
                                                                        :</b></td>
                                                                <td>
                                                                    <textarea name="ASSOCIATED2" id="ASSOCIATED2"
                                                                              tabindex="34"
                                                                              class="count_HPI"><?php echo text($ASSOCIATED2); ?></textarea>
                                                                </td>
                                                                <td>
                                                                    <i><?php echo xlt('Anything else occur at the same time?'); ?></i>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <textarea name="LOCATION2" id="LOCATION2"
                                                                              tabindex="35"
                                                                              class="count_HPI"><?php echo text($LOCATION2); ?></textarea>
                                                                </td>
                                                                <td>
                                                                    <i><?php echo xlt('Where on your body does it occur?'); ?></i>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <textarea name="QUALITY2" id="QUALITY2"
                                                                              tabindex="36"
                                                                              class="count_HPI"><?php echo text($QUALITY2); ?></textarea>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><textarea name="DURATION2" id="DURATION2"
                                                                              tabindex="37"
                                                                              class="count_HPI"><?php echo text($DURATION2); ?></textarea>
                                                                </td>
                                                                <td>
                                                                    <i><?php echo xlt('How long does it last?'); ?></i>
                                                                </td>
                                                        ...
                                                        <center>
                                                            <i id="CODE_HIGH_2" name="CODE_HIGH"
                                                               class="CODE_HIGH fa fa-check nodisplay" value="1"></i>
                                                            <span id="CODE_HELP_2">
                                    <span class="detailed_HPI"><?php echo xlt('Detailed HPI') ?>:</span>
                                    <span
                                                    ...
                                                    <div id="tab3_HPI_text" class="tab_content">
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <textarea name="TIMING3" id="TIMING3" tabindex="30"
                                                                              class="count_HPI"><?php echo text($TIMING3); ?></textarea>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <textarea name="CONTEXT3" id="CONTEXT3"
                                                                              tabindex="31"
                                                                              class="count_HPI"><?php echo text($CONTEXT3); ?></textarea>
                                                                </td>
                                                                <td>
                                                                    <i><?php echo xlt('Does it occur in certain situations?'); ?></i>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <textarea name="SEVERITY3" id="SEVERITY3"
                                                                              tabindex="32"
                                                                              class="count_HPI"><?php echo text($SEVERITY3); ?></textarea>
                                                                </td>
                                                                <td>
                                                                    <i><?php echo xlt('How bad is it? 0-10, mild, mod, severe?'); ?></i>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td class="right"><b><?php echo xlt('Modifying'); ?>
                                                                        :</b></td>
                                                                <td>
                                                                    <textarea name="MODIFY3" id="MODIFY3" tabindex="33"
                                                                              class="count_HPI"><?php echo text($MODIFY3); ?></textarea>
                                                                </td>
                                                                <td>
                                                                    <i><?php echo xlt('Does anything make it better? Worse?'); ?></i>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td class="right"><b><?php echo xlt('Associated'); ?>
                                                                        :</b></td>
                                                                <td>
                                                                    <textarea name="ASSOCIATED3" id="ASSOCIATED3"
                                                                              tabindex="34"
                                                                              class="count_HPI"><?php echo text($ASSOCIATED3); ?></textarea>
                                                                </td>
                                                                <td>
                                                                    <i><?php echo xlt('Anything else occur at the same time?'); ?></i>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <textarea name="LOCATION3" id="LOCATION3"
                                                                              tabindex="35"
                                                                              class="count_HPI"><?php echo text($LOCATION3); ?></textarea>
                                                                </td>
                                                                <td>
                                                                    <i><?php echo xlt('Where on your body does it occur?'); ?></i>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <textarea name="QUALITY3" id="QUALITY3"
                                                                              tabindex="36"
                                                                              class="count_HPI"><?php echo text($QUALITY3); ?></textarea>
                                                                </td>
                                                                <td>
                                                                    <i><?php echo xlt('eg. aching, burning, radiating pain'); ?></i>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <textarea name="DURATION3" id="DURATION3"
                                                                              tabindex="37"
                                                                              class="count_HPI"><?php echo text($DURATION3); ?></textarea>
                                                                </td>
                                                                <td><i><?php echo xlt('How long does it last?'); ?></i>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <center>
                                                            <i id="CODE_HIGH_3" name="CODE_HIGH"
                                                               class="CODE_HIGH fa fa-check nodisplay" value="1"></i>
                                                            <span ID="CODE_HELP_3">
                                    <span class="detailed_HPI"><?php echo xlt('Detailed HPI') ?>:</span>
                                    <span
                            ...
                            <div id="PMH_1" name="PMH_1" class="<?php echo attr($display_Add); ?> clear_both">
                                ...
                                <div id="PMH_left" name="PMH_left" class="exam_section_left borderShadow">
                                    <div id="PMH_left_text" class="TEXT_class">
                                        <b class="left"><?php echo xlt('PMSFH{{Abbreviation for Past medical Surgical Family and Social History}}'); ?>
                                            :</b> <i class="fa fa-help"></i><br/>
                                        <a class="closeButton_2 fa fa-list"
                                           title="<?php echo xla('Toggle the right-sided PMSFH panel'); ?>"
                                           id="right-panel-link" name="right-panel-link" href="#right-panel"></a>
                                        <i class="closeButton_3 fa fa-paint-brush"
                                           title="<?php echo xla('Open/Close the PMH draw panel'); ?>"
                                           id="BUTTON_DRAW_PMH" name="BUTTON_DRAW_PMH"></i>
                                        <i class="closeButton_4 fa fa-database"
                                           title="<?php echo xla('Open/Close the PMSFH summary panel'); ?>"
                                           id="BUTTON_QP_PMH" name="BUTTON_QP_PMH"></i>
                                        <i class="closeButton_5 fa fa-user-md fa-sm fa-2" name="Shorthand_kb"
                                           title="<?php echo xla("Open/Close the Shorthand Window and display Shorthand Codes"); ?>"></i>
                                        <i class="closeButton fa fa-minus-circle"
                                           title="<?php echo xla('Minimize this panel'); ?>" id="BUTTON_TAB_PMH"
                                           name="BUTTON_TAB_PMH"></i>
                    ...
                    ?>
                    <div class="loading row clear_both" id="LayerTechnical_sections_loading"
                         name="LayerTechnical_sections_loading"><i class="fa fa-spinner fa-spin"></i>
                    </div>
                    <div class="clear_both row" id="LayerTechnical_sections_1" name="LayerTechnical_sections">
                        ...
                        <div id="LayerMood" class="vitals">
                            <div id="Lyr2.9" class="top_left">
                                <th class="text_clinical" nowrap><b id="MS_tab"><?php echo xlt('Mental Status'); ?>:</b>
                                </th>
                            </div>
                            <br/>
                            ...
                            <label for="alert"
                                   class="input-helper input-helper--checkbox"><?php echo xlt('Alert{{Mental Status}}'); ?></label><br/>
                            <input type="checkbox" name="oriented" id="oriented" <?php if ($oriented) {
                                echo "checked='checked'";
                            } ?> value="1">
                            <label for="oriented"
                                   class="input-helper input-helper--checkbox"><?php echo xlt('Oriented TPP{{oriented to person and place}}'); ?></label><br/>
                            <input type="checkbox" name="confused" id="confused" <?php if ($confused) {
                                echo "checked='checked'";
                            } ?> value="1">
                            <label for="confused"
                                   class="input-helper input-helper--checkbox"><?php echo xlt('Mood/Affect Nml{{Mood and affect normal}}'); ?></label><br/>
                        ...
                        <div id="LayerVision" class="vitals">
                            <div id="Lyr30" class="top_left">
                                <th class="text_clinical"><b id="vision_tab"
                                                             title="Show/hide the refraction panels"><?php echo xlt('Vision'); ?>
                                        :</b></th>
                            </div>
                            <?php
                          ...
                          <span id="tabs">
                              <ul>
                                  <li id="LayerVision_RXHX_lightswitch" class="<?php echo attr($button_RXHX); ?>"
                                      value="Prior Refractions"
                                      title="<?php echo xla("Show the last three Refractions"); ?>"><?php echo xlt('R{{History of Refraction}}'); ?></li> |
                                  <li id="LayerVision_W_lightswitch" class="<?php echo attr($button_W); ?>"
                                      value="Current"
                                      title="<?php echo xla("Display the patient's current glasses"); ?>"><?php echo xlt('W{{Current Rx - wearing}}'); ?></li> |
                                  <li id="LayerVision_MR_lightswitch" class="<?php echo attr($button_MR); ?>"
                                      value="Auto"
                                      title="<?php echo xla("Display the Manifest Refraction panel"); ?>"><?php echo xlt('MR{{Manifest Refraction}}'); ?></li> |
                                  <li id="LayerVision_CR_lightswitch" class="<?php echo attr($button_AR); ?>"
                                      value="Cyclo"
                                      title="<?php echo xla("Display the Autorefraction Panel"); ?>"><?php echo xlt('AR{{autorefraction}}'); ?></li> |
                                  <li id="LayerVision_CTL_lightswitch" class="<?php echo attr($button_CTL); ?>"
                                      value="Contact Lens"
                                      title="<?php echo xla("Display the Contact Lens Panel"); ?>"><?php echo xlt('CTL{{Contact Lens}}'); ?></li> |
                                  <li id="LayerVision_ADDITIONAL_lightswitch"
                                      class="<?php echo attr($button_ADDITIONAL); ?>" value="Additional"
                                      title="<?php echo xla("Display Additional measurements (Ks, IOL cals, etc)"); ?>"><?php echo xlt('Add.{{Additional Measurements}}'); ?></li> |
                                  <li id="LayerVision_VAX_lightswitch" class="<?php echo attr($button_VAX); ?>"
                                      value="Visual Acuities"
                                      title="<?php echo xla("Summary of Acuities for this patient"); ?>"><?php echo xlt('Va{{Visual Acuities}}'); ?></li>
                              </ul>
                          </span>
                            </div>
                            ...
                            <div id="Visions_A" name="Visions_A">
                                <b>OD</b>
                                <input type="TEXT" tabindex="40" id="SCODVA" name="SCODVA"
                                       value="<?php echo attr($SCODVA); ?>">
                                <input type="TEXT" tabindex="42" id="ODVA_1_copy" name="ODVA_1_copy"
                                       value="<?php echo attr($ODVA_1); ?>">
                                <input type="TEXT" tabindex="44" id="PHODVA_copy" name="PHODVA_copy"
                                       value="<?php echo attr($PHODVA); ?>">
                                <br/>
                                <b>OS</b>
                                <input type="TEXT" tabindex="41" id="SCOSVA" name="SCOSVA"
                                       value="<?php echo attr($SCOSVA); ?>">
                                <input type="TEXT" tabindex="43" id="OSVA_1_copy" name="OSVA_1_copy"
                                       value="<?php echo attr($OSVA_1); ?>">
                                <input type="TEXT" tabindex="45" id="PHOSVA_copy" name="PHOSVA_copy"
                                       value="<?php echo attr($PHOSVA); ?>">
                                <br/>
                                <span id="more_visions_1"
                                      name="more_visions_1"><b><?php echo xlt('Acuity'); ?></b> </span>
                            ...
                            <div id="Visions_B" name="Visions_B" class="nodisplay">
                                <b><?php echo xlt('OD'); ?> </b>
                                <input type="TEXT" tabindex="46" id="ARODVA_copy" name="ARODVA_copy"
                                       value="<?php echo attr($ARODVA); ?>">
                                <input type="TEXT" tabindex="48" id="MRODVA_copy" name="MRODVA_copy"
                                       value="<?php echo attr($MRODVA); ?>">
                                <input type="TEXT" tabindex="50" id="CRODVA_copy" name="CRODVA_copy"
                                       value="<?php echo attr($CRODVA); ?>">
                                <br/>
                                <b><?php echo xlt('OS'); ?> </b>
                                <input type="TEXT" tabindex="47" id="AROSVA_copy" name="AROSVA_copy"
                                       value="<?php echo attr($AROSVA); ?>">
                                <input type="TEXT" tabindex="49" id="MROSVA_copy" name="MROSVA_copy"
                                       value="<?php echo attr($MROSVA); ?>">
                                <input type="TEXT" tabindex="51" id="CROSVA_copy" name="CROSVA_copy"
                                       value="<?php echo attr($CROSVA); ?>">
                                <br/>
                                <span id="more_visions_2"
                                      name="more_visions_2"><b><?php echo xlt('Acuity'); ?></b> </span>
                        ...
                        <div id="LayerTension" class="vitals">
                            ...
                            <span title="Display the Glaucoma Flow Sheet" id="LayerVision_IOP_lightswitch"
                                  name="LayerVision_IOP_lightswitch" class="closeButton fa  fa-line-chart"
                                  id="IOP_Graph" name="IOP_Graph"></span>
                            <!-- -->
                            <div id="Lyr40">
                          <span class="top_left">
                              ...
                              <div>
                                    ...
                                    ?>
                                  <input type="text" name="IOPTIME" id="IOPTIME" tabindex="-1"
                                         value="<?php echo attr($show_IOPTIME); ?>">
                            ...
                            <div id="Lyr42">
                                ...
                                <input type="text" tabindex="52" name="ODIOPAP" id="ODIOPAP"
                                       value="<?php echo attr($ODIOPAP); ?>">
                                <input type="text" tabindex="54" name="ODIOPTPN" id="ODIOPTPN"
                                       value="<?php echo attr($ODIOPTPN); ?>">
                                <input type="text" name="ODIOPFTN" id="ODIOPFTN" value="<?php echo attr($ODIOPFTN); ?>">
                                <br/>
                                <b><?php echo xlt('OS{{left eye}}'); ?> </b>
                                <input type="text" tabindex="53" name="OSIOPAP" id="OSIOPAP"
                                       value="<?php echo attr($OSIOPAP); ?>">
                                <input type="text" tabindex="55" name="OSIOPTPN" id="OSIOPTPN"
                                       value="<?php echo attr($OSIOPTPN); ?>">
                        ...
                        <span class="top_left">
                            ...
                            <div id="Lyr501">
                                <label for="Amsler-Normal"
                                       class="input-helper input-helper--checkbox"><?php echo xlt('Normal'); ?></label>
                        ...
                        <div id="LayerFields" class="vitals">
                            ...
                            ?>
                            <div id="Lyr60">
                                <label for="FieldsNormal"
                                       class="input-helper input-helper--checkbox"><?php echo xlt('FTCF{{Full to count fingers}}'); ?></label>
                                <input id="FieldsNormal" type="checkbox" value="1" <?php echo attr($VFFTCF); ?>>
                            </div>
                            <div id="Lyr511">
                                <table cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td class="center" colspan="2"><b><?php echo xlt('OD{{right eye}}'); ?></b><br/>
                                        </td>
                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                    ...
                                    <tr>
                                        <td class="VF_1">
                                            <input name="ODVF1" id="ODVF1"
                                                   type="checkbox" <?php echo attr($ODVF['1']) ?> class="hidden">
                                            <label for="ODVF1"
                                                   class="input-helper input-helper--checkbox boxed"></label>
                                        </td>
                                        <td class="VF_2">
                                            <input name="ODVF2" id="ODVF2"
                                                   type="checkbox" <?php echo attr($ODVF['2']) ?> class="hidden">
                                            <label for="ODVF2"
                                                   class="input-helper input-helper--checkbox boxed"></label>
                                        </td>
                                        <td></td>
                                        <td class="VF_1">
                                            <input name="OSVF1" id="OSVF1"
                                                   type="checkbox" <?php echo attr($OSVF['1']); ?> class="hidden">
                                            <label for="OSVF1"
                                                   class="input-helper input-helper--checkbox boxed"></label>
                                        </td>
                                        <td class="VF_2">
                                            <input name="OSVF2" id="OSVF2"
                                                   type="checkbox" <?php echo attr($OSVF['2']); ?> class="hidden">
                                            <label for="OSVF2"
                                                   class="input-helper input-helper--checkbox boxed"> </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="VF_3">
                                            <input name="ODVF3" id="ODVF3" type="checkbox"
                                                   class="hidden" <?php echo attr($ODVF['3']); ?>>
                                            <label for="ODVF3"
                                                   class="input-helper input-helper--checkbox boxed"></label>
                                        </td>
                                        <td class="VF_4">
                                            <input name="ODVF4" id="ODVF4" type="checkbox"
                                                   class="hidden" <?php echo attr($ODVF['4']); ?>>
                                            <label for="ODVF4"
                                                   class="input-helper input-helper--checkbox boxed"></label>
                                        </td>
                                        <td></td>
                                        <td class="VF_3">
                                            <input name="OSVF3" id="OSVF3" type="checkbox"
                                                   class="hidden" <?php echo attr($OSVF['3']); ?>>
                                            <label for="OSVF3"
                                                   class="input-helper input-helper--checkbox boxed"></label>
                                        </td>
                                        <td class="VF_4">
                                            <input name="OSVF4" id="OSVF4" type="checkbox"
                                                   class="hidden" <?php echo attr($OSVF['4']); ?>>
                                            <label for="OSVF4"
                                                   class="input-helper input-helper--checkbox boxed"></label>
                                        </td>
                                    </tr>
                        ...
                        <div id="LayerPupils" class="vitals">
                            ...
                            <div id="Lyr701">
                                <label for="PUPIL_NORMAL"
                                       class="input-helper input-helper--checkbox"><?php echo xlt('Normal'); ?></label>
                                <input id="PUPIL_NORMAL" name="PUPIL_NORMAL"
                                       type="checkbox" <?php if ($PUPIL_NORMAL == '1') {
                            ...
                            <div id="Lyr70">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pupil_1">
                                            <input type="text" id="ODPUPILSIZE1" name="ODPUPILSIZE1"
                                                   value="<?php echo attr($ODPUPILSIZE1); ?>">
                                            <font>&#8594;</font>
                                            <input type="text" id="ODPUPILSIZE2" size="1" name="ODPUPILSIZE2"
                                                   value="<?php echo attr($ODPUPILSIZE2); ?>">
                                        </td>
                                        <td class="pupil_2">
                                            <input type="text" class="pupil_input_2" name='ODPUPILREACTIVITY'
                                                   id='ODPUPILREACTIVITY'
                                                   value='<?php echo attr($ODPUPILREACTIVITY); ?>'>
                                        </td>
                                        <td class="pupil_3">
                                            <input type="text" class="pupil_input_2" name="ODAPD" id='ODAPD'
                                                   value='<?php echo attr($ODAPD); ?>'>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="pupil_4">
                                            <input type="text" size="1" name="OSPUPILSIZE1" id="OSPUPILSIZE1"
                                                   class="pupil_input" value="<?php echo attr($OSPUPILSIZE1); ?>">
                                            <font>&#8594;</font>
                                            <input type="text" size="1" name="OSPUPILSIZE2" id="OSPUPILSIZE2"
                                                   class="pupil_input" value="<?php echo attr($OSPUPILSIZE2); ?>">
                                        </td>
                                        <td class="pupil_5">
                                            <input type="text" class="pupil_input_2" name='OSPUPILREACTIVITY'
                                                   id='OSPUPILREACTIVITY'
                                                   value="<?php echo attr($OSPUPILREACTIVITY); ?>">
                                        </td>
                                        <td class="pupil_6">
                                            <input type="text" class="pupil_input_2" name="OSAPD" id="OSAPD"
                                                   value='<?php echo attr($OSAPD); ?>'>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <div id="dim_pupils_panel" name="dim_pupils_panel"
                             class="vitals <?php echo attr($display_dim_pupils_panel); ?>">
                            <span class="top_left"><b id="pupils_DIM"><?php echo xlt('Pupils') ?>
                                    : <?php echo xlt('Dim'); ?></b> </span>
                            <div id="Lyr71">
                                <table>
                                    <tr>
                                        <th></th>
                                    ...
                                    <tr>
                                        ...
                                        <td claa="border-bottom">
                                            <input type="text" id="DIMODPUPILSIZE1" name="DIMODPUPILSIZE1"
                                                   value='<?php echo attr($DIMODPUPILSIZE1); ?>'>
                                            <font>&#8594;</font>
                                            <input type="text" id="DIMODPUPILSIZE2" name="DIMODPUPILSIZE2"
                                                   value='<?php echo attr($DIMODPUPILSIZE2); ?>'>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><b><?php echo xlt('OS{{left eye}}'); ?></b>
                                        ...
                                        <td class="border-top">
                                            <input type="text" name="DIMOSPUPILSIZE1" id="DIMOSPUPILSIZE1"
                                                   value="<?php echo attr($DIMOSPUPILSIZE1); ?>">
                                            <font>&#8594;</font>
                                            <input type="text" name="DIMOSPUPILSIZE2" id="DIMOSPUPILSIZE2"
                                                   value="<?php echo attr($DIMOSPUPILSIZE2); ?>">
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            <div class="pupil_dim_comments">
                                ...
                                <textarea id="PUPIL_COMMENTS"
                                          name="PUPIL_COMMENTS"><?php echo text($PUPIL_COMMENTS); ?></textarea>
                            </div>
                        </div>
                    ...
                    <div id="REFRACTION_sections" name="REFRACTION_sections" class="row nodisplay clear_both">
                        <div id="LayerVision2">
                            ...
                            <div id="LayerVision_W" class="<?php echo $display_W; ?> ">
                                ...
                                <div id="LayerVision_W_1" name="currentRX"
                                     class="refraction current_W borderShadow <?php echo $display_W_width; ?>">
                                    ...
                                    <i class="closeButton_2 fa fa-arrows-h " id="W_width_display_1"
                                    ...
                                    <i onclick="top.restoreSession();  doscript('W','<?php echo attr($pid); ?>','<?php echo attr($encounter); ?>','1'); return false;"
                                       title="<?php echo xla("Dispense this Rx"); ?>"
                                       class="closeButton_3 fa fa-print"></i>
                                    <i onclick="top.restoreSession();  dispensed('<?php echo attr($pid); ?>');return false;"
                                       title="<?php echo xla("List of previously dispensed Spectacle and Contact Lens Rxs"); ?>"
                                    ...
                                    <table id="wearing_1">
                                        ...
                                        <tr>
                                            ...
                                            <td><i class="fa fa-gamepad" name="reverseme"
                                                   ...
                                                   aria-hidden="true" id="revW1"></i></td>
                                            ...
                                            <td name="W_wide"></td>
                                            <td name="W_wide"
                                                title="<?php echo xla('Horizontal Prism Power'); ?>"><?php echo xlt('HP{{abbreviation for Horizontal Prism Power}}'); ?></td>
                                            <td name="W_wide"
                                                title="<?php echo xla('Horizontal Prism Base'); ?>"><?php echo xlt('HB{{abbreviation for Horizontal Prism Base}}'); ?></td>
                                            <td name="W_wide"
                                                title="<?php echo xla('Vertical Prism Power'); ?>"><?php echo xlt('VP{{abbreviation for Vertical Prism Power}}'); ?></td>
                                            <td name="W_wide"
                                                title="<?php echo xla('Vertical Prism Base'); ?>"><?php echo xlt('VB{{abbreviation for Vertical Prism Base}}'); ?></td>
                                            <td name="W_wide"
                                                title="<?php echo xla('Slab Off'); ?>"><?php echo xlt('Slab Off'); ?></td>
                                            <td name="W_wide"
                                                title="<?php echo xla('Vertex Distance'); ?>"><?php echo xlt('VD{{abbreviation for Vertex Distance}}'); ?></td>
                                            <td name="W_wide"
                                            ...
                                            <td rowspan="6" class="right">
                                                ...
                                                <input type="radio" value="0" id="Single_1"
                                                       name="RX_TYPE_1" <?php if ($RX_TYPE_1 == '0') {
                                                    echo 'checked="checked"';
                                                } ?> /></span><br/>
                                                <label for="Bifocal_1"
                                                       class="input-helper input-helper--checkbox"><?php echo xlt('Bifocal'); ?></label>
                                                <input type="radio" value="1" id="Bifocal_1"
                                                       name="RX_TYPE_1" <?php if ($RX_TYPE_1 == '1') {
                                                    echo 'checked="checked"';
                                                } ?> /></span><br/>
                                                <label for="Trifocal_1"
                                                       class="input-helper input-helper--checkbox"><?php echo xlt('Trifocal'); ?></label>
                                                <input type="radio" value="2" id="Trifocal_1"
                                                       name="RX_TYPE_1" <?php if ($RX_TYPE_1 == '2') {
                                                    echo 'checked="checked"';
                                                } ?> /></span><br/>
                                                <label for="Progressive_1"
                                                       class="input-helper input-helper--checkbox"><?php echo xlt('Prog.{{Progressive lenses}}'); ?></label>
                                                <input type="radio" value="3" id="Progressive_1"
                                                       name="RX_TYPE_1" <?php if ($RX_TYPE_1 == '3') {
                                                    echo 'checked="checked"';
                                                } ?> /></span><br/>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><input type="text" class="sphere" id="ODSPH_1" name="ODSPH_1"
                                                       value="<?php echo attr($ODSPH_1); ?>" tabindex="100"></td>
                                            <td><input type="text" class="cylinder" id="ODCYL_1" name="ODCYL_1"
                                                       value="<?php echo attr($ODCYL_1); ?>" tabindex="101"></td>
                                            <td><input type="text" class="axis" id="ODAXIS_1" name="ODAXIS_1"
                                                       value="<?php echo attr($ODAXIS_1); ?>" tabindex="102"></td>
                                            <td><input type="text" class="acuity" id="ODVA_1" name="ODVA_1"
                                                       value="<?php echo attr($ODVA_1); ?>" tabindex="108"></td>

                                            <td name="W_wide"></td>
                                            <td name="W_wide"><input type="text" class="prism" id="ODHPD_1"
                                                                     name="ODHPD_1"
                                                                     value="<?php echo attr($ODHPD_1); ?>"
                                                                     tabindex="122"></td>
                                            <td name="W_wide"><input type="text" class="prism" id="ODHBASE_1"
                                                                     name="ODHBASE_1"
                                                                     value="<?php echo attr($ODHBASE_1); ?>"
                                                                     tabindex="124"></td>
                                            <td name="W_wide"><input type="text" class="prism" id="ODVPD_1"
                                                                     name="ODVPD_1"
                                                                     value="<?php echo attr($ODVPD_1); ?>"
                                                                     tabindex="126"></td>
                                            <td name="W_wide"><input type="text" class="prism" id="ODVBASE_1"
                                                                     name="ODVBASE_1"
                                                                     value="<?php echo attr($ODVBASE_1); ?>"
                                                                     tabindex="128"></td>
                                            <td name="W_wide"><input type="text" class="prism" id="ODSLABOFF_1"
                                                                     name="ODSLABOFF_1"
                                                                     value="<?php echo attr($ODSLABOFF_1); ?>"
                                                                     tabindex="130"></td>
                                            <td name="W_wide"><input type="text" class="prism" id="ODVERTEXDIST_1"
                                                                     name="ODVERTEXDIST_1"
                                                                     value="<?php echo attr($ODVERTEXDIST_1); ?>"
                                                                     tabindex="132"></td>
                                            <td name="W_wide"><input type="text" class="prism" id="ODMPDD_1"
                                                                     name="ODMPDD_1"
                                                                     value="<?php echo attr($ODMPDD_1); ?>"
                                                                     tabindex="134"></td>
                                            <td name="W_wide"><input type="text" class="prism" id="ODMPDN_1"
                                                                     name="ODMPDN_1"
                                                                     value="<?php echo attr($ODMPDN_1); ?>"
                                                                     tabindex="136"></td>
                                        </tr>
                                        <tr>
                                            <td><b><?php echo xlt('OS{{left eye}}'); ?>:</b></td>
                                            <td><input type="text" class="sphere" id="OSSPH_1" name="OSSPH_1"
                                                       value="<?php echo attr($OSSPH_1); ?>" tabindex="103"></td>
                                            <td><input type="text" class="cylinder" id="OSCYL_1" name="OSCYL_1"
                                                       value="<?php echo attr($OSCYL_1); ?>" tabindex="104"></td>
                                            <td><input type="text" class="axis" id="OSAXIS_1" name="OSAXIS_1"
                                                       value="<?php echo attr($OSAXIS_1); ?>" tabindex="105"></td>
                                            <td><input type="text" class="acuity" id="OSVA_1" name="OSVA_1"
                                                       value="<?php echo attr($OSVA_1); ?>" tabindex="109"></td>

                                            <td name="W_wide"></td>
                                            <td name="W_wide"><input type="text" class="prism" id="OSHPD_1"
                                                                     name="OSHPD_1"
                                                                     value="<?php echo attr($OSHPD_1); ?>"
                                                                     tabindex="123"></td>
                                            <td name="W_wide"><input type="text" class="prism" id="OSHBASE_1"
                                                                     name="OSHBASE_1"
                                                                     value="<?php echo attr($OSHBASE_1); ?>"
                                                                     tabindex="125"></td>
                                            <td name="W_wide"><input type="text" class="prism" id="OSVPD_1"
                                                                     name="OSVPD_1"
                                                                     value="<?php echo attr($OSVPD_1); ?>"
                                                                     tabindex="127"></td>
                                            <td name="W_wide"><input type="text" class="prism" id="OSVBASE_1"
                                                                     name="OSVBASE_1"
                                                                     value="<?php echo attr($OSVBASE_1); ?>"
                                                                     tabindex="129"></td>
                                            <td name="W_wide"><input type="text" class="prism" id="OSSLABOFF_1"
                                                                     name="OSSLABOFF_1"
                                                                     value="<?php echo attr($OSSLABOFF_1); ?>"
                                                                     tabindex="131"></td>
                                            <td name="W_wide"><input type="text" class="prism" id="OSVERTEXDIST_1"
                                                                     name="OSVERTEXDIST_1"
                                                                     value="<?php echo attr($OSVERTEXDIST_1); ?>"
                                                                     tabindex="133"></td>
                                            <td name="W_wide"><input type="text" class="prism" id="OSMPDD_1"
                                                                     name="OSMPDD_1"
                                                                     value="<?php echo attr($OSMPDD_1); ?>"
                                                                     tabindex="135"></td>
                                            <td name="W_wide"><input type="text" class="prism" id="OSMPDN_1"
                                                                     name="OSMPDN_1"
                                                                     value="<?php echo attr($OSMPDN_1); ?>"
                                                                     tabindex="137"></td>
                                        </tr>
                                        <tr class="WNEAR">
                                            <td rowspan=2><?php echo xlt('Mid{{middle Rx strength}}'); ?>
                                                /<br/><?php echo xlt('Near'); ?></td>
                                            <td><b><?php echo xlt('OD{{right eye}}'); ?>:</b></td>
                                            <?php echo '<input type="hidden" name="RXStart_1" id="RXStart_1" value="' . $RX_TYPE_1 . '">'; ?>
                                            <td class="WMid"><input type="text" class="presbyopia" id="ODMIDADD_1"
                                                                    name="ODMIDADD_1"
                                                                    value="<?php echo attr($ODMIDADD_1); ?>"></td>
                                            <td class="WAdd2"><input type="text" class="presbyopia" id="ODADD_1"
                                                                     name="ODADD_1"
                                                                     value="<?php echo attr($ODADD_1); ?>"
                                                                     tabindex="106"></td>
                                            <td></td>
                                            <td><input class="jaeger" type="text" id="ODNEARVA_1" name="ODNEARVA_1"
                                                       value="<?php echo attr($ODNEARVA_1); ?>" tabindex="110"></td>
                                            ...
                                            <td name="W_wide" title="<?php echo xla('Lens Material'); ?>" colspan="2">
                                                <a href="<?php echo $GLOBALS['webroot']; ?>/interface/super/edit_list.php?list_id=Eye_Lens_Material"
                                                   target="RTop"
                                            ...
                                            <td name="W_wide2" colspan="4" rowspan="4">
                                                <a href="<?php echo $GLOBALS['webroot']; ?>/interface/super/edit_list.php?list_id=Eye_Lens_Treatments"
                                                   target="RTop"
                                        ...
                                        <tr class="WNEAR">
                                            <td><b><?php echo xlt('OS{{left eye}}'); ?>:</b></td>
                                            <td class="WMid"><input type="text" class="presbyopia" id="OSMIDADD_1"
                                                                    name="OSMIDADD_1"
                                                                    value="<?php echo attr($OSMIDADD_1); ?>"></td>
                                            <td class="WAdd2"><input type="text" class="presbyopia" id="OSADD_1"
                                                                     name="OSADD_1"
                                                                     value="<?php echo attr($OSADD_1); ?>"
                                                                     tabindex="107"></td>
                                            <td></td>
                                            ...
                                            <td name="W_wide"><input type="text" class="prism" id="BPDN_1" name="BPDN_1"
                                                                     ...
                                                                     tabindex="140"></td>
                                            <td name="W_wide" title="<?php echo xla('Lens Material Options'); ?>"
                            ...
                            <div id="LayerVision_MR"
                                 class="refraction manifest borderShadow <?php echo $display_AR; ?>">
                                <i onclick="top.restoreSession();  dispensed('<?php echo attr($pid); ?>');return false;"
                                   title="<?php echo xla("List of previously dispensed Spectacle and Contact Lens Rxs"); ?>"
                                   class="closeButton_3 fa fa-list-ul"></i>
                                <span class="closeButton_2 fa fa-print" title="<?php echo xla('Dispense this Rx'); ?>"
                                      onclick="top.restoreSession();doscript('MR',<?php echo attr($pid); ?>,<?php echo attr($encounter); ?>);return false;"></span>
                                <span class="closeButton fa  fa-close" id="Close_MR" name="Close_MR"
                                      title="<?php echo xla('Close this panel and make this a Preference to stay closed'); ?>"></span>
                                <table id="dry_wet_refraction">
                                    <th colspan="5"><?php echo xlt('Manifest (Dry) Refraction'); ?></th>
                                    <th NOWRAP colspan="2">
                                        <input type="checkbox" name="BALANCED" id="Balanced"
                                               value="on" <?php if ($BALANCED == 'on') {
                                            echo "checked='checked'";
                                        } ?> tabindex="10182">
                                        <label for="Balanced"
                                               class="input-helper input-helper--checkbox"><?php echo xlt('Balanced'); ?></label>
                                    </th>

                                    <tr>
                                        <td><i class="fa fa-gamepad" name="reverseme"
                                               title="<?php echo xla('Convert between plus and minus cylinder'); ?>"
                                               aria-hidden="true" id="MR"></i></td>
                                        <td><?php echo xlt('Sph{{Sphere}}'); ?></td>
                                        <td><?php echo xlt('Cyl{{Cylinder}}'); ?></td>
                                        <td><?php echo xlt('Axis{{Axis of a glasses prescription}}'); ?></td>
                                        <td><?php echo xlt('Acuity'); ?></td>
                                    ...
                                    <tr>
                                        <td><b><?php echo xlt('OD{{right eye}}'); ?>:</b></td>
                                        <td><input type="text" id="MRODSPH" name="MRODSPH"
                                                   value="<?php echo attr($MRODSPH); ?>" tabindex="10170"></td>
                                        <td><input type="text" id="MRODCYL" name="MRODCYL"
                                                   value="<?php echo attr($MRODCYL); ?>" tabindex="10171"></td>
                                        <td><input type="text" id="MRODAXIS" name="MRODAXIS"
                                                   value="<?php echo attr($MRODAXIS); ?>" tabindex="10172"></td>
                                        <td><input type="text" id="MRODVA" name="MRODVA"
                                                   value="<?php echo attr($MRODVA); ?>" tabindex="10176"></td>
                                        <td><input type="text" id="MRODADD" name="MRODADD"
                                                   value="<?php echo attr($MRODADD); ?>" tabindex="10178"></td>
                                        <td><input class="jaeger" type="text" id="MRNEARODVA" name="MRNEARODVA"
                                                   value="<?php echo attr($MRNEARODVA); ?>" tabindex="10180"></td>
                                        <td><input type="text" id="MRODPRISM" name="MRODPRISM"
                                                   value="<?php echo attr($MRODPRISM); ?>"></td>
                                    </tr>
                                    <tr>
                                        <td><b><?php echo xlt('OS{{left eye}}'); ?>:</b></td>
                                        <td><input type="text" id="MROSSPH" name="MROSSPH"
                                                   value="<?php echo attr($MROSSPH); ?>" tabindex="10173"></td>
                                        <td><input type="text" id="MROSCYL" name="MROSCYL"
                                                   value="<?php echo attr($MROSCYL); ?>" tabindex="10174"></td>
                                        <td><input type="text" id="MROSAXIS" name="MROSAXIS"
                                                   value="<?php echo attr($MROSAXIS); ?>" tabindex="10175"></td>
                                        <td><input type="text" id="MROSVA" name="MROSVA"
                                                   value="<?php echo attr($MROSVA); ?>" tabindex="10177"></td>
                                        <td><input type="text" id="MROSADD" name="MROSADD"
                                                   value="<?php echo attr($MROSADD); ?>" tabindex="10179"></td>
                                        <td><input class="jaeger" type="text" id="MRNEAROSVA" name="MRNEAROSVA"
                                                   value="<?php echo attr($MRNEAROSVA); ?>" tabindex="10181"></td>
                                        <td><input type="text" id="MROSPRISM" name="MROSPRISM"
                                                   value="<?php echo attr($MROSPRISM); ?>"></td>
                                    </tr>
                                </table>

                                <table>
                                    <th colspan="7"><?php echo xlt('Cycloplegic (Wet) Refraction'); ?></th>
                                    <th><i title="<?php echo xla("Dispense Rx"); ?>" class="fa fa-print"
                                           onclick="top.restoreSession();doscript('CR',<?php echo attr($pid); ?>,<?php echo attr($encounter); ?>);return false;"></i>
                                    </th>

                                    <tr>
                                        <td><i class="fa fa-gamepad" name="reverseme"
                                               title="<?php echo xla('Convert between plus and minus cylinder'); ?>"
                                               aria-hidden="true" id="CR"></i></td>
                                        <td><?php echo xlt('Sph{{Sphere}}'); ?></td>
                                        <td><?php echo xlt('Cyl{{Cylinder}}'); ?></td>
                                        <td><?php echo xlt('Axis{{Axis of a glasses prescription}}'); ?></td>
                                        <td><?php echo xlt('Acuity'); ?></td>
                                        <td rowspan="3">
                                            <ul>
                                                <li>
                                                    <input type="radio" name="WETTYPE" id="Streak"
                                                           value="Streak" <?php if ($WETTYPE == "Streak") {
                                                        echo "checked='checked'";
                                                    } ?>/>
                                                    <label for="Streak"
                                                           class="input-helper input-helper--checkbox"><?php echo xlt('Streak'); ?></label>
                                                </li>
                                                <li>
                                                    <input type="radio" name="WETTYPE" id="Auto"
                                                           value="Auto" <?php if ($WETTYPE == "Auto") {
                                                        echo "checked='checked'";
                                                    } ?>>
                                                    <label for="Auto"
                                                           class="input-helper input-helper--checkbox"><?php echo xlt('Auto{{autorefraction}}'); ?></label>
                                                </li>

                                                <li>
                                                    <input type="radio" name="WETTYPE" id="Manual"
                                                           value="Manual" <?php if ($WETTYPE == "Manual") {
                                                        echo "checked='checked'";
                                                    } ?>>
                                                    <label for="Manual"
                                                           class="input-helper input-helper--checkbox"><?php echo xlt('Manual'); ?></label>
                                                </li>
                                            </ul>
                                        </td>
                                    ...
                                    <tr>
                                        <td><b><?php echo xlt('OD{{right eye}}'); ?>:</b></td>
                                        <td><input type="text" id="CRODSPH" name="CRODSPH"
                                                   value="<?php echo attr($CRODSPH); ?>" tabindex="10183"></td>
                                        <td><input type="text" id="CRODCYL" name="CRODCYL"
                                                   value="<?php echo attr($CRODCYL); ?>" tabindex="10184"></td>
                                        <td><input type="text" id="CRODAXIS" name="CRODAXIS"
                                                   value="<?php echo attr($CRODAXIS); ?>" tabindex="10185"></td>
                                        <td><input type="text" id="CRODVA" name="CRODVA"
                                                   value="<?php echo attr($CRODVA); ?>" tabindex="10189"></td>
                                        <td><input type="text" id="ODIOPPOST" name="ODIOPPOST"
                                                   value="<?php echo attr($ODIOPPOST); ?>">
                                    </tr>
                                    <tr>
                                        <td><b><?php echo xlt('OS{{left eye}}'); ?>:</b></td>
                                        <td><input type="text" id="CROSSPH" name="CROSSPH"
                                                   value="<?php echo attr($CROSSPH); ?>" tabindex="10186"></td>
                                        <td><input type="text" id="CROSCYL" name="CROSCYL"
                                                   value="<?php echo attr($CROSCYL); ?>" tabindex="10187"></td>
                                        <td><input type="text" id="CROSAXIS" name="CROSAXIS"
                                                   value="<?php echo attr($CROSAXIS); ?>" tabindex="10188"></td>
                                        <td><input type="text" id="CROSVA" name="CROSVA"
                                                   value="<?php echo attr($CROSVA); ?>" tabindex="10190"></td>

                                        <td><input type="text" id="OSIOPPOST" name="OSIOPPOST"
                                                   value="<?php echo attr($OSIOPPOST); ?>"></td>
                                    </tr>
                                </table>
                            </div>
                                            ...
                                            <div id="CTL_box">
                                                <table>
                                                    <tr>
                                                        <td></td>
                                                        <td>
                                                            <a href="<?php echo $GLOBALS['webroot']; ?>/interface/super/edit_list.php?list_id=CTLManufacturer"
                                                               target="RTop"
                            ...
                            <div id="LayerVision_ADDITIONAL"
                                 class="refraction borderShadow <?php echo $display_Add; ?>">
                                <span title="<?php echo xla('Close and make this a Preference to stay closed'); ?>"
                                      class="closeButton fa  fa-close" id="Close_ADDITIONAL"
                                      name="Close_ADDITIONAL"></span>
                                ...
                                <table id="Additional">
                                    ...
                                    <tr>
                                        <td><b><?php echo xlt('OD{{right eye}}'); ?>:</b></td>
                                        <td><input type="text" id="PHODVA" name="PHODVA"
                                                   title="<?php echo xla('Pinhole Vision'); ?>"
                                                   value="<?php echo attr($PHODVA); ?>" tabindex="10251"></td>
                                        <td><input type="text" id="PAMODVA" name="PAMODVA"
                                                   title="<?php echo xla('Potential Acuity Meter'); ?>"
                                                   value="<?php echo attr($PAMODVA); ?>" tabindex="10253"></td>
                                        <td><input type="text" id="LIODVA" name="LIODVA"
                                                   title="<?php echo xla('Laser Interferometry'); ?>"
                                                   value="<?php echo attr($LIODVA); ?>" tabindex="10255"></td>
                                        <td><input type="text" id="GLAREODVA" name="GLAREODVA"
                                                   title="<?php echo xla('Brightness Acuity Testing'); ?>"
                                                   value="<?php echo attr($GLAREODVA); ?>" tabindex="10257"></td>
                                        ...
                                        <td><input type="text" id="ODK2AXIS" name="ODK2AXIS"
                                                   value="<?php echo attr($ODK2AXIS); ?>" tabindex="10261"></td>
                                    </tr>
                                    <tr>
                                        <td><b><?php echo xlt('OS{{left eye}}'); ?>:</b></td>
                                        <td><input type="text" id="PHOSVA" name="PHOSVA"
                                                   title="<?php echo xla('Pinhole Vision'); ?>"
                                                   value="<?php echo attr($PHOSVA); ?>" tabindex="10252"></td>
                                        <td><input type="text" id="PAMOSVA" name="PAMOSVA"
                                                   title="<?php echo xla('Potential Acuity Meter'); ?>"
                                                   value="<?php echo attr($PAMOSVA); ?>" tabindex="10254"></td>
                                        <td><input type="text" id="LIOSVA" name="LIOSVA"
                                                   title="<?php echo xla('Laser Interferometry'); ?>"
                                                   value="<?php echo attr($LIOSVA); ?>" tabindex="10256"></td>
                                        <td><input type="text" id="GLAREOSVA" name="GLAREOSVA"
                                                   title="<?php echo xla('Brightness Acuity Testing'); ?>"
                                                   value="<?php echo attr($GLAREOSVA); ?>" tabindex="10258"></td>
                                        ...
                                        <td><input type="text" id="OSK2AXIS" name="OSK2AXIS"
                                                   value="<?php echo attr($OSK2AXIS); ?>" tabindex="10264"></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><b><?php echo xlt('OD{{right eye}}'); ?>:</b></td>
                                        <td><input type="text" id="ODAXIALLENGTH" name="ODAXIALLENGTH"
                                                   value="<?php echo attr($ODAXIALLENGTH); ?>" tabindex="10265"></td>
                                        <td><input type="text" id="ODACD" name="ODACD"
                                                   value="<?php echo attr($ODACD); ?>" tabindex="10267"></td>
                                        <td><input type="text" id="ODPDMeasured" name="ODPDMeasured"
                                                   value="<?php echo attr($ODPDMeasured); ?>" tabindex="10269"></td>
                                        <td><input type="text" id="ODLT" name="ODLT" value="<?php echo attr($ODLT); ?>"
                                                   tabindex="10271"></td>
                                        <td><input type="text" id="ODW2W" name="ODW2W"
                                                   value="<?php echo attr($ODW2W); ?>" tabindex="10273"></td>
                                        <td><input type="text" id="ODECL" name="ODECL"
                                                   value="<?php echo attr($ODECL); ?>" tabindex="10275"></td>
                                        <td rowspan="2"><input type="text" id="BINOCVA" name="BINOCVA"
                                                               value="<?php echo attr($BINOCVA); ?>"></td>
                                    </tr>
                                    <tr>
                                        <td><b><?php echo xlt('OS{{left eye}}'); ?>:</b></td>
                                        <td><input type="text" id="OSAXIALLENGTH" name="OSAXIALLENGTH"
                                                   value="<?php echo attr($OSAXIALLENGTH); ?>" tabindex="10266"></td>
                                        <td><input type="text" id="OSACD" name="OSACD"
                                                   value="<?php echo attr($OSACD); ?>" tabindex="10268"></td>
                                        <td><input type="text" id="OSPDMeasured" name="OSPDMeasured"
                                                   value="<?php echo attr($OSPDMeasured); ?>" tabindex="10270"></td>
                                        <td><input type="text" id="OSLT" name="OSLT" value="<?php echo attr($OSLT); ?>"
                                                   tabindex="10272"></td>
                                        <td><input type="text" id="OSW2W" name="OSW2W"
                                                   value="<?php echo attr($OSW2W); ?>" tabindex="10274"></td>
                                        <td><input type="text" id="OSECL" name="OSECL"
                                                   value="<?php echo attr($OSECL); ?>" tabindex="10276"></td>
                            ...
                            <div id="LayerVision_VAX" class="refraction borderShadow <?php echo $display_Add; ?>">
                                ...
                                <table id="Additional_VA">
                                    ...
                                    <tr>
                                        <td><b><?php echo xlt('OD{{right eye}}'); ?>:</b></td>
                                        <td><input type="text" id="SCODVA_copy_brd" name="SCODVA_copy_brd"
                                                   value="<?php echo attr($SCODVA); ?>" tabindex="10300"></td>
                                        <td><input type="text" id="ODVA_1_copy_brd" name="ODVA_1_copy_brd"
                                                   value="<?php echo attr($ODVA_1); ?>" tabindex="10302"></td>
                                        <td><input type="text" id="ARODVA_copy_brd" name="ARODVA_copy_brd"
                                                   value="<?php echo attr($ARODVA); ?>" tabindex="10304"></td>
                                        <td><input type="text" id="MRODVA_copy_brd" name="MRODVA_copy_brd"
                                                   value="<?php echo attr($MRODVA); ?>" tabindex="10306"></td>
                                        <td><input type="text" id="CRODVA_copy_brd" name="CRODVA_copy_brd"
                                                   value="<?php echo attr($CRODVA); ?>" tabindex="10308"></td>
                                        <td><input type="text" id="PHODVA_copy_brd" name="PHODVA_copy_brd"
                                                   value="<?php echo attr($PHODVA); ?>" tabindex="10310"></td>
                                        <td><input type="text" id="CTLODVA_copy_brd" name="CTLODVA_copy_brd"
                                                   value="<?php echo attr($CTLODVA); ?>" tabindex="10312"></td>
                                    </tr>
                                    <tr>
                                        <td><b><?php echo xlt('OS{{left eye}}'); ?>:</b></td>
                                        <td><input type="text" id="SCOSVA_copy" name="SCOSVA_copy"
                                                   value="<?php echo attr($SCOSVA); ?>" tabindex="10301"></td>
                                        <td><input type="text" id="OSVA_1_copy_brd" name="OSVA_1_copy_brd"
                                                   value="<?php echo attr($OSVA_1); ?>" tabindex="10303"></td>
                                        <td><input type="text" id="AROSVA_copy_brd" name="AROSVA_copy_brd"
                                                   value="<?php echo attr($AROSVA); ?>" tabindex="10305"></td>
                                        <td><input type="text" id="MROSVA_copy_brd" name="MROSVA_copy_brd"
                                                   value="<?php echo attr($MROSVA); ?>" tabindex="10307"></td>
                                        <td><input type="text" id="CROSVA_copy_brd" name="CROSVA_copy_brd"
                                                   value="<?php echo attr($CROSVA); ?>" tabindex="10309"></td>
                                        <td><input type="text" id="PHOSVA_copy_brd" name="PHOSVA_copy_brd"
                                                   value="<?php echo attr($PHOSVA); ?>" tabindex="10311"></td>
                                        <td><input type="text" id="CTLOSVA_copy_brd" name="CTLOSVA_copy_brd"
                                                   value="<?php echo attr($CTLOSVA); ?>" tabindex="10313"></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><b><?php echo xlt('OD{{right eye}}'); ?>:</b></td>
                                        <td><input class="jaeger" type="text" id="SCNEARODVA"
                                                   title="<?php echo xla('Near Acuity without Correction'); ?>"
                                                   name="SCNEARODVA" value="<?php echo attr($SCNEARODVA); ?>"
                                                   tabindex="10320"></td>
                                        <td><input class="jaeger" type="text" id="ODNEARVA_1_copy_brd"
                                                   title="<?php echo xla('Near Acuity with Correction'); ?>"
                                                   name="ODNEARVA_1_copy_brd" value="<?php echo attr($ODNEARVA_1); ?>"
                                                   tabindex="10322"></td>
                                        <td><input class="jaeger" type="text" id="ARNEARODVA_copy_brd"
                                                   title="<?php echo xla('Near Acuity AutoRefraction'); ?>"
                                                   name="ARNEARODVA_copy_brd" value="<?php echo attr($ARNEARODVA); ?>"
                                                   tabindex="10324"></td>
                                        <td><input class="jaeger" type="text" id="MRNEARODVA_copy_brd"
                                                   title="<?php echo xla('Near Acuity Manifest Refraction'); ?>"
                                                   name="MRNEARODVA_copy_brd" value="<?php echo attr($MRNEARODVA); ?>"
                                                   tabindex="10326"></td>
                                        <td><input type="text" id="PAMODVA_copy_brd"
                                                   title="<?php echo xla('Potential Acuity Meter'); ?>"
                                                   name="PAMODVA_copy_brd" value="<?php echo attr($PAMODVA); ?>"
                                                   tabindex="10328"></td>
                                        <td><input type="text" id="GLAREODVA_copy_brd"
                                                   title="<?php echo xla('Brightness Acuity Testing'); ?>"
                                                   name="GLAREODVA_copy_brd" value="<?php echo attr($GLAREODVA); ?>"
                                                   tabindex="10330"></td>
                                        <td><input type="text" id="CONTRASTODVA_copy_brd"
                                                   title="<?php echo xla('Contrast Acuity Testing'); ?>"
                                                   name="CONTRASTODVA_copy_brd"
                                                   value="<?php echo attr($CONTRASTODVA); ?>" tabindex="10332"></td>
                                    </tr>
                                    <tr>
                                        <td><b><?php echo xlt('OS{{left eye}}'); ?>:</b></td>
                                        <td><input class="jaeger" type="text" id="SCNEAROSVA"
                                                   title="<?php echo xla('Near Acuity without Correction'); ?>"
                                                   name="SCNEAROSVA" value="<?php echo attr($SCNEAROSVA); ?>"
                                                   tabindex="10321"></td>
                                        <td><input class="jaeger" type="text" id="OSNEARVA_1_copy_brd"
                                                   title="<?php echo xla('Near Acuity with Correction'); ?>"
                                                   name="OSNEARVA_1_copy_brd" value="<?php echo attr($OSNEARVA_1); ?>"
                                                   tabindex="10323"></td>
                                        <td><input class="jaeger" type="text" id="ARNEAROSVA_copy"
                                                   title="<?php echo xla('Near Acuity AutoRefraction'); ?>"
                                                   name="ARNEAROSVA_copy" value="<?php echo attr($ARNEAROSVA); ?>"
                                                   tabindex="10325"></td>
                                        <td><input class="jaeger" type="text" id="MRNEAROSVA_copy"
                                                   title="<?php echo xla('Near Acuity Manifest Refraction'); ?>"
                                                   name="MRNEAROSVA_copy" value="<?php echo attr($MRNEAROSVA); ?>"
                                                   tabindex="10327"></td>
                                        <td><input type="text" id="PAMOSVA_copy_brd"
                                                   title="<?php echo xla('Potential Acuity Meter'); ?>"
                                                   name="PAMOSVA_copy_brd" value="<?php echo attr($PAMOSVA); ?>"
                                                   tabindex="10329"></td>
                                        <td><input type="text" id="GLAREOSVA_copy_brd"
                                                   title="<?php echo xla('Brightness Acuity Testing'); ?>"
                                                   name="GLAREOSVA_copy_brd" value="<?php echo attr($GLAREOSVA); ?>"
                                                   tabindex="10331"></td>
                                        <td><input type="text" id="CONTRASTOSVA"
                                                   title="<?php echo xla('Contrast Acuity Testing'); ?>"
                                                   name="CONTRASTOSVA" value="<?php echo attr($CONTRASTOSVA); ?>"
                                                   tabindex="10333"></td>
                                    </tr>
                                </table>
                            </div>
                  ...
                  <i class="fa fa-paint-brush fa-sm"> </i>&nbsp;<b><?php echo xlt('Draw'); ?></b></span>
                        <span id="EXAM_QP" name="EXAM_QP" title="<?php echo xla('Open the Quick Pick panels'); ?>"
                              value="QP" class="btn btn-default">
                    ...
                    <div id="EXAM_KB" name="EXAM_KB" class="kb borderShadow nodisplay">
                        ...
                        <span class="BAR2_kb" title="<?php echo xla('Click to display shorthand field names.'); ?>"
                              class="ke"><b><?php echo xlt('Shorthand'); ?></b>
                </span>

                        <a target="_shorthand"
                           href="<?php echo $GLOBALS['webroot']; ?>/interface/forms/eye_mag/help.php">
                            <i title="<?php echo xla('Click for Shorthand Help.'); ?>"
                               class="fa fa-info-circle fa-1"></i>
                        </a><br/>
                    ...
                    <div class="nodisplay" id="DA_EXAM_sections" name="DA_EXAM_sections">
                        ...
                        <div id="EXT_1" name="EXT_1" class="clear_both">
                            ...
                            <div id="EXT_left" class="exam_section_left borderShadow">
                                <div id="EXT_left_text" class="TEXT_class">
                                    <i class="closeButton_2 fa fa-paint-brush"
                                       title="<?php echo xla('External Draw Panel'); ?>" id="BUTTON_DRAW_EXT"
                                       name="BUTTON_DRAW_EXT"></i>
                                    <i class="closeButton_3 fa fa-database" title="<?php echo xla('Quick Picks'); ?>"
                                       id="BUTTON_QP_EXT" name="BUTTON_QP_EXT"></i>
                                    <i class="closeButton_4 fa fa-user-md fa-sm fa-2" name="Shorthand_kb"
                                       title="<?php echo xla("Open/Close the Shorthand Window and Codes"); ?>"></i>
                                    <i class="closeButton fa fa-minus-circle"
                                    ...
                                    <div id="EXT_left_1">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="LLF" id="LLF" class="EXT"
                                                           value="<?php echo attr($LLF); ?>"></td>
                                            </tr>
                                            <tr>
                                                <td class="right"
                                                ...
                                                <td><input type="text" size="1" name="LMRD" id="LMRD" class="EXT"
                                                           value="<?php echo attr($LMRD); ?>"></td>
                                            </tr>
                                            <tr>
                                                <td class="right"
                                                ...
                                                <td><input type="text" size="1" name="LVFISSURE" id="LVFISSURE"
                                                           class="EXT" value="<?php echo attr($LVFISSURE); ?>"></td>
                                            </tr>
                                            <tr>
                                                <td class="right"
                                                ...
                                                <td><input type="text" name="LCAROTID" id="LCAROTID" class="EXT"
                                                           value="<?php echo attr($LCAROTID); ?>"></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><input type="text" size="1" name="LTEMPART" id="LTEMPART"
                                                           class="EXT" value="<?php echo attr($LTEMPART); ?>"></td>
                                            </tr>
                                            <tr>
                                                <td class="right"
                                                ...
                                                <td><input type="text" size="1" name="LCNV" id="LCNV" class="EXT"
                                                           value="<?php echo attr($LCNV); ?>"></td>
                                            </tr>
                                            <tr>
                                                <td class="right"
                                                ...
                                                <td><input type="text" size="1" name="LCNVII" class="EXT" id="LCNVII"
                                                           value="<?php echo attr($LCNVII); ?>"></td>
                                            </tr>

                                            <tr>
                                                <td colspan=3
                                                    class="underline"><?php echo xlt('Hertel Exophthalmometry'); ?></td>
                                            </tr>
                                            <tr class="center">
                                                <td>
                                                    <input type="text" size="1" id="ODHERTEL" name="ODHERTEL"
                                                           class="EXT" value="<?php echo attr($ODHERTEL); ?>">
                                                    <i class="fa fa-minus"></i>
                                                </td>
                                                <td>
                                                    <input type="text" size=3 id="HERTELBASE" name="HERTELBASE"
                                                           class="EXT" value="<?php echo attr($HERTELBASE); ?>">
                                                    <i class="fa fa-minus"></i>
                                                </td>
                                                <td>
                                                    <input type="text" size=1 id="OSHERTEL" name="OSHERTEL" class="EXT"
                                                           value="<?php echo attr($OSHERTEL); ?>">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                    ...
                                    <div id="EXT_text_list" name="EXT_text_list"
                                         class="borderShadow  <?php echo attr($display_EXT_view); ?>">
                                        <span class="top_right fa <?php echo attr($marker); ?>" name="EXT_text_view"
                                        ...
                                        <table cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td><textarea name="RBROW" id="RBROW"
                                                              class="right EXT"><?php echo text($RBROW); ?></textarea>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><textarea name="RUL" id="RUL"
                                                              class="right EXT"><?php echo text($RUL); ?></textarea>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><textarea name="RLL" id="RLL"
                                                              class="right EXT"><?php echo text($RLL); ?></textarea>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><textarea name="RMCT" id="RMCT"
                                                              class="right EXT"><?php echo text($RMCT); ?></textarea>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><textarea name="RADNEXA" id="RADNEXA"
                                                              class="right EXT"><?php echo text($RADNEXA); ?></textarea>
                                                </td>
                                                <td>
                            ...
                            <div id="EXT_right" name="EXT_right" class="exam_section_right borderShadow text_clinical">
                                ...
                                <div id="QP_EXT" name="QP_EXT" class="QP_class">
                                    <input type="hidden" id="EXT_prefix" name="EXT_prefix"
                                           value="<?php echo attr($EXT_prefix); ?>">

                                    <span class="closeButton fa fa-close pull-right z100" id="BUTTON_TEXTD_EXT"
                                          name="BUTTON_TEXTD_EXT" value="1"></span>
                                    <div class="qp10">
                                        <span class="eye_button eye_button_selected" id="EXT_prefix_off"
                                              name="EXT_prefix_off"
                                              onclick="$('#EXT_prefix').val('').trigger('change');"><?php echo xlt('Off'); ?></span>
                                        <span class="eye_button" id="EXT_defaults"
                                              name="EXT_defaults"><?php echo xlt('Defaults'); ?></span>
                                        <span class="eye_button" id="EXT_prefix_no" name="EXT_prefix_no"
                                              onclick="$('#EXT_prefix').val('no').trigger('change');"> <?php echo xlt('no'); ?> </span>
                                        <span class="eye_button" id="EXT_prefix_trace" name="EXT_prefix_trace"
                                              onclick="$('#EXT_prefix').val('trace').trigger('change');"> <?php echo xlt('tr'); ?> </span>
                                        <span class="eye_button" id="EXT_prefix_1" name="EXT_prefix_1"
                                              onclick="$('#EXT_prefix').val('+1').trigger('change');"> <?php echo xlt('+1'); ?> </span>
                                        <span class="eye_button" id="EXT_prefix_2" name="EXT_prefix_2"
                                    ...
                                    <div name="QP_11">
                                        <span class="eye_button" id="EXT_prefix_1mm" name="EXT_prefix_1mm"
                                              onclick="$('#EXT_prefix').val('1mm').trigger('change');"> 1<?php echo xlt('mm{{millimeters}}'); ?> </span>
                                        <br/>
                                        <span class="eye_button" id="EXT_prefix_2mm" name="EXT_prefix_2mm"
                                              onclick="$('#EXT_prefix').val('2mm').trigger('change');"> 2<?php echo xlt('mm{{millimeters}}'); ?> </span>
                                        <br/>
                                        <span class="eye_button" id="EXT_prefix_3mm" name="EXT_prefix_3mm"
                                              onclick="$('#EXT_prefix').val('3mm').trigger('change');"> 3<?php echo xlt('mm{{millimeters}}'); ?> </span>
                                        <br/>
                                        <span class="eye_button" id="EXT_prefix_4mm" name="EXT_prefix_4mm"
                                              onclick="$('#EXT_prefix').val('4mm').trigger('change');"> 4<?php echo xlt('mm{{millimeters}}'); ?> </span>
                                        <br/>
                                        <span class="eye_button" id="EXT_prefix_5mm" name="EXT_prefix_5mm"
                                              onclick="$('#EXT_prefix').val('5mm').trigger('change');"> 5<?php echo xlt('mm{{millimeters}}'); ?> </span>
                                        <br/>
                                        <span class="eye_button" id="EXT_prefix_medial" name="EXT_prefix_medial"
                                              onclick="$('#EXT_prefix').val('medial').trigger('change');"><?php echo xlt('med{{medial}}'); ?></span>
                                        <span class="eye_button" id="EXT_prefix_lateral" name="EXT_prefix_lateral"
                                              onclick="$('#EXT_prefix').val('lateral').trigger('change');"><?php echo xlt('lat{{lateral}}'); ?></span>
                                        <span class="eye_button" id="EXT_prefix_superior" name="EXT_prefix_superior"
                                              onclick="$('#EXT_prefix').val('superior').trigger('change');"><?php echo xlt('sup{{superior}}'); ?></span>
                                        <span class="eye_button" id="EXT_prefix_inferior" name="EXT_prefix_inferior"
                                              onclick="$('#EXT_prefix').val('inferior').trigger('change');"><?php echo xlt('inf{{inferior}}'); ?></span>
                                        <span class="eye_button" id="EXT_prefix_anterior" name="EXT_prefix_anterior"
                                              onclick="$('#EXT_prefix').val('anterior').trigger('change');"><?php echo xlt('ant{{anterior}}'); ?></span>
                                        <br/>
                                        <span class="eye_button" id="EXT_prefix_mid" name="EXT_prefix_mid"
                                              onclick="$('#EXT_prefix').val('mid').trigger('change');"><?php echo xlt('mid{{middle}}'); ?></span>
                                        <br/>
                                        <span class="eye_button" id="EXT_prefix_posterior" name="EXT_prefix_posterior"
                                              onclick="$('#EXT_prefix').val('posterior').trigger('change');"><?php echo xlt('post{{posterior}}'); ?></span>
                                        <br/>
                                        <span class="eye_button" id="EXT_prefix_deep" name="EXT_prefix_deep"
                                              onclick="$('#EXT_prefix').val('deep').trigger('change');"><?php echo xlt('deep'); ?></span>
                                        <br/>
                                        <br/>
                                    ...
                                    <div id="EXT_QP_block1" name="EXT_QP_block1"
                                         class="QP_block borderShadow text_clinical">
                        ...
                        <div id="ANTSEG_1" class="clear_both">
                            <div id="ANTSEG_left" name="ANTSEG_left" class="exam_section_left borderShadow">
                                ...
                                <div class="TEXT_class" id="ANTSEG_left_text">
                                    <span class="closeButton_2 fa fa-paint-brush"
                                          title="<?php echo xla('Open/Close the Anterior Segment drawing panel'); ?>"
                                          id="BUTTON_DRAW_ANTSEG" name="BUTTON_DRAW_ANTSEG"></span>
                                    <i class="closeButton_3 fa fa-database"
                                       title="<?php echo xla('Open/Close the Anterior Segment Exam Quick Picks panel'); ?>"
                                       id="BUTTON_QP_ANTSEG" name="BUTTON_QP_ANTSEG"></i>
                                    <i class="closeButton_4 fa fa-user-md fa-sm fa-2" name="Shorthand_kb"
                                       title="<?php echo xla("Open/Close the Shorthand Window and display Shorthand Codes"); ?>"></i>
                                    <i class="closeButton fa fa-minus-circle"
                                    ...
                                    <div id="ANTSEG_left_1" class="text_clinical">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="ODGONIO" id="ODGONIO"
                                                           value="<?php echo attr($ODGONIO); ?>"></td>
                                                <td><input type="text" name="OSGONIO" id="OSGONIO"
                                                           value="<?php echo attr($OSGONIO); ?>"></td>
                                            </tr>
                                            <tr>
                                                <td class="right"
                                                    title="<?php echo xla('Pachymetry: Central Corneal Thickness'); ?>">
                                                    <div class="kb kb_left"><?php echo 'PACH'; ?></div>
                                                    <?php echo xlt('Pachy{{Pachymetry}}'); ?>
                                                </td>
                                                <td><input type="text" name="ODKTHICKNESS" id="ODKTHICKNESS"
                                                           value="<?php echo attr($ODKTHICKNESS); ?>">
                                                </td>
                                                <td><input type="text" name="OSKTHICKNESS" id="OSKTHICKNESS"
                                                           value="<?php echo attr($OSKTHICKNESS); ?>">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="right"
                                                    title="<?php echo xla('Schirmers I (w/o anesthesia)'); ?>">
                                                    <div class="kb kb_left"><?php echo 'SCH1'; ?></div>
                                                    <?php echo xlt('Schirmers I'); ?> </td>
                                                <td><input type="text" name="ODSCHIRMER1" id="ODSCHIRMER1"
                                                           value="<?php echo attr($ODSCHIRMER1); ?>">
                                                </td>
                                                <td><input type="text" name="OSSCHIRMER1" id="OSSCHIRMER1"
                                                           value="<?php echo attr($OSSCHIRMER1); ?>">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="right"
                                                    title="<?php echo xla('Schirmers II (w/ anesthesia)'); ?>">
                                                    <div class="kb kb_left"><?php echo 'SCH2'; ?></div>
                                                    <?php echo xlt('Schirmers II'); ?> </td>
                                                <td><input type="text" name="ODSCHIRMER2" id="ODSCHIRMER2"
                                                           value="<?php echo attr($ODSCHIRMER2); ?>">
                                                </td>
                                                <td><input type="text" name="OSSCHIRMER2" id="OSSCHIRMER2"
                                                           value="<?php echo attr($OSSCHIRMER2); ?>">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><input type="text" name="ODTBUT" id="ODTBUT"
                                                           value="<?php echo attr($ODTBUT); ?>"></td>
                                                <td><input type="text" name="OSTBUT" id="OSTBUT"
                                                           value="<?php echo attr($OSTBUT); ?>"></td>
                                            </tr>
                                            <tr>
                                                <td colspan="3" rowspan="4" id="dil_box" nowrap="">
                                                    ...
                                                    <input type="text" class="pull-right"
                                                           title="<?php echo xla('Dilation Time'); ?>" id="DIL_MEDS"
                                                           name="DIL_MEDS" value="<?php
                                                    if ($DIL_MEDS) {
                                                        echo attr($DIL_MEDS);
                                                    }
                                                    ?>" placeholder="Time"/>
                                                    ...
                                                    <table id="dil_listbox">
                                                        <tr>
                                                            <td><input type="checkbox" class="dil_drug" id="CycloMydril"
                                                                       name="CYCLOMYDRIL"
                                                                       value="Cyclomydril" <?php if ($CYCLOMYDRIL == 'Cyclomydril') {
                                                                    echo "checked='checked'";
                                                                } ?> /><label for="CycloMydril"
                                                                              class="input-helper input-helper--checkbox dil_drug_label"><?php echo xlt('CycloMydril'); ?></label>
                                                            </td>
                                                            <td><input type="checkbox" class="dil_drug" id="Tropicamide"
                                                                       name="TROPICAMIDE"
                                                                       value="Tropicamide 2.5%" <?php if ($TROPICAMIDE == 'Tropicamide 2.5%') {
                                                                    echo "checked='checked'";
                                                                } ?> /><label for="Tropicamide"
                                                                              class="input-helper input-helper--checkbox dil_drug_label"><?php echo xlt('Tropic 2.5%'); ?></label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><input type="checkbox" class="dil_drug" id="Neo25"
                                                                       name="NEO25"
                                                                       value="Neosynephrine 2.5%" <?php if ($NEO25 == 'Neosynephrine 2.5%') {
                                                                    echo "checked='checked'";
                                                                } ?> /><label for="Neo25"
                                                                              class="input-helper input-helper--checkbox dil_drug_label"><?php echo xlt('Neo 2.5%'); ?></label>
                                                            </td>
                                                            <td><input type="checkbox" class="dil_drug" id="Neo10"
                                                                       name="NEO10"
                                                                       value="Neosynephrine 10%" <?php if ($NEO10 == 'Neosynephrine 10%') {
                                                                    echo "checked='checked'";
                                                                } ?> /><label for="Neo10"
                                                                              class="input-helper input-helper--checkbox dil_drug_label"><?php echo xlt('Neo 10%'); ?></label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><input type="checkbox" class="dil_drug" id="Cyclogyl"
                                                                       name="CYCLOGYL"
                                                                       value="Cyclopentolate 1%" <?php if ($CYCLOGYL == 'Cyclopentolate 1%') {
                                                                    echo "checked='checked'";
                                                                } ?> /><label for="Cyclogyl"
                                                                              class="input-helper input-helper--checkbox dil_drug_label"><?php echo xlt('Cyclo 1%'); ?></label>
                                                            </td>
                                                            <td><input type="checkbox" class="dil_drug" id="Atropine"
                                                                       name="ATROPINE"
                                                                       value="Atropine 1%" <?php if ($ATROPINE == 'Atropine 1%') {
                                                                    echo "checked='checked'";
                                                                } ?> /><label for="Atropine"
                                                                              class="input-helper input-helper--checkbox dil_drug_label"><?php echo xlt('Atropine 1%'); ?></label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                    ...
                                    <div id="ANTSEG_text_list" name="ANTSEG_text_list"
                                         class="borderShadow <?php echo attr($display_ANTSEG_view); ?>">
                                        <span class="top_right fa <?php echo attr($marker); ?>" name="ANTSEG_text_view"
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <textarea name="ODCONJ" id="ODCONJ"
                                                              class="right ANTSEG"><?php echo text($ODCONJ); ?></textarea>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><textarea name="ODCORNEA" id="ODCORNEA"
                                                              class="right ANTSEG"><?php echo text($ODCORNEA); ?></textarea>
                                                </td>
                                                <td>
                                                ...
                                                <td><textarea name="OSCORNEA" id="OSCORNEA"
                                                              class="ANTSEG"><?php echo text($OSCORNEA); ?></textarea>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><textarea name="ODAC" id="ODAC"
                                                ...
                                                <td><textarea name="OSAC" id="OSAC"
                                                              class="ANTSEG"><?php echo text($OSAC); ?></textarea></td>
                                            </tr>
                                            <tr>
                                                <td><textarea name="ODLENS" id="ODLENS"
                                                              class="right ANTSEG"><?php echo text($ODLENS); ?></textarea>
                                                </td>
                                                <td>
                                                ...
                                                <td><textarea name="OSLENS" id="OSLENS"
                                                              class="ANTSEG"><?php echo text($OSLENS); ?></textarea>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><textarea name="ODIRIS" id="ODIRIS"
                                                              class="right ANTSEG"><?php echo text($ODIRIS); ?></textarea>
                                                </td>
                                                <td>
                                                ...
                                                <td><textarea name="OSIRIS" id="OSIRIS"
                                                              class="ANTSEG"><?php echo text($OSIRIS); ?></textarea>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <div class="QP_lengthen" id="ANTSEG_COMMENTS_DIV">
                                        <b><?php echo xlt('Comments'); ?>:</b>
                                        <div class="kb kb_left"><?php echo xlt('ACOM{{Anterior Segment}}'); ?> </div>
                                        <br/>
                                        <textarea id="ANTSEG_COMMENTS"
                                                  name="ANTSEG_COMMENTS"><?php echo text($ANTSEG_COMMENTS); ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div id="ANTSEG_right" name=="ANTSEG_right"
                                 class="exam_section_right borderShadow text_clinical ">
                                <div id="PRIORS_ANTSEG_left_text" name="PRIORS_ANTSEG_left_text"
                                ...
                                <div id="QP_ANTSEG" name="QP_ANTSEG" class="QP_class">
                                    ...
                                    <div class="qp10">
                                        <span class="eye_button eye_button_selected" id="ANTSEG_prefix_off"
                                              name="ANTSEG_prefix_off"
                                              onclick="$('#ANTSEG_prefix').val('off').trigger('change');"><?php echo xlt('Off'); ?> </span>
                                        <span class="eye_button" id="ANTSEG_defaults"
                                              name="ANTSEG_defaults"><?php echo xlt('Defaults'); ?></span>
                                        <span class="eye_button" id="ANTSEG_prefix_no" name="ANTSEG_prefix_no"
                                              onclick="$('#ANTSEG_prefix').val('no').trigger('change');"> <?php echo xlt('no'); ?> </span>
                                        <span class="eye_button" id="ANTSEG_prefix_trace" name="ANTSEG_prefix_trace"
                                              onclick="$('#ANTSEG_prefix').val('trace').trigger('change');"> <?php echo xlt('tr'); ?> </span>
                                        <span class="eye_button" id="ANTSEG_prefix_1" name="ANTSEG_prefix_1"
                                              onclick="$('#ANTSEG_prefix').val('+1').trigger('change');"> <?php echo xlt('+1'); ?> </span>
                                        <span class="eye_button" id="ANTSEG_prefix_2" name="ANTSEG_prefix_2"
                                    ...
                                    <div name="QP_11">
                                        <span class="eye_button" id="ANTSEG_prefix_1mm" name="ANTSEG_prefix_1mm"
                                              onclick="$('#ANTSEG_prefix').val('1mm').trigger('change');"> <?php echo xlt('1mm'); ?> </span>
                                        <br/>
                                        <span class="eye_button" id="ANTSEG_prefix_2mm" name="ANTSEG_prefix_2mm"
                                              onclick="$('#ANTSEG_prefix').val('2mm').trigger('change');"> <?php echo xlt('2mm'); ?> </span>
                                        <br/>
                                        <span class="eye_button" id="ANTSEG_prefix_3mm" name="ANTSEG_prefix_3mm"
                                              onclick="$('#ANTSEG_prefix').val('3mm').trigger('change');"> <?php echo xlt('3mm'); ?> </span>
                                        <br/>
                                        <span class="eye_button" id="ANTSEG_prefix_4mm" name="ANTSEG_prefix_4mm"
                                              onclick="$('#ANTSEG_prefix').val('4mm').trigger('change');"> <?php echo xlt('4mm'); ?> </span>
                                        <br/>
                                        <span class="eye_button" id="ANTSEG_prefix_5mm" name="ANTSEG_prefix_5mm"
                                              onclick="$('#ANTSEG_prefix').val('5mm').trigger('change');"> <?php echo xlt('5mm'); ?> </span>
                                        <br/>
                                        <span class="eye_button" id="ANTSEG_prefix_medial" name="ANTSEG_prefix_medial"
                                              onclick="$('#ANTSEG_prefix').val('medial').trigger('change');"><?php echo xlt('med{{medial}}'); ?></span>
                                        <span class="eye_button" id="ANTSEG_prefix_lateral" name="ANTSEG_prefix_lateral"
                                              onclick="$('#ANTSEG_prefix').val('lateral').trigger('change');"><?php echo xlt('lat{{lateral}}'); ?></span>
                                        <span class="eye_button" id="ANTSEG_prefix_superior"
                                              name="ANTSEG_prefix_superior"
                                              onclick="$('#ANTSEG_prefix').val('superior').trigger('change');"><?php echo xlt('sup{{superior}}'); ?></span>
                                        <span class="eye_button" id="ANTSEG_prefix_inferior"
                                              name="ANTSEG_prefix_inferior"
                                              onclick="$('#ANTSEG_prefix').val('inferior').trigger('change');"><?php echo xlt('inf{{inferior}}'); ?></span>
                                        <span class="eye_button" id="ANTSEG_prefix_anterior"
                                              name="ANTSEG_prefix_anterior"
                                              onclick="$('#ANTSEG_prefix').val('anterior').trigger('change');"><?php echo xlt('ant{{anterior}}'); ?></span>
                                        <br/>
                                        <span class="eye_button" id="ANTSEG_prefix_mid" name="ANTSEG_prefix_mid"
                                              onclick="$('#ANTSEG_prefix').val('mid').trigger('change');"><?php echo xlt('mid'); ?></span>
                                        <br/>
                                        <span class="eye_button" id="ANTSEG_prefix_posterior"
                                              name="ANTSEG_prefix_posterior"
                                              onclick="$('#ANTSEG_prefix').val('posterior').trigger('change');"><?php echo xlt('post{{posterior}}'); ?></span>
                                        <br/>
                                        <span class="eye_button" id="ANTSEG_prefix_deep" name="ANTSEG_prefix_deep"
                                              onclick="$('#ANTSEG_prefix').val('deep').trigger('change');"><?php echo xlt('deep'); ?></span>
                                        <br/>
                                        <br/>
                                        <span class="eye_button" id="ANTSEG_prefix_clear" name="ANTSEG_prefix_clear"
                                              title="<?php echo xla('This will clear the data from all Anterior Segment Exam fields'); ?>"
                                              onclick="$('#ANTSEG_prefix').val('clear').trigger('change');"><?php echo xlt('clear'); ?></span>

                                    </div>
                                    <div class="QP_block borderShadow text_clinical ">
                                        <?php echo $QP_ANTSEG = display_QP("ANTSEG", $provider_id); ?>
                                    </div>
                                    <span class="closeButton fa fa-close pull-right z100" id="BUTTON_TEXTD_ANTSEG"
                                          name="BUTTON_TEXTD_ANTSEG"></span>
                                </div>
                            </div>
                        </div>
                        <!-- end Ant Seg -->
                        ...
                        <div id="POSTSEG_1" class="clear_both">
                            <div id="RETINA_left" name="RETINA_left" class="exam_section_left borderShadow">
                                ...
                                <div class="TEXT_class" id="RETINA_left_text" name="RETINA_left_text">
                                    <span class="closeButton_2 fa fa-paint-brush"
                                          title="<?php echo xla('Open/Close the Retina drawing panel'); ?>"
                                          id="BUTTON_DRAW_RETINA" name="BUTTON_DRAW_RETINA"></span>
                                    <i class="closeButton_3 fa fa-database"
                                       title="<?php echo xla('Open/Close the Retinal Exam Quick Picks panel'); ?>"
                                       id="BUTTON_QP_RETINA" name="BUTTON_QP_RETINA"></i>
                                    <i class="closeButton_4 fa fa-user-md fa-sm fa-2" name="Shorthand_kb"
                                       title="<?php echo xla("Open/Close the Shorthand Window and display Shorthand Codes"); ?>"></i>
                                    <i class="closeButton fa fa-minus-circle"
                                    ...
                                    <input type="checkbox" id="DIL_RISKS" name="DIL_RISKS"
                                           value="on" <?php if ($DIL_RISKS == 'on') {
                                        echo "checked='checked'";
                                    } ?>>
                                    <label for="DIL_RISKS"
                                           class="input-helper input-helper--checkbox"><?php echo xlt('Dilation orders/risks reviewed'); ?></label>
                                    <br/>
                                    <div id="RETINA_left_1" class="text_clinical">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="RETINA" name="ODCUP" size="4" id="ODCUP"
                                                           value="<?php echo attr($ODCUP); ?>">
                                                </td>
                                                <td>
                                                    <input type="text" class="RETINA" name="OSCUP" size="4" id="OSCUP"
                                            ...
                                            <tr>
                                                <td class="bold right">
                                                    ...
                                                    <?php echo xlt('CMT{{Central Macular Thickness}}'); ?>:
                                                </td>
                                                <td>
                                                    <input class="RETINA" type="text" name="ODCMT" size="4" id="ODCMT"
                                                           value="<?php echo attr($ODCMT); ?>">
                                                </td>
                                                <td>
                                                    <input class="RETINA" type="text" name="OSCMT" size="4" id="OSCMT"
                                                           value="<?php echo attr($OSCMT); ?>">
                                                </td>
                                            </tr>
                                        </table>
                                        <br/>
                                    ...
                                    <div>
                                        <div id="RETINA_text_list" name="RETINA_text_list"
                                             class="borderShadow  <?php echo attr($display_RETINA_view); ?>">
                                            ...
                                            <table cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td><textarea name="ODDISC" id="ODDISC"
                                                                  class="RETINA right"><?php echo text($ODDISC); ?></textarea>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><textarea name="ODMACULA" id="ODMACULA"
                                                                  class="RETINA right"><?php echo text($ODMACULA); ?></textarea>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><textarea name="ODVESSELS" id="ODVESSELS"
                                                                  class="RETINA right"><?php echo text($ODVESSELS); ?></textarea>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><textarea name="ODVITREOUS" id="ODVITREOUS"
                                                                  class="RETINA right"><?php echo text($ODVITREOUS); ?></textarea>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><textarea name="ODPERIPH" id="ODPERIPH"
                                    ...
                                    <div class="QP_lengthen" id="RETINA_COMMENTS_DIV">
                                        ...
                                        <br/>
                                        <textarea id="RETINA_COMMENTS" class="RETINA"
                                                  name="RETINA_COMMENTS"><?php echo text($RETINA_COMMENTS); ?></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="RETINA_right" class="exam_section_right borderShadow text_clinical">
                                ...
                                <div id="QP_RETINA" name="QP_RETINA" class="QP_class">
                                    ...
                                    <div class="qp10">
                                        <span class="eye_button  eye_button_selected" id="RETINA_prefix_off"
                                              name="RETINA_prefix_off"
                                              onclick="$('#RETINA_prefix').val('').trigger('change');"><?php echo xlt('Off'); ?></span>
                                        <span class="eye_button" id="RETINA_defaults"
                                              name="RETINA_defaults"><?php echo xlt('Defaults'); ?></span>
                                        <span class="eye_button" id="RETINA_prefix_no" name="RETINA_prefix_no"
                                              onclick="$('#RETINA_prefix').val('no').trigger('change');"> <?php echo xlt('no'); ?> </span>
                                        <span class="eye_button" id="RETINA_prefix_trace" name="RETINA_prefix_trace"
                                              onclick="$('#RETINA_prefix').val('trace').trigger('change');"> <?php echo xlt('tr'); ?> </span>
                                        <span class="eye_button" id="RETINA_prefix_1" name="RETINA_prefix_1"
                                              onclick="$('#RETINA_prefix').val('+1').trigger('change');"> <?php echo xlt('+1'); ?> </span>
                                        <span class="eye_button" id="RETINA_prefix_2" name="RETINA_prefix_2"
                                    ...
                                    <div name="QP_11">
                                        <span class="eye_button" id="RETINA_prefix_1mm" name="RETINA_prefix_1mm"
                                              onclick="$('#RETINA_prefix').val('1mm').trigger('change');"> <?php echo xlt('1mm'); ?> </span>
                                        <br/>
                                        <span class="eye_button" id="RETINA_prefix_2mm" name="RETINA_prefix_2mm"
                                              onclick="$('#RETINA_prefix').val('2mm').trigger('change');"> <?php echo xlt('2mm'); ?> </span>
                                        <br/>
                                        <span class="eye_button" id="RETINA_prefix_3mm" name="RETINA_prefix_3mm"
                                              onclick="$('#RETINA_prefix').val('3mm').trigger('change');"> <?php echo xlt('3mm'); ?> </span>
                                        <br/>
                                        <span class="eye_button" id="RETINA_prefix_4mm" name="RETINA_prefix_4mm"
                                              onclick="$('#RETINA_prefix').val('4mm').trigger('change');"> <?php echo xlt('4mm'); ?> </span>
                                        <br/>
                                        <span class="eye_button" id="RETINA_prefix_5mm" name="RETINA_prefix_5mm"
                                              onclick="$('#RETINA_prefix').val('5mm').trigger('change');"> <?php echo xlt('5mm'); ?> </span>
                                        <br/>
                                        <span class="eye_button" id="RETINA_prefix_nasal" name="RETINA_prefix_nasal"
                                              onclick="$('#RETINA_prefix').val('nasal').trigger('change');"><?php echo xlt('nasal'); ?></span>
                                        <span class="eye_button" id="RETINA_prefix_temp" name="RETINA_prefix_temp"
                                              onclick="$('#RETINA_prefix').val('temp').trigger('change');"><?php echo xlt('temp{{temporal}}'); ?></span>
                                        <span class="eye_button" id="RETINA_prefix_superior"
                                              name="RETINA_prefix_superior"
                                              onclick="$('#RETINA_prefix').val('superior').trigger('change');"><?php echo xlt('sup{{superior}}'); ?></span>
                                        <span class="eye_button" id="RETINA_prefix_inferior"
                                              name="RETINA_prefix_inferior"
                                              onclick="$('#RETINA_prefix').val('inferior').trigger('change');"><?php echo xlt('inf{{inferior}}'); ?></span>
                                        <span class="eye_button" id="RETINA_prefix_anterior"
                                              name="RETINA_prefix_anterior"
                                              onclick="$('#RETINA_prefix').val('anterior').trigger('change');"><?php echo xlt('ant{{anterior}}'); ?></span>
                                        <br/>
                                        <span class="eye_button" id="RETINA_prefix_mid" name="RETINA_prefix_mid"
                                              onclick="$('#RETINA_prefix').val('mid').trigger('change');"><?php echo xlt('mid{{middle}}'); ?></span>
                                        <br/>
                                        <span class="eye_button" id="RETINA_prefix_posterior"
                                              name="RETINA_prefix_posterior"
                                              onclick="$('#RETINA_prefix').val('posterior').trigger('change');"><?php echo xlt('post{{posterior}}'); ?></span>
                                        <br/>
                                        <span class="eye_button" id="RETINA_prefix_deep" name="RETINA_prefix_deep"
                                              onclick="$('#RETINA_prefix').val('deep').trigger('change');"><?php echo xlt('deep'); ?></span>
                                        <br/>
                                        <br/>
                                        <span class="eye_button" id="RETINA_prefix_clear" name="RETINA_prefix_clear"
                                              title="<?php echo xla('This will clear the data from all Retina Exam fields'); ?>"
                                              onclick="$('#RETINA_prefix').val('clear').trigger('change');"><?php echo xlt('clear'); ?></span>
                                    </div>
                                    <div class="QP_block borderShadow text_clinical">
                                        <?php echo $QP_RETINA = display_QP("RETINA", $provider_id); ?>
                                    </div>
                                    <span class="closeButton fa fa-close pull-right z100" id="BUTTON_TEXTD_RETINA"
                                          name="BUTTON_TEXTD_RETINA" value="1"></span>
                                </div>
                            </div>
                        </div>
                        <!-- end Retina -->
                        ...
                        <div id="NEURO_1" class="clear_both">
                            <div id="NEURO_left" class="exam_section_left borderShadow">
                                ...
                                <div class="TEXT_class" id="NEURO_left_text" name="NEURO_left_text">
                                    <span class="closeButton_2 fa fa-paint-brush" id="BUTTON_DRAW_NEURO"
                                          title="<?php echo xla('Open/Close the Neuro drawing panel'); ?>"
                                          name="BUTTON_DRAW_NEURO"></span>
                                    <i class="closeButton_3 fa fa-database"
                                       title="<?php echo xla('Open/Close the Neuro Exam Quick Picks panel'); ?>"
                                       id="BUTTON_QP_NEURO" name="BUTTON_QP_NEURO"></i>
                                    <i class="closeButton_4 fa fa-user-md fa-sm fa-2" name="Shorthand_kb"
                                       title="<?php echo xla("Open/Close the Shorthand Window and display Shorthand Codes"); ?>"></i>
                                    <i class="closeButton fa fa-minus-circle"
                                       title="<?php echo xla('Open/Close Neuro panels'); ?>" id="BUTTON_TAB_NEURO"
                                       name="BUTTON_TAB_NEURO"></i>
                                    <b><?php echo xlt('Neuro'); ?>:</b>
                                    <div class="kb kb_left"
                                         title="<?php echo xla("Neuro/Phys Exam Default Values") . " " . xlt('including CVF{{Confrontational Visual Fields}} and Pupils'); ?>"><?php echo text('DNEURO'); ?></div>
                                    <br/>
                                    <div id="NEURO_left_1" class="text_clinical">
                                        <div id="NEURO_color" class="borderShadow">
                                            <table>
                                                <tr>
                                                    <td></td>
                                                    <td style="text-align:center;"><?php echo xlt('OD{{right eye}}'); ?></td>
                                                    <td style="text-align:center;"><?php echo xlt('OS{{left eye}}'); ?></td>
                                                </tr>
                                                <tr>
                                                    <td class="right"><?php echo xlt('Color'); ?>:</td>
                                                    <td><input type="text" name="ODCOLOR" id="ODCOLOR"
                                                               value="<?php if ($ODCOLOR) {
                                                                   echo text($ODCOLOR);
                                                               } else {
                                                                   echo "";
                                                               } ?>"/></td>
                                                    <td><input type="text" name="OSCOLOR" id="OSCOLOR"
                                                               value="<?php if ($OSCOLOR) {
                                                                   echo text($OSCOLOR);
                                                               } else {
                                                                   echo "";
                                                               } ?>"/></td>
                                    ...
                                    //or just take the normal they use and incorporate that ongoing?  -->
                                                        &nbsp;<span title="<?php echo xlt('Insert normals'); ?> - 11/11"
                                                                    class="fa fa-reply" id="NEURO_COLOR"
                                                                    name="NEURO_COLOR"></span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="right">
                                                    ...
                                                    <td>
                                                        <input type="text" Xsize="6" name="ODREDDESAT" id="ODREDDESAT"
                                                               value="<?php echo attr($ODREDDESAT); ?>"/>
                                                    </td>
                                                    <td>
                                                        <input type="text" Xsize="6" name="OSREDDESAT" id="OSREDDESAT"
                                                               value="<?php echo attr($OSREDDESAT); ?>"/>
                                                    </td>
                                                    <td>
                                                        &nbsp; <span
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="ODCOINS" id="ODCOINS"
                                                               value="<?php echo attr($ODCOINS); ?>"/>
                                                    </td>
                                                    <td>
                                                        <input type="text" name="OSCOINS" id="OSCOINS"
                                                               value="<?php echo attr($OSCOINS); ?>"/>
                                                    </td>
                                                    <td>
                                                        &nbsp;<span
                                        ...
                                        <div class="borderShadow" id="NEURO_11">
                                            <i class="fa fa-th fa-fw closeButton_2" id="Close_ACTMAIN"
                                               name="Close_ACTMAIN"></i>
                                            <table class="ACT_top">
                                                <tr>
                                                    <td>
                                                        <span id="ACTTRIGGER"
                                                              name="ACTTRIGGER"><?php echo xlt('Alternate Cover Test'); ?>
                                                            :</span>
                                                    </td>
                                                    <td>
                                    <span id="ACTNORMAL_CHECK" name="ACTNORMAL_CHECK">
                                    <label for="ACT"
                                           class="input-helper input-helper--checkbox"><?php echo xlt('Ortho{{orthophoric}}'); ?></label>
                                                            ...
                                                            <table id="ACTTABLE">
                                                                <tr>
                                                                    <td id="ACT_tab_SCDIST" name="ACT_tab_SCDIST"
                                                                        class="ACT_selected"> <?php echo xlt('scDist{{without correction distance}}'); ?> </td>
                                                                    <td id="ACT_tab_CCDIST" name="ACT_tab_CCDIST"
                                                                        class="ACT_deselected"> <?php echo xlt('ccDist{{with correction distance}}'); ?> </td>
                                                                    <td id="ACT_tab_SCNEAR" name="ACT_tab_SCNEAR"
                                                                        class="ACT_deselected"> <?php echo xlt('scNear{{without correction near}}'); ?> </td>
                                                                    <td id="ACT_tab_CCNEAR" name="ACT_tab_CCNEAR"
                                                                        class="ACT_deselected"> <?php echo xlt('ccNear{{with correction at near}}'); ?> </td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="4">
                                                                        <div id="ACT_SCDIST" name="ACT_SCDIST"
                                                                             class="ACT_box">
                                                                            <br/>
                                                                            <table>
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="border-right:1pt solid black;border-bottom:1pt solid black;">
                                                                                        <textarea id="ACT1SCDIST"
                                                                                                  name="ACT1SCDIST"
                                                                                                  class="ACT"><?php echo text($ACT1SCDIST); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border:1pt solid black;border-top:0pt;">
                                                                                        <textarea id="ACT2SCDIST"
                                                                                                  name="ACT2SCDIST"
                                                                                                  class="ACT"><?php echo text($ACT2SCDIST); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border-left:1pt solid black;border-bottom:1pt solid black;">
                                                                                        <textarea id="ACT3SCDIST"
                                                                                                  name="ACT3SCDIST"
                                                                                                  class="ACT"><?php echo text($ACT3SCDIST); ?></textarea>
                                                                                    </td>
                                                                                    <td><?php echo xlt('L{{left}}'); ?></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="border:1pt solid black;border-left:0pt;">
                                                                                        <textarea id="ACT4SCDIST"
                                                                                                  name="ACT4SCDIST"
                                                                                                  class="ACT"><?php echo text($ACT4SCDIST); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border:1pt solid black;">
                                                                                        <textarea id="ACT5SCDIST"
                                                                                                  class="neurosens2 ACT"
                                                                                                  name="ACT5SCDIST"><?php echo text($ACT5SCDIST); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border:1pt solid black;border-right:0pt;">
                                                                                        <textarea id="ACT6SCDIST"
                                                                                                  name="ACT6SCDIST"
                                                                                                  class="ACT"><?php echo text($ACT6SCDIST); ?></textarea>
                                                                                    </td>
                                                                                    <td>
                                                                                        <i class="fa fa-reply flip-left"></i>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td style="border:0; border-top:2pt solid black;border-right:2pt solid black;text-align:right;">
                                                                                        <textarea id="ACT10SCDIST"
                                                                                                  name="ACT10SCDIST"
                                                                                                  class="ACT"><?php echo text($ACT10SCDIST); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border-right:1pt solid black;border-top:1pt solid black;text-align:right;">
                                                                                        <textarea id="ACT7SCDIST"
                                                                                                  name="ACT7SCDIST"
                                                                                                  class="ACT"><?php echo text($ACT7SCDIST); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border:1pt solid black;border-bottom:0pt;text-align:center;">
                                                                                        <textarea id="ACT8SCDIST"
                                                                                                  name="ACT8SCDIST"
                                                                                                  class="ACT"><?php echo text($ACT8SCDIST); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border-left:1pt solid black;border-top:1pt solid black;text-align:left;">
                                                                                        <textarea id="ACT9SCDIST"
                                                                                                  name="ACT9SCDIST"
                                                                                                  class="ACT"><?php echo text($ACT9SCDIST); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border:0; border-top:2pt solid black;border-left:2pt solid black;text-align:left;vertical-align:middle;">
                                                                                        <textarea id="ACT11SCDIST"
                                                                                                  name="ACT11SCDIST"
                                                                                                  class="ACT"><?php echo text($ACT11SCDIST); ?></textarea>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                            <br/>
                                                                        </div>
                                                                        <div id="ACT_CCDIST" name="ACT_CCDIST"
                                                                             class="nodisplay ACT_box">
                                                                            <br/>
                                                                            <table>
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="border-right:1pt solid black;border-bottom:1pt solid black;text-align:right;">
                                                                                        <textarea id="ACT1CCDIST"
                                                                                                  name="ACT1CCDIST"
                                                                                                  class="ACT"><?php echo text($ACT1CCDIST); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border:1pt solid black;border-top:0pt;text-align:center;">
                                                                                        <textarea id="ACT2CCDIST"
                                                                                                  name="ACT2CCDIST"
                                                                                                  class="ACT"><?php echo text($ACT2CCDIST); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border-left:1pt solid black;border-bottom:1pt solid black;text-align:left;">
                                                                                        <textarea id="ACT3CCDIST"
                                                                                                  name="ACT3CCDIST"
                                                                                                  class="ACT"><?php echo text($ACT3CCDIST); ?></textarea>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="border:1pt solid black;border-left:0pt;text-align:right;">
                                                                                        <textarea id="ACT4CCDIST"
                                                                                                  name="ACT4CCDIST"
                                                                                                  class="ACT"><?php echo text($ACT4CCDIST); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border:1pt solid black;text-align:center;">
                                                                                        <textarea id="ACT5CCDIST"
                                                                                                  name="ACT5CCDIST"
                                                                                                  class="neurosens2 ACT"><?php echo text($ACT5CCDIST); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border:1pt solid black;border-right:0pt;text-align:left;">
                                                                                        <textarea id="ACT6CCDIST"
                                                                                                  name="ACT6CCDIST"
                                                                                                  class="ACT"><?php echo text($ACT6CCDIST); ?></textarea>
                                                                                    </td>
                                                                                    <td>
                                                                                        <i class="fa fa-reply flip-left"></i>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="border:0; border-top:2pt solid black;border-right:2pt solid black;text-align:right;">
                                                                                        <textarea id="ACT10CCDIST"
                                                                                                  name="ACT10CCDIST"
                                                                                                  class="ACT"><?php echo text($ACT10CCDIST); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border-right:1pt solid black;border-top:1pt solid black;text-align:right;">
                                                                                        <textarea id="ACT7CCDIST"
                                                                                                  name="ACT7CCDIST"
                                                                                                  class="ACT"><?php echo text($ACT7CCDIST); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border:1pt solid black;border-bottom:0pt;text-align:center;">
                                                                                        <textarea id="ACT8CCDIST"
                                                                                                  name="ACT8CCDIST"
                                                                                                  class="ACT"><?php echo text($ACT8CCDIST); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border-left:1pt solid black;border-top:1pt solid black;text-align:left;">
                                                                                        <textarea id="ACT9CCDIST"
                                                                                                  name="ACT9CCDIST"
                                                                                                  class="ACT"><?php echo text($ACT9CCDIST); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border:0; border-top:2pt solid black;border-left:2pt solid black;text-align:left;vertical-align:middle;">
                                                                                        <textarea id="ACT11CCDIST"
                                                                                                  name="ACT11CCDIST"
                                                                                                  class="ACT"><?php echo text($ACT11CCDIST); ?></textarea>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                            <br/>
                                                                        </div>
                                                                        <div id="ACT_SCNEAR" name="ACT_SCNEAR"
                                                                             class="nodisplay ACT_box">
                                                                            <br/>
                                                                            <table>
                                                                                <tr>
                                                                                    <td style="text-align:center;"><?php echo xlt('R{{right}}'); ?></td>
                                                                                    <td style="border-right:1pt solid black;border-bottom:1pt solid black;text-align:right;">
                                                                                        <textarea id="ACT1SCNEAR"
                                                                                                  name="ACT1SCNEAR"
                                                                                                  class="ACT"><?php echo text($ACT1SCNEAR); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border:1pt solid black;border-top:0pt;text-align:center;">
                                                                                        <textarea id="ACT2SCNEAR"
                                                                                                  name="ACT2SCNEAR"
                                                                                                  class="ACT"><?php echo text($ACT2SCNEAR); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border-left:1pt solid black;border-bottom:1pt solid black;text-align:left;">
                                                                                        <textarea id="ACT3SCNEAR"
                                                                                                  name="ACT3SCNEAR"
                                                                                                  class="ACT"><?php echo text($ACT3SCNEAR); ?></textarea>
                                                                                    </td>
                                                                                    <td style="text-align:center;"><?php echo xlt('L{{left}}'); ?></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="border:1pt solid black;border-left:0pt;text-align:right;">
                                                                                        <textarea id="ACT4SCNEAR"
                                                                                                  name="ACT4SCNEAR"
                                                                                                  class="ACT"><?php echo text($ACT4SCNEAR); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border:1pt solid black;text-align:center;">
                                                                                        <textarea id="ACT5SCNEAR"
                                                                                                  name="ACT5SCNEAR"
                                                                                                  class="neurosens2 ACT"><?php echo text($ACT5SCNEAR); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border:1pt solid black;border-right:0pt;text-align:left;">
                                                                                        <textarea id="ACT6SCNEAR"
                                                                                                  name="ACT6SCNEAR"
                                                                                                  class="ACT"><?php echo text($ACT6SCNEAR); ?></textarea>
                                                                                    </td>
                                                                                    <td>
                                                                                        <i class="fa fa-reply flip-left"></i>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="border:0; border-top:2pt solid black;border-right:2pt solid black;text-align:right;">
                                                                                        <textarea id="ACT10SCNEAR"
                                                                                                  name="ACT10SCNEAR"
                                                                                                  class="ACT"><?php echo text($ACT10SCNEAR); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border-right:1pt solid black;border-top:1pt solid black;text-align:right;">
                                                                                        <textarea id="ACT7SCNEAR"
                                                                                                  name="ACT7SCNEAR"
                                                                                                  class="ACT"><?php echo text($ACT7SCNEAR); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border:1pt solid black;border-bottom:0pt;text-align:center;">
                                                                                        <textarea id="ACT8SCNEAR"
                                                                                                  name="ACT8SCNEAR"
                                                                                                  class="ACT"><?php echo text($ACT8SCNEAR); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border-left:1pt solid black;border-top:1pt solid black;text-align:left;">
                                                                                        <textarea id="ACT9SCNEAR"
                                                                                                  name="ACT9SCNEAR"
                                                                                                  class="ACT"><?php echo text($ACT9SCNEAR); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border:0; border-top:2pt solid black;border-left:2pt solid black;text-align:left;vertical-align:middle;">
                                                                                        <textarea id="ACT11SCNEAR"
                                                                                                  name="ACT11SCNEAR"
                                                                                                  class="ACT"><?php echo text($ACT11SCNEAR); ?></textarea>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                            <br/>
                                                                        </div>
                                                                        <div id="ACT_CCNEAR" name="ACT_CCNEAR"
                                                                             class="nodisplay ACT_box">
                                                                            <br/>
                                                                            <table>
                                                                                <tr>
                                                                                    <td style="text-align:center;"><?php echo xlt('R{{right}}'); ?></td>
                                                                                    <td style="border-right:1pt solid black;border-bottom:1pt solid black;text-align:right;">
                                                                                        <textarea id="ACT1CCNEAR"
                                                                                                  name="ACT1CCNEAR"
                                                                                                  class="ACT"><?php echo text($ACT1CCNEAR); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border:1pt solid black;border-top:0pt;text-align:center;">
                                                                                        <textarea id="ACT2CCNEAR"
                                                                                                  name="ACT2CCNEAR"
                                                                                                  class="ACT"><?php echo text($ACT2CCNEAR); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border-left:1pt solid black;border-bottom:1pt solid black;text-align:left;">
                                                                                        <textarea id="ACT3CCNEAR"
                                                                                                  name="ACT3CCNEAR"
                                                                                                  class="ACT"><?php echo text($ACT3CCNEAR); ?></textarea>
                                                                                    </td>
                                                                                    <td style="text-align:center;"><?php echo xlt('L{{left}}'); ?></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="border:1pt solid black;border-left:0pt;text-align:right;">
                                                                                        <textarea id="ACT4CCNEAR"
                                                                                                  name="ACT4CCNEAR"
                                                                                                  class="ACT"><?php echo text($ACT4CCNEAR); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border:1pt solid black;text-align:center;">
                                                                                        <textarea id="ACT5CCNEAR"
                                                                                                  name="ACT5CCNEAR"
                                                                                                  class="neurosens2 ACT"><?php echo text($ACT5CCNEAR); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border:1pt solid black;border-right:0pt;text-align:left;">
                                                                                        <textarea id="ACT6CCNEAR"
                                                                                                  name="ACT6CCNEAR"
                                                                                                  class="ACT"><?php echo text($ACT6CCNEAR); ?></textarea>
                                                                                    </td>
                                                                                    <td>
                                                                                        <i class="fa fa-reply flip-left"></i>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="border:0; border-top:2pt solid black;border-right:2pt solid black;text-align:right;">
                                                                                        <textarea id="ACT10CCNEAR"
                                                                                                  name="ACT10CCNEAR"
                                                                                                  class="ACT"><?php echo text($ACT10CCNEAR); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border-right:1pt solid black;border-top:1pt solid black;text-align:right;">
                                                                                        <textarea id="ACT7CCNEAR"
                                                                                                  name="ACT7CCNEAR"
                                                                                                  class="ACT"><?php echo text($ACT7CCNEAR); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border:1pt solid black;border-bottom:0pt;text-align:center;">
                                                                                        <textarea id="ACT8CCNEAR"
                                                                                                  name="ACT8CCNEAR"
                                                                                                  class="ACT"><?php echo text($ACT8CCNEAR); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border-left:1pt solid black;border-top:1pt solid black;text-align:left;">
                                                                                        <textarea id="ACT9CCNEAR"
                                                                                                  name="ACT9CCNEAR"
                                                                                                  class="ACT"><?php echo text($ACT9CCNEAR); ?></textarea>
                                                                                    </td>
                                                                                    <td style="border:0; border-top:2pt solid black;border-left:2pt solid black;text-align:left;vertical-align:middle;">
                                                                                        <textarea id="ACT11CCNEAR"
                                                                                                  name="ACT11CCNEAR"
                                                                                                  class="ACT"><?php echo text($ACT11CCNEAR); ?></textarea>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                            <br/>
                                                ...
                                                <table
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" id="ODNPA" style="width:70%;"
                                                                   ...
                                                                   value="<?php echo attr($ODNPA); ?>"></td>
                                                        <td><input type="text" id="OSNPA" style="width:70%;"
                                                                   class="neurosens2" name="OSNPA"
                                                                   value="<?php echo attr($OSNPA); ?>"></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="right"><span
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            <input type="text" style="width:85%;" class="neurosens"
                                                                   name="STEREOPSIS" id="STEREOPSIS"
                                                                   value="<?php echo attr($STEREOPSIS); ?>">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3">&nbsp;
                                                    ...
                                                    <tr>
                                                        <td class="bold underline"><?php echo xlt('Amplitudes'); ?>:
                                                        </td>
                                                        <td><?php echo xlt('Distance'); ?></td>
                                                        <td><?php echo xlt('Near'); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="text-align:right;"><?php echo xlt('Divergence'); ?>
                                                            :
                                                        </td>
                                                        <td><input type="text" id="DACCDIST" class="neurosens2"
                                                                   name="DACCDIST"
                                                                   value="<?php echo attr($DACCDIST); ?>"></td>
                                                        <td><input type="text" id="DACCNEAR" class="neurosens2"
                                                                   name="DACCNEAR"
                                                                   value="<?php echo attr($DACCNEAR); ?>"></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="text-align:right;"><?php echo xlt('Convergence'); ?>
                                                            :
                                                        </td>
                                                        <td><input type="text" id="CACCDIST" class="neurosens2"
                                                                   name="CACCDIST"
                                                                   value="<?php echo attr($CACCDIST); ?>"></td>
                                                        <td><input type="text" id="CACCNEAR" class="neurosens2"
                                                                   name="CACCNEAR"
                                                                   value="<?php echo attr($CACCNEAR); ?>"></td>
                                                    </tr>
                                                    </tr>
                                                    <tr>
                                                        <td class="right">
                                                        ...
                                                        <td colspan="2">
                                                            <input type="text" style="width:90%;" class="neurosens2"
                                                                   name="VERTFUSAMPS" id="VERTFUSAMPS"
                                                                   value="<?php echo attr($VERTFUSAMPS); ?>">
                                                            <br/>
                                                        </td>
                                                    </tr>
                                                </table>
                                        ...
                                        <div id="NEURO_MOTILITY" class="text_clinical borderShadow">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td class="right">
                                                        <label for="MOTILITYNORMAL"
                                                               class="input-helper input-helper--checkbox"><?php echo xlt('Normal'); ?></label>
                                                        <input id="MOTILITYNORMAL" name="MOTILITYNORMAL"
                                                               type="checkbox" <?php if ($MOTILITYNORMAL == 'on') {
                                                            echo "checked='checked'";
                                                        } ?>>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <input type="hidden" name="MOTILITY_RS" id="MOTILITY_RS"
                                                               value="<?php echo attr($MOTILITY_RS); ?>">
                                                        <input type="hidden" name="MOTILITY_RI" id="MOTILITY_RI"
                                                               value="<?php echo attr($MOTILITY_RI); ?>">
                                                        <input type="hidden" name="MOTILITY_RR" id="MOTILITY_RR"
                                                               value="<?php echo attr($MOTILITY_RR); ?>">
                                                        <input type="hidden" name="MOTILITY_RL" id="MOTILITY_RL"
                                                               value="<?php echo attr($MOTILITY_RL); ?>">
                                                        <input type="hidden" name="MOTILITY_LS" id="MOTILITY_LS"
                                                               value="<?php echo attr($MOTILITY_LS); ?>">
                                                        <input type="hidden" name="MOTILITY_LI" id="MOTILITY_LI"
                                                               value="<?php echo attr($MOTILITY_LI); ?>">
                                                        <input type="hidden" name="MOTILITY_LR" id="MOTILITY_LR"
                                                               value="<?php echo attr($MOTILITY_LR); ?>">
                                                        <input type="hidden" name="MOTILITY_LL" id="MOTILITY_LL"
                                                               value="<?php echo attr($MOTILITY_LL); ?>">

                                                        <input type="hidden" name="MOTILITY_RRSO" id="MOTILITY_RRSO"
                                                               value="<?php echo attr($MOTILITY_RRSO); ?>">
                                                        <input type="hidden" name="MOTILITY_RRIO" id="MOTILITY_RRIO"
                                                               value="<?php echo attr($MOTILITY_RLIO); ?>">
                                                        <input type="hidden" name="MOTILITY_RLSO" id="MOTILITY_RLSO"
                                                               value="<?php echo attr($MOTILITY_RLSO); ?>">
                                                        <input type="hidden" name="MOTILITY_RLIO" id="MOTILITY_RLIO"
                                                               value="<?php echo attr($MOTILITY_RLIO); ?>">

                                                        <input type="hidden" name="MOTILITY_LRSO" id="MOTILITY_LRSO"
                                                               value="<?php echo attr($MOTILITY_LRSO); ?>">
                                                        <input type="hidden" name="MOTILITY_LRIO" id="MOTILITY_LRIO"
                                                               value="<?php echo attr($MOTILITY_LLIO); ?>">
                                                        <input type="hidden" name="MOTILITY_LLSO" id="MOTILITY_LLSO"
                                                               value="<?php echo attr($MOTILITY_LLSO); ?>">
                                                        <input type="hidden" name="MOTILITY_LLIO" id="MOTILITY_LLIO"
                                                               value="<?php echo attr($MOTILITY_LLIO); ?>">
                                                        ...
                                                        <div class="divTable">
                                                            ...
                                                            <div class="divRow">
                                                                <div class="divCell" name="MOTILITY_RRSO_4"
                                                                     id="MOTILITY_RRSO_4">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RRSO_4_2"
                                                                     id="MOTILITY_RRSO_4_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RRSO_3_2"
                                                                     id="MOTILITY_RRSO_3_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RS_4_3"
                                                                     id="MOTILITY_RS_4_3">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RS_4_1"
                                                                     id="MOTILITY_RS_4_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RS_4"
                                                                     id="MOTILITY_RS_4"
                                                                     value="<?php echo attr($MOTILITY_RS); ?>">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RS_4_2"
                                                                     id="MOTILITY_RS_4_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RS_4_4"
                                                                     id="MOTILITY_RS_4_4">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RLSO_3_1"
                                                                     id="MOTILITY_RLSO_3_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RLSO_4_1"
                                                                     id="MOTILITY_RLSO_4_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RLSO_4"
                                                                     id="MOTILITY_RLSO_4">&nbsp;
                                                                </div>
                                                            </div>
                                                            <div class="divRow">
                                                                <div class="divCell" name="MOTILITY_RRSO_4_1"
                                                                     id="MOTILITY_RRSO_4_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RRSO_3"
                                                                     id="MOTILITY_RRSO_3">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RRSO_2_2"
                                                                     id="MOTILITY_RRSO_2_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RS_3_1"
                                                                     id="MOTILITY_RS_3_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RS_3"
                                                                     id="MOTILITY_RS_3">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RS_3_2"
                                                                     id="MOTILITY_RS_3_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RLSO_2_1"
                                                                     id="MOTILITY_RLSO_2_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RLSO_3"
                                                                     id="MOTILITY_RLSO_3">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RLSO_4_2"
                                                                     id="MOTILITY_RLSO_4_2">&nbsp;
                                                                </div>
                                                            </div>
                                                            <div class="divRow">
                                                                <div class="divCell" name="MOTILITY_RRSO_3_1"
                                                                     id="MOTILITY_RRSO_3_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RRSO_2_1"
                                                                     id="MOTILITY_RRSO_2_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RRSO_2"
                                                                     id="MOTILITY_RRSO_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RS_2_1"
                                                                     id="MOTILITY_RS_2_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RS_2"
                                                                     id="MOTILITY_RS_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RS_2_2"
                                                                     id="MOTILITY_RS_2_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RLSO_2"
                                                                     id="MOTILITY_RLSO_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RLSO_2_2"
                                                                     id="MOTILITY_RLSO_2_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RLSO_232"
                                                                     id="MOTILITY_RLSO_3_2">&nbsp;
                                                                </div>
                                                            </div>
                                                            <div class="divRow">
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RRSO_1"
                                                                     id="MOTILITY_RRSO_1">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RS_1_1"
                                                                     id="MOTILITY_RS_1_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RS_1"
                                                                     id="MOTILITY_RS_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RS_1_2"
                                                                     id="MOTILITY_RS_1_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RLSO_1"
                                                                     id="MOTILITY_RLSO_1">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                            ...
                                                            <div class="divRow">
                                                                <div class="divCell" name="MOTILITY_RR_4_3"
                                                                     id="MOTILITY_RR_4_3">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RR_4_1"
                                                                     id="MOTILITY_RR_4_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RR_3_1"
                                                                     id="MOTILITY_RR_3_1">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RS_0_1"
                                                                     id="MOTILITY_RS_0_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RS_0"
                                                                     id="MOTILITY_RS_0">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RS_0_2"
                                                                     id="MOTILITY_RS_0_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RL_3_1"
                                                                     id="MOTILITY_RL_3_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RL_4_1"
                                                                     id="MOTILITY_RL_4_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RL_4_3"
                                                                     id="MOTILITY_RL_4_3">&nbsp;
                                                                </div>
                                                            </div>
                                                            <div class="divMiddleRow">
                                                                <div class="divCell" name="MOTILITY_RR_4_4"
                                                                     id="MOTILITY_RR_4_4">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RR_4"
                                                                     id="MOTILITY_RR_4"
                                                                     value="<?php echo attr($MOTILITY_RR); ?>">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RR_3"
                                                                     id="MOTILITY_RR_3">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RR_2"
                                                                     id="MOTILITY_RR_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RR_1"
                                                                     id="MOTILITY_RR_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RR_0"
                                                                     id="MOTILITY_RR_0">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_R0"
                                                                     id="MOTILITY_R0">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RL_0"
                                                                     id="MOTILITY_RL_0">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RL_1"
                                                                     id="MOTILITY_RL_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RL_2"
                                                                     id="MOTILITY_RL_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RL_3"
                                                                     id="MOTILITY_RL_3">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RL_4"
                                                                     id="MOTILITY_RL_4"
                                                                     value="<?php echo attr($MOTILITY_RL); ?>">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RL_4_4"
                                                                     id="MOTILITY_RL_4_4">&nbsp;
                                                                </div>
                                                            </div>
                                                            <div class="divRow">
                                                                <div class="divCell" name="MOTILITY_RR_4_5"
                                                                     id="MOTILITY_RR_4_5">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RR_4_2"
                                                                     id="MOTILITY_RR_4_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RR_3_2"
                                                                     id="MOTILITY_RR_3_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RI_0_1"
                                                                     id="MOTILITY_RI_0_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" id="MOTILITY_RI_0"
                                                                     name="MOTILITY_RI_0">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RI_0_2"
                                                                     id="MOTILITY_RI_0_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RL_3_2"
                                                                     id="MOTILITY_RL_3_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RL_4_2"
                                                                     id="MOTILITY_RL_4_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RL_4_5"
                                                                     id="MOTILITY_RL_4_5">&nbsp;
                                                                </div>
                                                            </div>
                                                            <div class="divRow">
                                                                ...
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RRIO_1"
                                                                     id="MOTILITY_RRIO_1">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RI_1_1"
                                                                     id="MOTILITY_RI_1_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" id="MOTILITY_RI_1"
                                                                     name="MOTILITY_RI_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RI_1_2"
                                                                     id="MOTILITY_RI_1_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RLIO_1"
                                                                     id="MOTILITY_RLIO_1">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                            ...
                                                            <div class="divRow">
                                                                <div class="divCell" name="MOTILITY_RRIO_3_1"
                                                                     id="MOTILITY_RRIO_3_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RRIO_2_1"
                                                                     id="MOTILITY_RRIO_2_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RRIO_2"
                                                                     id="MOTILITY_RRIO_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RI_2_1"
                                                                     id="MOTILITY_RI_2_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" id="MOTILITY_RI_2"
                                                                     name="MOTILITY_RI_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RI_2_2"
                                                                     id="MOTILITY_RI_2_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RLIO_2"
                                                                     id="MOTILITY_RLIO_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RLIO_2_1"
                                                                     id="MOTILITY_RLIO_2_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RLIO_3_1"
                                                                     id="MOTILITY_RLIO_3_1">&nbsp;
                                                                </div>
                                                            </div>
                                                            <div class="divRow">
                                                                <div class="divCell" name="MOTILITY_RRIO_4_1"
                                                                     id="MOTILITY_RRIO_4_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RRIO_3"
                                                                     id="MOTILITY_RRIO_3">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RRIO_2_2"
                                                                     id="MOTILITY_RRIO_2_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RI_3_1"
                                                                     id="MOTILITY_RI_3_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" id="MOTILITY_RI_3"
                                                                     name="MOTILITY_RI_3">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RI_3_2"
                                                                     id="MOTILITY_RI_3_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RLIO_2_2"
                                                                     id="MOTILITY_RLIO_2_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RLI0_3"
                                                                     id="MOTILITY_RLIO_3">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RLIO_4_1"
                                                                     id="MOTILITY_RLIO_4_1">&nbsp;
                                                                </div>
                                                            </div>
                                                            <div class="divRow">
                                                                <div class="divCell" name="MOTILITY_RRIO_4"
                                                                     id="MOTILITY_RRIO_4"
                                                                     value="<?php echo attr($MOTILITY_RRIO); ?>">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RRIO_4_2"
                                                                     id="MOTILITY_RRIO_4_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RRIO_3_2"
                                                                     id="MOTILITY_RRIO_3_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RI_4_3"
                                                                     id="MOTILITY_RI_4_3">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RI_4_1"
                                                                     id="MOTILITY_RI_4_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" id="MOTILITY_RI_4"
                                                                     name="MOTILITY_RI_4"
                                                                     value="<?php echo attr($MOTILITY_RI); ?>">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RI_4_2"
                                                                     id="MOTILITY_RI_4_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RI_4_4"
                                                                     id="MOTILITY_RI_4_4">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_RLIO_3_2"
                                                                     id="MOTILITY_RLIO_3_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RLIO_4_2"
                                                                     id="MOTILITY_RLIO_4_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_RLIO_4"
                                                                     id="MOTILITY_RLIO_4"
                                                                     value="<?php echo attr($MOTILITY_RLIO); ?>">&nbsp;
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="divTable">
                                                            ...
                                                            <div class="divRow">
                                                                <div class="divCell" name="MOTILITY_LRSO_4"
                                                                     id="MOTILITY_LRSO_4"
                                                                     value="<?php echo attr($MOTILITY_LRSO); ?>">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LRSO_4_2"
                                                                     id="MOTILITY_LRSO_4_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LRSO_3_3"
                                                                     id="MOTILITY_LRSO_3_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LS_4_3"
                                                                     id="MOTILITY_LS_4_3">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LS_4_1"
                                                                     id="MOTILITY_LS_4_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LS_4"
                                                                     id="MOTILITY_LS_4"
                                                                     value="<?php echo attr($MOTILITY_LS); ?>">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LS_4_2"
                                                                     id="MOTILITY_LS_4_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LS_4_4"
                                                                     id="MOTILITY_LS_4_4">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LLSO_3_1"
                                                                     id="MOTILITY_LLSO_3_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LLSO_4_1"
                                                                     id="MOTILITY_LLSO_4_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LLSO_4"
                                                                     id="MOTILITY_LLSO_4"
                                                                     value="<?php echo attr($MOTILITY_LLSO); ?>">&nbsp;
                                                                </div>
                                                            </div>
                                                            <div class="divRow">
                                                                <div class="divCell" name="MOTILITY_LRSO_4_1"
                                                                     id="MOTILITY_LRSO_4_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LRSO_3"
                                                                     id="MOTILITY_LRSO_3">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LRSO_2_2"
                                                                     id="MOTILITY_LRSO_2_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LS_3_1"
                                                                     id="MOTILITY_LS_3_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LS_3"
                                                                     id="MOTILITY_LS_3">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LS_3_2"
                                                                     id="MOTILITY_LS_3_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LLSO_2_1"
                                                                     id="MOTILITY_LLSO_2_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LLSO_3"
                                                                     id="MOTILITY_LLSO_3">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LLSO_4_2"
                                                                     id="MOTILITY_LLSO_4_2">&nbsp;
                                                                </div>
                                                            </div>
                                                            <div class="divRow">
                                                                <div class="divCell" name="MOTILITY_LRSO_3_1"
                                                                     id="MOTILITY_LRSO_3_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LRSO_2_1"
                                                                     id="MOTILITY_LRSO_2_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LRSO_2"
                                                                     id="MOTILITY_LRSO_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LS_2_1"
                                                                     id="MOTILITY_LS_2_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LS_2"
                                                                     id="MOTILITY_LS_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LS_2_2"
                                                                     id="MOTILITY_LS_2_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LLSO_2"
                                                                     id="MOTILITY_LLSO_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LLSO_2_2"
                                                                     id="MOTILITY_LLSO_2_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LLSO_3_2"
                                                                     id="MOTILITY_LLSO_3_2">&nbsp;
                                                                </div>
                                                            </div>
                                                            <div class="divRow">
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LRSO_1"
                                                                     id="MOTILITY_LRSO_1">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LS_1_1"
                                                                     id="MOTILITY_LS_1_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LS_1"
                                                                     id="MOTILITY_LS_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LS_1_2"
                                                                     id="MOTILITY_LS_1_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LLSO_1"
                                                                     id="MOTILITY_LLSO_1">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                            ...
                                                            <div class="divRow">
                                                                <div class="divCell" name="MOTILITY_LR_4_3"
                                                                     id="MOTILITY_LR_4_3">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LR_4_1"
                                                                     id="MOTILITY_LR_4_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LR_3_1"
                                                                     id="MOTILITY_LR_3_1">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LS_0_1"
                                                                     id="MOTILITY_LS_0_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LS_0"
                                                                     id="MOTILITY_LS_0">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LS_0_1"
                                                                     id="MOTILITY_LS_0_1">&nbsp;
                                                                ...
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LL_3_1"
                                                                     id="MOTILITY_LL_3_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LL_4_1"
                                                                     id="MOTILITY_LL_4_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LL_4_3"
                                                                     id="MOTILITY_LL_4_3">&nbsp;
                                                                </div>
                                                            </div>
                                                            <div class="divMiddleRow">
                                                                <div class="divCell" name="MOTILITY_LR_4_4"
                                                                     id="MOTILITY_LR_4_4">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LR_4"
                                                                     id="MOTILITY_LR_4"
                                                                     value="<?php echo attr($MOTILITY_LR); ?>">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LR_3"
                                                                     id="MOTILITY_LR_3">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LR_2"
                                                                     id="MOTILITY_LR_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LR_1"
                                                                     id="MOTILITY_LR_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LR_0"
                                                                     id="MOTILITY_LR_0">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_L0"
                                                                     id="MOTILITY_L0">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LL_0"
                                                                     id="MOTILITY_LL_0">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LL_1"
                                                                     id="MOTILITY_LL_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LL_2"
                                                                     id="MOTILITY_LL_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LL_3"
                                                                     id="MOTILITY_LL_3">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LL_4"
                                                                     id="MOTILITY_LL_4"
                                                                     value="<?php echo attr($MOTILITY_LL); ?>">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LL_4_4"
                                                                     id="MOTILITY_LL_4_4">&nbsp;
                                                                </div>
                                                            </div>
                                                            <div class="divRow">
                                                                <div class="divCell" name="MOTILITY_LR_4_5"
                                                                     id="MOTILITY_LR_4_5">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LR_4_2"
                                                                     id="MOTILITY_LR_4_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LR_3_3"
                                                                     id="MOTILITY_LR_3_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LI_0_1"
                                                                     id="MOTILITY_LI_0_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" id="MOTILITY_LI_0"
                                                                     name="MOTILITY_LI_0">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LI_0_2"
                                                                     id="MOTILITY_LI_0_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LL_3_2"
                                                                     id="MOTILITY_LL_3_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LL_4_2"
                                                                     id="MOTILITY_LL_4_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LL_5_2"
                                                                     id="MOTILITY_LL_5_2">&nbsp;
                                                                </div>
                                                            </div>
                                                            <div class="divRow">
                                                                ...
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LRIO_1"
                                                                     id="MOTILITY_LRIO_1">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LI_1_1"
                                                                     id="MOTILITY_LI_1_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" id="MOTILITY_LI_1"
                                                                     name="MOTILITY_LI_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LI_1_2"
                                                                     id="MOTILITY_LI_1_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LLIO_1"
                                                                     id="MOTILITY_LLIO_1">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                            ...
                                                            <div class="divRow">
                                                                <div class="divCell" name="MOTILITY_LRIO_3_1"
                                                                     id="MOTILITY_LRIO_3_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LRIO_2_1"
                                                                     id="MOTILITY_LRIO_2_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LRIO_2"
                                                                     id="MOTILITY_LRIO_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LI_2_1"
                                                                     id="MOTILITY_LI_2_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LI_2"
                                                                     id="MOTILITY_LI_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LI_2_2"
                                                                     id="MOTILITY_LI_2_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LLIO_2"
                                                                     id="MOTILITY_LLIO_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LLIO_2_1"
                                                                     id="MOTILITY_LLIO_2_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LLIO_3_1"
                                                                     id="MOTILITY_LLIO_3_1">&nbsp;
                                                                </div>
                                                            </div>
                                                            <div class="divRow">
                                                                <div class="divCell" name="MOTILITY_LRIO_4_1"
                                                                     id="MOTILITY_LRIO_4_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LRIO_3"
                                                                     id="MOTILITY_LRIO_3">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LRIO_2_2"
                                                                     id="MOTILITY_LRIO_2_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LI_3_1"
                                                                     id="MOTILITY_LI_3_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LI_3"
                                                                     id="MOTILITY_LI_3">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LI_3_2"
                                                                     id="MOTILITY_LI_3_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LLIO_2_2"
                                                                     id="MOTILITY_LLIO_2_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LLIO_3"
                                                                     id="MOTILITY_LLIO_3">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LLIO_4_1"
                                                                     id="MOTILITY_LLIO_4_1">&nbsp;
                                                                </div>
                                                            </div>
                                                            <div class="divRow">
                                                                <div class="divCell" name="MOTILITY_LRIO_4"
                                                                     id="MOTILITY_LRIO_4"
                                                                     value="<?php echo attr($MOTILITY_LRIO); ?>">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LRIO_4_2"
                                                                     id="MOTILITY_LRIO_4_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LRIO_3_2"
                                                                     id="MOTILITY_LRIO_3_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LI_4_1"
                                                                     id="MOTILITY_LI_4_1">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LI_4"
                                                                     id="MOTILITY_LI_4"
                                                                     value="<?php echo attr($MOTILITY_LI); ?>">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LI_4_2"
                                                                     id="MOTILITY_LI_4_2">&nbsp;
                                                                </div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell">&nbsp;</div>
                                                                <div class="divCell" name="MOTILITY_LLIO_3_2"
                                                                     id="MOTILITY_LLIO_3_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LLIO_4_2"
                                                                     id="MOTILITY_LLIO_4_2">&nbsp;
                                                                </div>
                                                                <div class="divCell" name="MOTILITY_LLIO_4"
                                                                     id="MOTILITY_LLIO_4"
                                                                     value="<?php echo attr($MOTILITY_LLIO); ?>">&nbsp;
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="QP_lengthen" id="NEURO_COMMENTS_DIV">
                                        <b><?php echo xlt('Comments'); ?>:</b>
                                        <div class="kb kb_left"><?php echo xlt('NCOM{{Neuro comments}}'); ?></div>
                                        <br/>
                                        <textarea id="NEURO_COMMENTS"
                                                  name="NEURO_COMMENTS"><?php echo text($NEURO_COMMENTS); ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div id="NEURO_right" class="exam_section_right borderShadow text_clinical">
                                <div id="PRIORS_NEURO_left_text" name="PRIORS_NEURO_left_text"
                                     class="PRIORS_class PRIORS"><i class="fa fa-spinner fa-spin"></i>
                                </div>
                                <?php display_draw_section("NEURO", $encounter, $pid); ?>
                                <div id="QP_NEURO" name="QP_NEURO" class="QP_class">
                                    <input type="hidden" id="NEURO_ACT_zone" name="NEURO_ACT_zone"
                                           value="<?php echo $ACT_SHOW; ?>">
                                    ...
                                    <div id="NEURO_P_2"><br/>
                                        <div class="borderShadow" class="NEURO_P_21"><span
                                            ...
                                            <span class="eye_button" id="NEURO_side_L" name="NEURO_side"
                                                  style="padding-left:0.06in;padding-right:0.06in;"
                                                  onclick="$('#NEURO_side').val('L').trigger('change');"><?php echo xlt('Left'); ?></span>
                                            <span class="eye_button eye_button_selected" id="NEURO_side_None"
                                                  name="NEURO_side"
                                                  onclick="$('#NEURO_side').val('').trigger('change');"><?php echo xlt('None{{Side}}'); ?></span>
                                            <br/>
                                        </div>
                                        <div class="borderShadow" class="NEURO_P_21"><span
                                            ...
                                            <span class="eye_button" id="NEURO_ACT_strab_ET_int" name="NEURO_ACT_strab"
                                                  title="<?php echo xla('Intermittent Esotropia'); ?>"
                                                  onclick="$('#NEURO_ACT_strab').val('E\(T\)').trigger('change');"><?php echo xlt('E(T){{intermittent esotropia}}'); ?></span>
                                            <span class="eye_button" id="NEURO_ACT_strab_ET" name="NEURO_ACT_strab"
                                                  title="<?php echo xla('Esotropia'); ?>"
                                                  onclick="$('#NEURO_ACT_strab').val('ET').trigger('change');"><?php echo xlt('ET{{esotropia}}'); ?></span>
                                            <br/>
                                            <span class="eye_button" id="NEURO_ACT_strab_X" name="NEURO_ACT_strab"
                                                  title="<?php echo xla('Exophoria'); ?>"
                                                  onclick="$('#NEURO_ACT_strab').val('X').trigger('change');"><?php echo xlt('X{{exophoria}}'); ?></span>
                                            <span class="eye_button" id="NEURO_ACT_strab_XT_int" name="NEURO_ACT_strab"
                                                  title="<?php echo xla('Intermittent Exotropia'); ?>"
                                                  onclick="$('#NEURO_ACT_strab').val('X\(T\)').trigger('change');"><?php echo xlt('X(T){{intermittent exophoria}}'); ?></span>
                                            <span class="eye_button" id="NEURO_ACT_strab_XT" name="NEURO_ACT_strab"
                                                  title="<?php echo xla('Exotropia'); ?>"
                                                  onclick="$('#NEURO_ACT_strab').val('XT').trigger('change');"><?php echo xlt('XT{{exotropia}}'); ?></span>

                                            <br/>
                                            <span class="eye_button" id="NEURO_ACT_strab_H" name="NEURO_ACT_strab"
                                                  title="<?php echo xla('Hyperphoria'); ?>"
                                                  onclick="$('#NEURO_ACT_strab').val('HT').trigger('change');"><?php echo xlt('HT{{hyperphoria}}'); ?></span>
                                            <span class="eye_button" id="NEURO_ACT_strab_HT_int" name="NEURO_ACT_strab"
                                                  title="<?php echo xla('intermittent hyperphoria'); ?>"
                                                  onclick="$('#NEURO_ACT_strab').val('H\(T\)').trigger('change');"><?php echo xlt('H(T){{intermittent hypertropia}}'); ?></span>
                                            <span class="eye_button" id="NEURO_ACT_strab_hypoT" name="NEURO_ACT_strab"
                                                  title="<?php echo xla('Hypotropia'); ?>"
                                                  onclick="$('#NEURO_ACT_strab').val('hypoT').trigger('change');"><?php echo xlt('hypoT{{hypotropia}}'); ?></span>
                                            <span class="eye_button" id="NEURO_ACT_strab_hypoT_int"
                                                  name="NEURO_ACT_strab"
                                                  title="<?php echo xla('Intermittent hypotropia'); ?>"
                                                  onclick="$('#NEURO_ACT_strab').val('hypo\(T\)').trigger('change');"><?php echo xlt('hypo(T){{intermittent hypotropia}}'); ?></span>
                                            <br/>
                                        </div>
                                        <br/><br/>
                                        <div>
                                            <button id="NEURO_RECORD"
                                                    name="NEURO_RECORD"> <?php echo xlt('RECORD'); ?> </button>
                                        </div>
                                    </div>
                                    <div id="NEURO_P_3">
                                        &nbsp;
                                        <div class="borderShadow ACT_boxed"><span
                                            ...
                                            <span class="eye_button <?php if ($ACT_SHOW == 'SCDIST') {
                                                echo "eye_button_selected";
                                                  ...
                                                  onclick="$('#NEURO_ACT_zone').val('SCDIST').trigger('change');"> <?php echo xlt('scDist{{without correction distance}}'); ?> </span>
                                            <span class="eye_button <?php if ($ACT_SHOW == 'CCDIST') {
                                                echo "eye_button_selected";
                                            } ?>" id="NEURO_ACT_zone_CCDIST" name="NEURO_ACT_zone"
                                                  onclick="$('#NEURO_ACT_zone').val('CCDIST').trigger('change');"> <?php echo xlt('ccDist{{with correction distance}}'); ?> </span>
                                            <span class="eye_button <?php if ($ACT_SHOW == 'SCNEAR') {
                                                echo "eye_button_selected";
                                            } ?>" id="NEURO_ACT_zone_SCNEAR" name="NEURO_ACT_zone"
                                                  onclick="$('#NEURO_ACT_zone').val('SCNEAR').trigger('change');"> <?php echo xlt('scNear{{without correction near}}'); ?> </span>
                                            <span class="eye_button <?php if ($ACT_SHOW == 'CCNEAR') {
                                                echo "eye_button_selected";
                                            } ?>" id="NEURO_ACT_zone_CCNEAR" name="NEURO_ACT_zone"
                                        ...
                                        <div class="borderShadow ACT_boxed"><span
                                            ...
                                            <span class="eye_button" id="NEURO_field_2" name="NEURO_field"
                                                  onclick="$('#NEURO_field').val('2').trigger('change');"> 2 </span>
                                            <span class="eye_button" id="NEURO_field_3" name="NEURO_field"
                                                  onclick="$('#NEURO_field').val('3').trigger('change');"> 3 </span>
                                            ...
                                            <span class="eye_button" id="NEURO_field_4" name="NEURO_field"
                                                  onclick="$('#NEURO_field').val('4').trigger('change');"> 4 </span>
                                            <span class="eye_button eye_button_selected" id="NEURO_field_5"
                                                  name="NEURO_field"
                                                  onclick="$('#NEURO_field').val('5').trigger('change');"> 5 </span>
                                            ...
                                            <span class="eye_button" id="NEURO_field_7" name="NEURO_field"
                                                  onclick="$('#NEURO_field').val('7').trigger('change');">7</span>
                                            <span class="eye_button" id="NEURO_field_8" name="NEURO_field"
                                                  onclick="$('#NEURO_field').val('8').trigger('change');">8</span>
                                            <span class="eye_button" id="NEURO_field_9" name="NEURO_field"
                                                  onclick="$('#NEURO_field').val('9').trigger('change');">9</span>
                                            <span class="eye_button" id="NEURO_field_11" name="NEURO_field"
                                                  onclick="$('#NEURO_field').val('11').trigger('change');">11</span>
                                        </div>
                                        ...
                                        <div class="borderShadow ACT_boxed"><span
                                            ...
                                            <span class="eye_button" id="NEURO_value_1" name="NEURO_value"
                                                  onclick="$('#NEURO_value').val('1').trigger('change');">1</span>
                                            <span class="eye_button" id="NEURO_value_2" name="NEURO_value"
                                                  onclick="$('#NEURO_value').val('2').trigger('change');">2</span>
                                            <span class="eye_button" id="NEURO_value_3" name="NEURO_value"
                                                  onclick="$('#NEURO_value').val('3').trigger('change');">3</span>
                                            <span class="eye_button" id="NEURO_value_4" name="NEURO_value"
                                                  onclick="$('#NEURO_value').val('4').trigger('change');">4</span>
                                            <span class="eye_button" id="NEURO_value_5" name="NEURO_value"
                                                  onclick="$('#NEURO_value').val('5').trigger('change');">5</span>
                                            <span class="eye_button" id="NEURO_value_6" name="NEURO_value"
                                                  onclick="$('#NEURO_value').val('6').trigger('change');">6</span>
                                            <span class="eye_button" id="NEURO_value_8" name="NEURO_value"
                                                  onclick="$('#NEURO_value').val('8').trigger('change');">8</span>
                                            <span class="eye_button" id="NEURO_value_10" name="NEURO_value"
                                                  onclick="$('#NEURO_value').val('10').trigger('change');">10</span>
                                            <span class="eye_button" id="NEURO_value_12" name="NEURO_value"
                                                  onclick="$('#NEURO_value').val('12').trigger('change');">12</span>
                                            <span class="eye_button" id="NEURO_value_14" name="NEURO_value"
                                                  onclick="$('#NEURO_value').val('14').trigger('change');">14</span>
                                            <span class="eye_button" id="NEURO_value_16" name="NEURO_value"
                                                  onclick="$('#NEURO_value').val('16').trigger('change');">16</span>
                                            <span class="eye_button" id="NEURO_value_18" name="NEURO_value"
                                                  onclick="$('#NEURO_value').val('18').trigger('change');">18</span>
                                            <span class="eye_button" id="NEURO_value_20" name="NEURO_value"
                                                  onclick="$('#NEURO_value').val('20').trigger('change');">20</span>
                                            <span class="eye_button" id="NEURO_value_25" name="NEURO_value"
                                                  onclick="$('#NEURO_value').val('25').trigger('change');">25</span>
                                            <span class="eye_button" id="NEURO_value_30" name="NEURO_value"
                                                  onclick="$('#NEURO_value').val('30').trigger('change');">30</span>
                                            <span class="eye_button" id="NEURO_value_35" name="NEURO_value"
                                                  onclick="$('#NEURO_value').val('35').trigger('change');">35</span>
                                            <span class="eye_button" id="NEURO_value_40" name="NEURO_value"
                                                  onclick="$('#NEURO_value').val('40').trigger('change');">40</span>
                                        </div>
                                    </div>
                                    <span class="closeButton fa fa-close pull-right z100" id="BUTTON_TEXTD_NEURO"
                                          name="BUTTON_TEXTD_NEURO" value="1"></span>
                                </div>
                            </div>
                        </div>
                        <!-- end Neuro -->
                        ...
                        <div class="size50 clear_both" id="IMPPLAN_1">
                            <div id="IMPPLAN_left" name="IMPPLAN_left"
                                 class="clear_both exam_section_left borderShadow">
                                <span class="anchor" id="IMPPLAN_anchor"></span>
                                <a class="closeButton_5 fa fa-file-pdf-o"
                                   title="<?php echo xla('Once completed, view and store this encounter as a PDF file'); ?>"
                                   target="_report"
                                   href="<?php echo $GLOBALS['webroot']; ?>/interface/patient_file/report/custom_report.php?printable=1&pdf=1&<?php echo $form_folder . "_" . $form_id . "=" . $encounter; ?>&"></a>
                                <span class="closeButton_2 fa fa-paint-brush" id="BUTTON_DRAW_IMPPLAN"
                                      title="<?php echo xla('Open/Close the Imp/Plan drawing panel'); ?>"
                                      name="BUTTON_DRAW_IMPPLAN"></span>
                                <i class="closeButton_3 fa fa-database"
                                   title="<?php echo xla('Show the Impression/Plan Builder panel'); ?>"
                                   id="BUTTON_QP_IMPPLAN" name="BUTTON_QP_IMPPLAN"></i>
                                <i class="closeButton_4 fa fa-user-md fa-sm fa-2" name="Shorthand_kb"
                                   title="<?php echo xla("Open/Close the Shorthand Window and display Shorthand Codes"); ?>"></i>
                                <i class="closeButton fa fa-minus-circle"
                                   title="<?php echo xla('Open/Close Imp/Plan panels'); ?>" id="BUTTON_TAB_IMPPLAN"
                                   name="BUTTON_TAB_IMPPLAN"></i>
                                <div id="IMPPLAN_left_text" name="IMPPLAN_left_text">
                                    <b><?php echo xlt('Impression/Plan'); ?>:</b>
                                    <div class="kb kb_left"><?php echo xlt('IMP{{impression}}'); ?></div>
                                    <div id="IMPPLAN_blank" name="IMPPLAN_blank" class="HPI_text">
                                        <br/>
                                        <table class="IMPPLAN">
                                            <tr>
                                                <td class="right bold"
                                                    style="width:75px;padding-right:10px;vertical-align:top;"><?php echo xlt('New Dx{{new diagnosis}}'); ?>
                                                    :
                                                </td>
                                                <td><textarea name="IMP" id="IMP"><?php echo text($IMP); ?></textarea>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <input type="hidden" name="IMPPLAN_count" id="IMPPLAN_count"
                                           value="<?php echo $IMPPLAN_count; ?>">
                                </div>
                            </div>
                       ...
                       */
                            ?>
                            <div class="size50">
                                <div id="IMPPLAN_right"
                                     class="exam_section_right borderShadow text_clinical clear_both ">
                                    <?php display_draw_section("IMPPLAN", $encounter, $pid); ?>

                                    <div id="PRIORS_IMPPLAN_left_text" name="PRIORS_IMPPLAN_left_text"
                                         class="PRIORS_class PRIORS"><i class="fa fa-spinner fa-spin"></i>
                                    </div>
                                    <div id="QP_IMPPLAN" name="QP_IMPPLAN" class="QP_class2">
                                        <span id="iPLAN_BUILD" name="iPLAN_BUILD"
                                              class="bold"><?php echo xlt('Impression/Plan'); ?></span>
                                        <div id="IP_P_1">
                                            <?php echo $selector = priors_select("IMPPLAN", $id, $id, $pid); ?>
                                        </div>
                                        <span class="closeButton fa fa-close pull-right z100" id="BUTTON_TEXTD_IMPPLAN"
                                              name="BUTTON_TEXTD_IMPPLAN" value="1"></span>
                                        <br/>
                                        <?php
                                        /*
                               ...
                               */
                                        ...
                                        <dl class="building_blocks" id="building_blocks" name="building_blocks">
                                            <dt class="borderShadow"><i
                                                ...
                                                <div id="IMP_start2">
                                                    <input type="checkbox" id="inc_PE" name="inc_PE"
                                                           checked="checked"><label for='inc_PE'
                                                                                    class='input-helper input-helper--checkbox'><?php echo xlt('Exam{{Physical Exam}}'); ?></label>&nbsp;
                                                    <input type="checkbox" id="inc_POH" name="inc_POH"
                                   ...
                                   */
                                            ...
                                            <dt class="borderShadow"><span><?php echo xlt('Coding Engine'); ?></span>
                                            </dt>
                                            <dd>
                                                <div style="padding:5px 10px 5px 10px;">
                                                    <table style="width:100%;">
                                                        <tr>
                                                            <td colspan="3">
                                                                <b><u><?php echo xlt('Diagnostic') . " " . xlt('Codes'); ?>
                                                                        :</u></b>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3" style="padding-top:5px;padding-left:15px;">
                                                                <span id="Coding_DX_Codes"><br/></span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding-top:10px;width:60%;">
                                                                <b><u><?php echo xlt('Visit');
                                                                        echo " " . xlt('Codes'); ?>:</u></b>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="indent20">
                                <span class="CODE_LOW indent20"
                                      title="<?php echo xla('Documentation for a Detailed HPI requires') . ":\n " . xla('> 3 HPI elements') . "\n " .
                                    ...
                                    ?> </span><span class="CODE_HIGH nodisplay"><i class="fa fa-check"></i> <?php
                                                            ...
                                                            <td class="text-center">
                                                                <span id="Coding_Visit_Codes"
                                                                      style="text-decoration:underline;"><?php echo xlt('Justify'); ?></span>
                                                        ...
                                                        <tr class="ui-widget-content">
                                                            ...
                                                            <td class="text-center">
                                                                <span class="modifier" name="visit_modifier"
                                                                      id="visit_mod_22" value="22"
                                                                      title="<?php echo xla('Modifier 22: Increased Procedural Services: When the work required to provide a service is substantially greater than typically required, it may be identified by adding modifier 22 to the usual procedure code.') ?>">22</span>
                                                                <span class="modifier" name="visit_modifier"
                                                                      id="visit_mod_24" value="24"
                                                                      title="<?php echo xla('Modifier 24: Unrelated Evaluation and Management Service by the Same Physician During a Postoperative Period') ?>">24</span>
                                                                <span class="modifier" name="visit_modifier"
                                                                      id="visit_mod_25" value="25"
                                                                      title="<?php echo xla('Modifier 25: Significant, separately identifiable evaluation and management (E/M) service by the same physician on the day of a procedure or other service') ?>">25</span>
                                                                <span class="modifier" name="visit_modifier"
                                                                      id="visit_mod_57" value="57"
                                                                      title="<?php echo xla('Modifier 57: Indicates an Evaluation and Management (E/M) service resulted in the initial decision to perform surgery either the day before a major surgery (90 day global) or the day of a major surgery.'); ?>">57</span>
                                                            </td>
                                                            <td>
                                                                <span id="visit_justification"
                                                                      class="pull-right text-center"
                                                                      style="padding:7px 2px;"></span>
                                                            </td>
                                                        </tr>

                                                        <tr id="neurosens_code" name="neurosens_code" class="nodisplay">
                                                            <td colspan="3" style="padding-top:5px;padding-left:15px;">
                                                                <input type="hidden" id="neurosens" style="width:50px;"
                                                                       value="92060" class="">
                                                                <i class="fa fa-check"></i> 92060 Sensorimotor Exam - no
                                                                modifier required.
                                                            </td>
                                                        </tr>
                                     ...
                                     ';
                                                    ...
                                                    <table style="width:100%;padding-top:10px;vertical-align:top;">
                                                        <tr>
                                                            <td style="width:40%;">
                                                                <b><u><?php echo xlt('Appt{{Abbreviation for appointment}}') . " " . xlt('Status') . " / " . xlt('Flow Board'); ?>
                                                                        :</u></b><br/>
                                                                <div class="indent20">
                                                                    ...
                                                                    <br/>
                                                                    <input type="radio" name="visit_status" id="coded"
                                                                           value="$"/><label for="coded">
                                                                        <b>$</b>&nbsp;<?php echo xlt('Coding complete'); ?>
                                                                    </label>
                                                                    <br/>
                                                                    <input type="radio" name="visit_status"
                          ...
                          ";
                                            ...
                                            <dd>
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td style="padding-right: 20px; padding-left: 20px;">
                                                            ...
                                                            while ($planQX_row = sqlFetchArray($PLANQX_results)) {
                                                                $PLANQX_arr[] = $planQX_row;
                                                            }
                                                            while ($row = sqlFetchArray($TODO_data)) {
                                                                $arrPLANQX[$counter]['option_id'] = $row['option_id'];
                                                                $arrPLANQX[$counter]['title'] = $row['title'];
                                                                $arrPLANQX[$counter]['option_value'] = $row['option_value'];
                                                                $arrPLANQX[$counter]['mapping'] = $row['mapping'];
                                                                $arrPLANQX[$counter]['notes'] = $row['notes'];
                                                    ...
                                                    <tr>
                                                        <td colspan="3" style="padding-left:20px;padding-top:4px;">
                                <textarea id="Plan<?php echo $counter; ?>" name="PLANQX[]"
                                          style="width: 440px;height: 44px;"><?php if ($foundQX < (empty($PLANQX_arr) ? 0 : count($PLANQX_arr))) {
                                        echo $PLANQX_arr[count($PLANQX_arr) - 1]['ORDER_DETAILS'];
                                    } ?></textarea>
                                                        </td>
                                                    </tr>
                                                    <tr>
                        ...
                        ";
                                            ...
                                            <dd>
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td style="padding-right:20px;padding-left:20px;">
                                                            ...
                                                            while ($planQXOI_row = sqlFetchArray($PLANQXOI_results)) {
                                                                $PLANQXOI_arr[] = $planQXOI_row;
                                                            }
                                                            while ($row = sqlFetchArray($TODO_data)) {
                                                                $arrPLANQXOI[$counter]['option_id'] = $row['option_id'];
                                                                $arrPLANQXOI[$counter]['title'] = $row['title'];
                                                                $arrPLANQXOI[$counter]['option_value'] = $row['option_value'];
                                                                $arrPLANQXOI[$counter]['mapping'] = $row['mapping'];
                                                                $arrPLANQXOI[$counter]['notes'] = $row['notes'];
                                                    ...
                                                    <tr>
                                                        <td colspan="3" style="padding-left:20px;padding-top:4px;">
                                <textarea id="Plan<?php echo $counter; ?>" name="PLANQXOI[]"
                                          style="width: 440px;height: 44px;"><?php if ($foundQXOI < (empty($PLANQXOI_arr) ? 0 : count($PLANQXOI_arr))) {
                                        echo $PLANQXOI_arr[count($PLANQXOI_arr) - 1]['ORDER_DETAILS'];
                                    } ?></textarea>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <dt class="borderShadow">
                                                <span><?php echo xlt('Communication Engine'); ?></span></dt>
                                            <dd>
                                                <div style="padding:5px 20px 5px 20px;">
                                                    ...
                                                    <table style="width:100%;">
                                                        <tr>
                                                            ...
                                                            <td class="bold underline" style="min-width:100px;">
                                                                Referrer
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <span id="ref_address">
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            <td class="top bold"><?php echo xlt('Insurance'); ?>:</td>
                                                            <td><?php echo text($ins_coA); ?></td>
                                                        </tr>
                                                        <?php if (!empty($ins_coB)) { ?>
                                                            <tr>
                                                                <td class="top bold"><?php echo xlt('Secondary'); ?>:
                                                                </td>
                                                                <td><?php echo text($ins_coB); ?></td>
                                                            </tr>
                                                        <?php } ?>
                                                        <tr>
                                                            <td class="top bold"><?php echo xlt('Pharmacy'); ?>:</td>
                                                            <?php
                                                            $frow['data_type'] = "12";
                                                            $frow['form_id'] = 'EYE';
...
<script language="JavaScript">
    ...
    <?php require_once(__DIR__ . "/js/eye_view_issue_actions.php"); ?>
...
<script>
    ...
    $('#right-panel-link_2').panelslider({
        side: 'right',
        clickClose: false,
        duration: 600,
        easingOpen: 'easeInBack',

                        ...
                        <td colspan="2" class="text-center"> <?php
                            if ($row['REFTYPE'] != "CTL") { ?>
                                ...
                                <table id="CTLRx" name="CTLRx" class="refraction">
                                    ...
                                    <tr>
                                        <td colspan="4"
                                            class="bold left text-uppercase text-top"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5" class="left"
                                            style="padding-left:10px;vertical-align:top;"><?php echo text($row['CTLBRANDOS']); ?>
                                            <?php
                                    ...
                                    <?php if (!empty($row['COMMENTS'])) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" class="left"
                                                style="padding-left:10px;vertical-align:middle;top:0px;">
                    ...
                    if ($REFTYPE != "CTL") { ?>
                        <table id="SpectacleRx" name="SpectacleRx" class="refraction bordershadow"
                            ...
                            <tr style="font-weight:bold;text-align:center;">
                                <td><i name="print_rx" id="print_rx" class="closeButton_5 fa fa-file-pdf-o"
                                       onclick="rx_print()" "></i>
                                </td>
                                <td></td>
                                <td><?php echo xlt('Sph{{Sphere}}'); ?></td>
                                ...
                                <td rowspan="5" class="right bold" colspan="1">
                                    ...
                                    <b id="SingleVision_span" name="SingleVision_span">
                                        <label for="RXTYPE_Single"><?php echo xlt('Monofocal'); ?></label>
                                        <input type="radio"
                                    ...
                                    <b id="Bifocal_span" name="Bifocal_span">
                                        ...
                                        <input type="radio"
                                               ...
                                               value="Bifocal" id="RXTYPE_Bifocal"
                                               name="RXTYPE" <?php echo attr($Bifocal); ?>></b><br/>
                            ...
                            <tr class="NEAR center">
                                ...
                                <td name="COLADD1">
                                    <input type="text" id="OSMIDADD" name="OSMIDADD"
                                           value="<?php echo attr($OSMIDADD); ?>"></td>
                                <td class="WAdd2">
                                    <input type="text" id="OSADD2" name="OSADD2" value="<?php echo attr($OSADD2); ?>">
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td class="right bold"><?php echo xlt('DP'); ?></td>
                                <td name="DP">
                                    <input type="text" id="DP" name="DP"
                                           value="<?php echo attr($BPDD); ?>"></td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="9" class="right">
                                                <span><?php
                                                    if (
                                                        ...
                                                        $ODMPDD || $ODMPDN || $OSMPDD || $OSMPDN || $BPDN ||
                        ...
                        <table id="CTLRx" name="CTLRx" class="refraction bordershadow">
                            ...
                            <tr>
                                ...
                                <td colspan="4"
                                    class="left"><?php echo text($CTLBRANDOD); ?><?php if ($CTLMANUFACTUREROD) {
                            ...
                            <tr>
                                ...
                                if ($adds) {
                                    ...
                                    <td><input type=text id="CTLODADD" name="CTLODADD"
                                               value="<?php echo attr($ODADD); ?>">
                                    </td>
                                <?php } ?>
                            </tr>
                            <tr>
                                <td colspan="2" class="right bold text-uppercase"><?php echo xlt('Quantity:'); ?></td>
                                <td colspan="4" class="left"><input id="CTLODQUANTITY" name="CTLODQUANTITY"
                                                                    value="<?php echo attr($CTLODQUANTITY); ?>"
                                                                    type="text" class="left"/></td>
                            </tr>
                            <tr>
                                <td colspan="7">
                                    <hr/>
                            ...
                            <tr>
                                <td colspan="2" class="right bold text-uppercase"><?php echo xlt('Brand'); ?>:</td>
                                <td colspan="4"
                                    class="left"><?php echo text($CTLBRANDOS); ?><?php if ($CTLMANUFACTUREROS) {
                            ...
                            <tr>
                                ...
                                if ($adds) {
                                    ...
                                    <td><input type=text id="CTLOSADD" name="CTLOSADD"
                                               value="<?php echo attr($OSADD); ?>"></td>
                                <?php } ?>
                            </tr>
                            <tr>
                                <td colspan="2" class="right bold text-uppercase"><?php echo xlt('Quantity:'); ?></td>
                                <td colspan="4" class="left"><input id="CTLOSQUANTITY" name="CTLOSQUANTITY"
                                                                    value="<?php echo attr($CTLOSQUANTITY); ?>"
                                                                    type="text" class="left"/></td>
                            </tr>
                            ...
                            <?php if ($CTL_COMMENTS > '') { ?>
                                ...
                                <tr>
                                    ...
                                    <td colspan="4" class="left">
                                        <textarea cols="30" rows="4" id="COMMENTS"
                                                  name="COMMENTS"><?php echo text($CTL_COMMENTS); ?></textarea>
                                    </td>
                                </tr>
                            <?php } ?>
                        </table>

...
function extractItemsFromQuery($proced_id)
{
    $query = "SELECT name, consiste, realiza, realiza, grafico, duracion, beneficios, riesgos, riesgos_graves, alternativas, post, consecuencias
...
<table style="margin-bottom: unset">
    ...
    <tr>
        ...
        <td colspan="49" class="blanco_left">
            <?php
            $items = extractItemsFromQuery($proced_id);

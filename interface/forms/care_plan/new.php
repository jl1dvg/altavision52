...
$sql1 = "SELECT id AS `value`, lname, fname FROM `users` WHERE active = 1 AND authorized != ?";
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="forms col-xs-4">
                            <label for="description_<?php echo attr($key) + 1; ?>" class="h5"><?php echo xlt('Ojo'); ?>:</label>
                        ...
                        <div class="forms col-xs-2">
                            <label for="care_plan_type_<?php echo attr($key) + 1; ?>" class="h5"><?php echo xlt('Provider'); ?>:</label>
                    ...
                    <div class="tb_row" id="tb_row_1">
                        <div class="form-group">
                            ...
                            <div class="forms col-xs-2">
                                <label for="care_plan_type_1" class="h5"><?php echo xlt('Provider'); ?>:</label>

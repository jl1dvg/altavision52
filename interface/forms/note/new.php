...
<head>
    ...
    <script type="text/javascript"
            src="<?php echo $GLOBALS['assets_static_relative']; ?>/jquery-datetimepicker/build/jquery.datetimepicker.full.min.js"></script>
...
<form method=post action="<?php echo $rootdir . "/forms/" . $form_name . "/save.php?mode=new"; ?>" name="my_form"
      id="my_form">
    ...
    <?php
    echo generate_select_list('note_type', 'certificados', '', 'Seleccionar tipo de certificaod', 'Unassigned');
    ?>
    <br>

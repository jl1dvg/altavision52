            ...
            <form id="new-encounter-form" method='post' action="<?php echo $rootdir ?>/forms/newpatient/save.php"
               ...
               authorized != 0 AND active = 1 ORDER BY lname, fname";
                ...
                authorized != 1 AND active = 1 ORDER BY lname, fname";
                        ...
                        <div class="form-group">
                            <label
                                class="control-label col-sm-2 oe-text-to-right"><?php echo xlt('Datos de derivación'); ?>
                                :</label>
                            ...
                            <label
                                class="control-label col-sm-2 oe-text-to-right"><?php echo xlt('Codigo de validación activo'); ?>
                                :</label>
                            <div class="col-sm-3">
                                <?php

...
$MedTratante      = (isset($_POST['tratante']))             ? $_POST['tratante'] : '';
...
if ($mode == 'new') {
    ...
    sqlStatement(
        ...
        "WHERE encounter = " . add_escape_custom($encounter) . " ".
    ...
    sqlStatement(
            "UPDATE forms SET " .
        "date = '" . add_escape_custom($date) . "' " .
        "WHERE encounter = " . add_escape_custom($encounter) . " ". "AND pid = " . add_escape_custom($pid) . " " . "AND deleted = 0 " . " " .
        "AND formdir = 'eye_mag' "
    );

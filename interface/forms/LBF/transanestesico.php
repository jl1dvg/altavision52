...
//Datos del PACIENTE
$titleres = getPatientData($pid, "pubpid,fname,mname,lname, lname2, pricelevel, sex,providerID,DATE_FORMAT(DOB,'%Y/%m/%d') as DOB_TS");
...
<div class="ritz grid-container" dir="ltr">
    <table class="waffle no-grid" cellspacing="0" cellpadding="0">
        ...
        <tr style="height: 17px">
            ...
            <td class="s11" colspan="18"><?php echo $datedprotocolo->format('d/m/Y'); ?></td>

...
if (!empty($_POST['bn_save']) || !empty($_POST['bn_save_print']) || !empty($_POST['bn_save_continue'])) {
    ...
    if (isset($_POST['form_date_id'])) {
        sqlStatement(
            "UPDATE forms SET date = ? WHERE formdir = ? AND form_id = ? AND deleted = 0",
            array($_POST['form_date_id'], $formname, $my_form_id)
        );
    }
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="page-header">
                    ...
                    <?php
                    $firow = sqlQuery(
                        "SELECT issue_id, date, provider_id FROM forms WHERE " .
                    ...
                    $form_date_id = empty($firow['date']) ? 0 : intval($firow['date']);


                    // Provider selector.
                    $proveedorAUT = sqlQuery(
...
// Append to historical data of other dates for this item.
            ...
            if (isset($LBF_SERVICES_SECTION)) {
                ...
                $ctype = $GLOBALS['ippf_specific'] ? 'CPT4' : '';
                echo "<p class='bold'>";
                ...
                echo "  <td class='bold'>" . xlt('Convenio') . "&nbsp;</td>\n";
                echo "  <td class='bold'>" . xlt('Unidades') . "&nbsp;</td>\n";
                ...
                foreach ($fs->serviceitems as $lino => $li) {
                    ...
                    echo "  <td class='text'>" .
                        ...
                        "  &nbsp;</td>\n";
                    echo "  <td class='text'>" .
                        $fs->genPriceLevelSelect2("form_fs_bill[$lino][pricelevel]", '-- ' . xl("Default") . ' --', $li['pricelevel']) .
                        "  &nbsp;</td>\n";
                    ...
                    echo "   <input type='hidden' name='form_fs_bill[$lino][price]' value='" . oeFormatMoney($li['price'] * $li['units']) . "' />\n";
                    echo "  </td>\n";
                    echo " </tr>\n";
                }
                echo "</table>\n";
            ...
            if (isset($LBF_PRODUCTS_SECTION)) {
                ...
                foreach ($fs->productitems as $lino => $li) {
                    ...
                    echo "  <td class='text' align='right'>\n" .
                        ...
                        "value='1'" . ($li['del'] ? " checked" : "") . " />\n";
                    foreach ($li['hidden'] as $hname => $hvalue) {
                        echo "   <input type='text' name='form_fs_prod[$lino][" . attr($hname) . "]' value='" . attr($hvalue) . "' />\n";
                    }
                    echo "  </td>\n";
                    echo " </tr>\n";
                }

...
CREATE TABLE `form_eye_refraction` (
  ...
  `LMODSPH`           varchar(25)  DEFAULT NULL,
  `LMODCYL`           varchar(25)  DEFAULT NULL,
  `LMODAXIS`          varchar(25)  DEFAULT NULL,
  `LMODVA`            varchar(25)  DEFAULT NULL,
  `LMODADD`           varchar(25)  DEFAULT NULL,
  `LMNEARODVA`        varchar(25)  DEFAULT NULL,
  `LMODPRISM`         varchar(50)  DEFAULT NULL,
  `LMOSSPH`           varchar(25)  DEFAULT NULL,
  `LMOSCYL`           varchar(25)  DEFAULT NULL,
  `LMOSAXIS`          varchar(25)  DEFAULT NULL,
  `LMOSVA`            varchar(25)  DEFAULT NULL,
  `LMOSADD`           varchar(25)  DEFAULT NULL,
  `LMNEAROSVA`        varchar(25)  DEFAULT NULL,
  `LMOSPRISM`         varchar(50)  DEFAULT NULL,
